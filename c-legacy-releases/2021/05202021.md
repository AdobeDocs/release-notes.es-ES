...
Consulte las [notas de la versión](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=en) de [!DNL Marketo Engage]  para obtener la información más reciente sobre la programación.
