...
* **Experience Manager as a Cloud Service**
   ...
   * **Guías del Experience Manager as a Cloud Service**

      * **Sistema de administración de contenido de componentes nativos de la nube** - Las guías del Experience Manager están disponibles as a Cloud Service. Obtenga el entorno que le permite crear, administrar y entregar documentación y contenido a escala.
      ...
      * **Nueva apariencia para el editor web**: nueva apariencia con los cambios de IU, lo que lo hace más intuitivo. La arquitectura subyacente ha cambiado de coral a espectro basado en React.
      ...
      Visita [Guías del Experience Manager](https://www.adobe.com/products/xml-documentation-for-experience-manager.html) para obtener más información.
