...
| Función | Descripción | [Disponibilidad general](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) - Fecha de destino |
| ----------- | ---------- | ------- |
