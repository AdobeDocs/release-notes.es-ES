...
Los servicios de Experience Cloud y la documentación de administración incluyen Atributos del cliente, Biblioteca de audiencias ([!UICONTROL People] ), Activation, administración de usuarios y productos y cookies del Experience Cloud.
...
General: El SDK ahora se distribuye mediante [!DNL XCFrameworks] con el fin de admitir hardware con la nueva arquitectura Apple M1, manteniendo al mismo tiempo la compatibilidad con la arquitectura Intel® existente.
...
| -----------| ---------- | ---------- | ---------- |
| 23 de diciembre de 2020 | [Información general sobre los esquemas de unión](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html?lang=es) | Vídeo | Obtenga información sobre los esquemas de unión utilizados por el perfil del cliente en tiempo real de Adobe Experience Platform. |
| 22 de diciembre de 2020 | [Creación de segmentos de varias entidades](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/create-multi-entity-segments.html?lang=es) | Vídeo | Aprenda a crear segmentos de varias entidades en el Generador de segmentos de Adobe Experience Platform. |
...
| 29 de octubre de 2020 (actualizado) | [Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/demo-of-offer-decisioning.html?lang=es) | Vídeo | Descubra cómo las marcas pueden utilizar el nuevo Adobe [!UICONTROL offer decisioning] para definir y administrar sus ofertas, aprovechar los datos de clientes en tiempo real y ofrecer las experiencias adecuadas que esperan sus clientes. |
...
El Experience Manager 6.5, Service Pack 7 (6.5.7.0, publicado el 26 de noviembre de 2020) es una actualización importante que incluye nuevas funciones, mejoras clave para el cliente, rendimiento mejorado, estabilidad y seguridad, publicada desde la disponibilidad general de Experience Manager 6.5 en abril de 2019.
...
Consulte [Experiencia unificada](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=es#benefits) para obtener más información sobre este plug-in.
      * El conversor de índices es una utilidad que se puede usar para transformar las definiciones de índices OAK personalizadas de un cliente en definiciones de índices OAK compatibles con as a Cloud Service Experience Manager.
...
* **Analizador de prácticas recomendadas**
   ...
   * Ahora, el [!UICONTROL Analizador de preparación para la nube] es el [!UICONTROL Analizador de prácticas recomendadas] (BPA). BPA proporciona una evaluación de prácticas recomendadas de su implementación actual de Experience Manager y ayuda a evaluar la preparación para pasar de una instancia de AEM existente a AEM como [!UICONTROL Cloud Service].
...
| Publicadas | Nombre | Solución | Descripción |
| ----------- | ----------- | ---------- | ---------- |
| 14 de noviembre de 2020 | [Creación de paneles de Advertising con Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html?lang=es) | Vídeo | Técnicas para crear un panel de Advertising para supervisar campañas en directo. |
