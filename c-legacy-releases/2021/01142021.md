...
[Los servicios de Experience Cloud y la documentación de administración incluyen los Atributos del cliente, la Biblioteca de audiencias ([!UICONTROL People] servicio), la Activación, la administración de usuarios y productos y las cookies de Experience Cloud.
...
Consulte [Notas de la versión de Experience Platform](https://docs.adobe.com/content/help/es-ES/experience-platform/release-notes/latest.translate.html) para ver las actualizaciones más recientes que se aplican a lo siguiente:
...
| Actualización de la compatibilidad con Ad Hoc Analysis Java™ 8 | 21 de agosto de 2020 | Actualmente, Ad Hoc Analysis no es compatible con Java™ 8 versiones 1.8.0_261 o posterior. Para garantizar que el acceso a esta herramienta no se interrumpa antes de que [fecha de finalización](https://spark.adobe.com/page/S9Bhp66VJ2fEn/) llegue, le recomendamos que mantenga una versión de Java™ 8 anterior a la 1.8.0_261. |
