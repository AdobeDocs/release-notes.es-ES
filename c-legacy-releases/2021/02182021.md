...
| 8 de enero de 2021 | [Actividad de Adobe Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/activity.html?lang=es) | Vídeo | Cloud Manager proporciona una vista consolidada de la actividad de un programa, que enumera todas las ejecuciones de la canalización de CI/CD, tanto de producción como de no producción. Esta función permite a los usuarios visualizar cualquier canalización en curso y revisar implementaciones anteriores. |
