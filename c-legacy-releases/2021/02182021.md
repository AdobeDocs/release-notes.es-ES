...
| -----------| ---------- | ---------- | ---------- |
| 26 de febrero de 2021 | [Monitorización del flujo de datos en Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html#data-ingestion) | Aprenda a monitorizar y rastrear los datos que se incorporan en Adobe Experience Platform mediante la IU y la API de Platform. |
