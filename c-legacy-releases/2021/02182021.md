...
| 3 de febrero de 2021 | [Activación de datos en aplicaciones que no son de Adobe](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=es) | Vídeo | Descubra cómo el CDP en tiempo real de Adobe le ayuda a crear estrategias de personalización verdaderas con sus audiencias. Además, aprenda cómo se integra en sus aplicaciones existentes de sistemas ecológicos y no de Adobe desde Microsoft®, Google y Facebook. |
...
| 1 de febrero de 2021 | [Creación de una entrega de SMS](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/sms-channel/create-a-sms-delivery.html?lang=es) | Campaign Classic | Obtenga información sobre cómo crear una entrega SMS. |
