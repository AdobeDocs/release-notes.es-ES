...
Consulte el [estado del sistema de Adobe del 21 de mayo de 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=es) para obtener la información más reciente sobre la versión.

## ![Icono](/assets/ec_appicon_24.png) Administración y servicios de Experience Cloud {#ecloud}

La documentación de [Servicios y administración de Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=es) incluye Atributos de cliente, Biblioteca de audiencias (servicio de [!UICONTROL Personas]), Activación, administración de usuarios y productos y cookies de Experience Cloud.
...
| 2 de febrero de 2021 | [Evolución de AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/evolution.html?lang=es) | Vídeo | Explore la historia de Experience Manager y las diferencias entre Experience Manager on-premise, Adobe Managed Services AEM y Experience Manager as a Cloud Service. |
