...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Campañas] | (Campañas de Google Ads) [!UICONTROL Advertising Cloud Search] ahora sincroniza, optimiza y proporciona atribución para anuncios de inventario locales en campañas de compra.<br><br>Configure y administre las publicidades de inventario locales dentro de Google Ads. |
