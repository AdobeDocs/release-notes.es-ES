---
title: 'Notas de la versión centrales: junio de 2021'
...
Funciones nuevas, correcciones y actualizaciones en Experience Manager (AEM). Adobe recomienda a los clientes que tengan implementaciones On-Premise implementar los parches más recientes para garantizar una mayor estabilidad, seguridad y rendimiento.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service Foundation**
      ...
      * [Canal de versión preliminar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/prerelease.html): Previsualice las próximas funciones un mes antes de que se activen en la producción.
   ...
   * **Experience Manager Assets as a Cloud Service**
     ...
     Nuevas funciones del canal de versión preliminar:
...
* **Nuevo Adobe Campaign v8** con mejoras significativas en infraestructura, seguridad, capacidad de entrega y monitorización. Adobe Campaign v8 mejora considerablemente su escala y velocidad, con la capacidad de administrar una cantidad más significativa de perfiles de clientes, así como tasas de entrega y transacciones por hora mucho más altas. Obtenga más información en la [Documentación de Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=es).
