...
| [Modelo de personalización móvil y web](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/web-personalization/overview.html?lang=es) | Aprenda a utilizar la segmentación de público en varias aplicaciones para personalizar y optimizar las experiencias de los clientes. Puede utilizar comportamientos de clientes, información demográfica, nivel de fidelidad y transacciones anteriores para personalizar diseños, llamadas a la acción y contenido. |
