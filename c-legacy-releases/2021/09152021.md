...
| Septiembre de 2021 | [Monitorización de bases de datos](https://experienceleague.adobe.com/docs/campaign-learn/control-panel/performance-monitoring/monitor-databases.html?lang=es) | Campaign V8 | Obtenga información sobre cómo monitorizar el uso de la base de datos con el [!UICONTROL Panel de control]. |
