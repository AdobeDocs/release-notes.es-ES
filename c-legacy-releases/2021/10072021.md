...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Octubre de 2021 | [Introducción a la documentación XML](https://experienceleague.adobe.com/?recommended=ExperienceManager-U-1-2021.xmldocs&amp;lang=es) | Curso | Obtenga información sobre cómo crear, organizar, crear y publicar contenido con las guías del Experience Manager. |
