...
Para más información, consulte [Novedades en Experience Cloud - Primavera de 2016](https://marketing.adobe.com/resources/help/es_ES/mcloud/marketing-cloud-interface.html).
...
La documentación incluye nuevo contenido procedimental para [!DNL  Target]. Consulte [Implementación del servicio Experience Cloud ID con Analytics ](https://marketing.adobe.com/resources/help/es_ES/mcvid/?f=mcvid-setup-target.html).

Para documentación del producto, consulte [Experience Cloud ID Services](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
