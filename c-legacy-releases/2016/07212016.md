...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Nuevo requisito de permisos para Administrar configuración de aplicación </p> </td> 
...
Consulte [Adobe Mobile Services](https://marketing.adobe.com/resources/help/es_ES/mobile/) para ver la documentación del producto. Para ver las notas de versiones anteriores, amplíe *Notas de la versión anterior* en el panel izquierdo.
...
Esta versión actualiza la versión a 1.6.0. Incluye las siguientes funciones, correcciones de errores y otros cambios.
...
Consulte también la documentación del producto del [servicio de Marketing Cloud ID](https://docs.adobe.com/content/help/es-ES/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A partir de octubre de 2016, los administradores de Analytics podrán administrar usuarios y la configuración de producto (grupos) en <span class="wintitle">Enterprise Dashboard</span>. Enterprise Panel es la interfaz de administración para Document Cloud, creativos y de marketing de Adobe. </p> <p>Podrá: </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     ...
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">Delegar funciones administrativas a usuarios sobre configuraciones de productos específicas. </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">Aplicar permisos a dimensiones y métricas específicas. </li> 
    </ul> <p>Además, la función actual de administración de usuarios de las Herramientas de administración recibirá mejoras importantes. </p> <p> <p class="important">Nota: Para obtener más información, consulte <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">Cambios administrativos de producto previstos para otoño de 2016</a>. </p> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>(Añadido en junio de 2016) Implementación simplificada para nuevos clientes </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_D1237FEB03554D7793CCF09148F32530">Se corrigió un problema de inicio de sesión que se producía en los usuarios cuyo inicio de sesión predeterminado del producto era SearchCenter (AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      ...
      <li id="li_59787469534B455686696BA9E095D388"> Se ha corregido un problema de lógica de segmentos en las reglas en el que había un valor hash "0" presente en la tabla de búsqueda de clasificación (AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">Se añadió la capacidad de enviar informes vacíos en lugar de responder con "sin datos". (AN-126210) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>El <span class="wintitle">Informe de errores de muestra</span> comprueba los aciertos y errores de tasas para el procesamiento de informes en sus archivos fuente de datos de entrada. El sistema de informes de errores muestra los datos en un gráfico de barras interactivo y proporciona métricas de resumen en forma de tabla. Además, incluye una opción que toma muestras de archivos para un intervalo de tiempo fijo y muestra los errores más comunes para cada tipo de error. </p> <p>La documentación estará disponible cuando la función se publique a finales de julio. </p> </td> 
  </tr> 
  <tr> 
...
* Se corrigió un problema en el cual responder a un tweet producía un error que indicaba que el tweet superaba los 140 caracteres.
* Se corrigió un problema en el cual los botones de alternancia que habilitaban ciertos abreviadores de vínculos no funcionaban.
* Se corrigió un problema en el cual las respuestas de los moderadores no se mostraban en Moderación.
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Las nuevas funciones incluyen lo siguiente: 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      ...
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">Compatibilidad con la conexión HTTP persistente (también conocida como HTTP keep-live) en todas las plataformas. </li> 
