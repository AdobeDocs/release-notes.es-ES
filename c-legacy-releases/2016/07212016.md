...
| Función | Descripción |
|---|---|
| Herramienta del servicio de Marketing Cloud ID | Se ha habilitado por defecto la opción de cargar la herramienta del servicio de Marketing Cloud ID en DTM en la parte superior de la página. |

**Se ha corregido un problema que hacía que se mostrara**

Cuando se agrega la herramienta del servicio de Marketing Cloud ID, la opción **[!UICONTROL Solicitar automáticamente el ID de visitante]se selecciona de forma predeterminada.** (DTM-8189)
...
**Avisos importantes sobre el servicio de Marketing Cloud ID**
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>El mecanismo CORS permite a los navegadores solicitar recursos provenientes de un dominio distinto al actual. El servicio de <span class="keyword">Marketing Cloud</span> ID admite los estándares CORS para habilitar solicitudes de recursos de origen diverso por parte del cliente. El servicio de ID cambia a solicitudes JSONP en los navegadores que no admiten el mecanismo CORS. (AAM-23988) </p> <p>Consulte: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-cors.html" format="https" scope="external"> Compatibilidad con CORS en el servicio de Marketing Cloud ID </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">Admin.: se ha corregido un problema que impedía realizar un seguimiento de la actividad de los usuarios que iniciaban sesión a través de Marketing Cloud con su Adobe ID. Esta corrección reproduce el seguimiento de la actividad de los usuarios que inician sesión de forma tradicional facilitando el nombre de su empresa, su nombre de usuario y la contraseña. (AN-124792) </li> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2016/07212016.md#mcvid" format="dita" scope="local"> Servicio de Marketing Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se ha cambiado el aspecto de la línea que divide el inicio de sesión heredado y Marketing Cloud. (AAM-24378)
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2ACBBBD7E090426480C9A2745358201E"> 
      <li id="li_442BDC1F137A48CEB019094E8D6E5348"> <p> <a href="https://docs.adobe.com/docs/en/aem/6-2/develop/ref/coral-ui/home/index.html" format="https" scope="external">Referencias de la API: documentación de la API de la IU de Coral (IU táctil optimizada)</a> </p> </li> 
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Proporciona, entre otras cosas, una descripción general básica de los componentes de AEM, incluidos los componentes de la IU clásica y de la IU táctil optimizada. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Integre AEM con otras soluciones de Adobe Marketing Cloud y con servicios de terceros. </p> </td> 
  </tr> 
  <tr> 
