---
description: Notas de la versión, julio de 2016
keywords: notas de la versión
seo-description: Notas de la versión, julio de 2016
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Nuevo requisito de permiso para Administrar configuración de aplicación </p> </td> 
...
Este lanzamiento actualiza la versión a 1.6.0 e incluye las siguientes funciones, corrección de errores y otros cambios.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El mecanismo CORS permite a los navegadores solicitar recursos provenientes de un dominio distinto al actual. El servicio de <span class="keyword">Experience Cloud</span> ID admite los estándares CORS para habilitar solicitudes de recursos de origen diverso por parte del cliente. El servicio de ID cambia a solicitudes JSONP en los navegadores que no admiten el mecanismo CORS. (AAM-23988) </p> <p>Consulte: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Compatibilidad con CORS en el servicio de Experience Cloud ID </a> </li> 
...
* Se ha cambiado el valor predeterminado ` loadTimeout` de los 500 a los 30.000 milisegundos (30 segundos). Consulte [Variables utilizadas por la función getInstance del servicio de ID](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html). (MCID-96)
...
* Nueva: [Implementar el servicio de Marketing Cloud ID para Analytics y Audience Manager](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-setup-aam-analytics.html)
* Revisada: [Probar y verificar el servicio de Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-test-analytics.html)

Consulte también la documentación del producto del [servicio de Marketing Cloud ID](https://docs.adobe.com/content/help/en/id-service/using/home.html).
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A partir de octubre de 2016, los administradores de Analytics podrán administrar usuarios y la configuración de producto (grupos) en <span class="wintitle">Enterprise Dashboard</span>. Enterprise Dashboard es la interfaz de administración para los Document Cloud de Marketing, Creativo y Marketing de Adobe. </p> <p>Podrá: </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">Cree configuraciones de producto para productos, herramientas, productos, grupos de informes (y más). </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">Cree usuarios y asígnelos a las configuraciones de producto. </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">Delegar funciones administrativas en usuarios sobre configuraciones de productos específicas. </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">Aplicar permisos a dimensiones y métricas específicas. </li> 
    </ul> <p>Además, la función de administración de usuarios de las Herramientas de administración actual recibirá mejoras importantes. </p> <p> <p class="important">Nota: Para obtener más información, consulte <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">Cambios administrativos de producto previstos para otoño de 2016</a>. </p> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>(Agregado en junio de 2016) Implementación simplificada para nuevos clientes </p> </td> 
...
Se han aplicado correcciones y mejoras a los siguientes productos y servicios:
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_D1237FEB03554D7793CCF09148F32530">Se ha corregido un problema de inicio de sesión que se producía entre los usuarios cuyo inicio de sesión predeterminado del producto era SearchCenter (AN-126281). </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      ...
      <li id="li_59787469534B455686696BA9E095D388"> Se ha corregido un problema con la lógica de segmentos en las reglas en las que está presente un valor hash "0" en la tabla de búsqueda de clasificaciones (AN-125340). </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">Se ha agregado la capacidad de enviar informes vacíos en lugar de responder con "sin datos". (AN-126210) </li> 
      ...
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">El desglose ahora proporciona tipos MIME adecuados en los correos electrónicos que produce (AN-124243) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>El <span class="wintitle">Informe de errores de muestra</span> comprueba los aciertos y errores de tasas para el procesamiento de informes en sus archivos fuente de datos de entrada. El informe de errores muestra los datos en un gráfico de barras interactivo y proporciona métricas de resumen en forma de tabla. Además, incluye una opción que toma muestras de archivos durante un intervalo de tiempo fijo y muestra los errores más comunes para cada tipo de error. </p> <p>La documentación estará disponible cuando la función se publique a finales de julio. </p> </td> 
  </tr> 
  <tr> 
...
* [Introducción a la gestión en lote](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk_start.html). Incluye una nueva hoja de cálculo para la gestión en lote.
...
* Se ha corregido un problema por el cual, al responder a un tweet, se producía un error que afirmaba que el tweet superaba los 140 caracteres.
* Se ha corregido un problema por el cual los botones de alternancia que habilitaban ciertos abreviadores de vínculos no funcionaban.
* Se ha corregido un problema por el cual las respuestas de los moderadores no se mostraban en Moderación.
...
Consulte [Ayuda de Primetime](https://helpx.adobe.com/es/support/primetime.html) para obtener la ayuda más actualizada sobre Primetime.
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Actualización de documentación de AEM 6.2 </p> </td> 
   <td colname="col2"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Gems on AEM es una serie de consejos técnicos proporcionados por expertos de Adobe. Dicha serie complementa la documentación del producto y los canales técnicos. También ayuda a los desarrolladores a ponerse en contacto y explorar un tema específico en detalle. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>AEM versiones de correcciones rápidas </p> </th> 
   <th colname="col2" class="entry"> <p>Descripción </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates.html?lang=es" format="https" scope="external"> Correcciones rápidas de AEM 6.2 </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/es/experience-manager/kb/aem61-available-hotfixes.html" format="https" scope="external"> Correcciones rápidas de AEM 6.1 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Entre las nuevas funciones se incluyen las siguientes: 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>Compatibilidad con expresiones regulares (regex) para filtros y reglas de caché. </p></li> 
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">Compatibilidad con conexión HTTP persistente (también conocida como HTTP viva) en todas las plataformas. </li> 
...
En la siguiente tabla aparece una selección de vínculos sobre los temas sugeridos. Estos temas pueden ayudarle a aprovechar al máximo la implementación y el uso de AEM.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Información sobre cuándo crear índices y cuándo no son necesarios. También incluye sugerencias para evitar el uso de consultas cuando no son necesarias y sugerencias para optimizar el rendimiento de los índices y consultas. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Resumen de los temas de integración disponibles. </p> </td> 
   <td colname="col3"> <p>15 de mayo de 2016 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido una tabla de comparación de productos para los productos de Analytics. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentación añadida para las nuevas funciones de Analysis Workspace. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha añadido documentación del producto y prácticas recomendadas para Marcas de hora opcionales. Esta función permite integrar datos con y sin marca de hora en un grupo de informes. Todos los grupos de informes nuevos serán Marcas de hora opcionales de forma predeterminada. </p> </td> 
   <td colname="col3"> <p>17 de septiembre de 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha actualizado el Generador de reglas de clasificación para que pueda agregar conjuntos de informes y variables a un conjunto de reglas al editar un conjunto de reglas existente (después de crear el conjunto de reglas). Anteriormente, se especificaban la variable y el grupo de informes al crear el conjunto de reglas. Este cambio evita que se produzcan problemas notificados con variables de clasificación. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El vínculo de perfil funciona con fuentes de datos entre dispositivos para identificar y recopilar características de visitantes del sitio autenticados. Incluye la función Reglas de combinación de perfiles , que le permite segmentar y dirigirse a los usuarios de forma precisa en varios dispositivos. </p> </td> 
   <td colname="col3"> <p>20 de agosto de 2015 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Un resumen general de lo que debe hacer para modernizar las implementaciones de soluciones para los servicios principales. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En <span class="uicontrol"> Herramientas de administración </span> &gt; <span class="uicontrol"> Generador de reglas de clasificación </span> &gt; <span class="term"> &amp;lt;nombre del conjunto de reglas&amp;gt;</span>, dos nuevas opciones le permiten seleccionar un modo de sobrescritura: </p> 
    ...
    </ul> <p>Anteriormente, si una clave ya estaba clasificada en cualquier columna o celda, la regla no se ejecutaba en esa clave y la fila de la tabla se omitía. </p> </td> 
