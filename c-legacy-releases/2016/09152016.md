  ...
  <tr> 
   ...
   <td colname="col2"> <p> Los activadores unen Analytics y Campaign, lo que permite a los especialistas en marketing definir y supervisar el comportamiento de los consumidores clave y, a continuación, generar una comunicación para varias soluciones y usarlas en decisiones y personalizaciones en tiempo real. Por ejemplo, puede crear activadores para: </p> 
    <ul id="ul_0B0893E7C7404528A33DC3AF5B600E21"> 
     <li id="li_A6E0A6DCE5554A54BB9528E32E1BF81A">Remercadotecnia por abandono del carro de compras o abandono del carro de compras con productos eliminados. </li> 
     <li id="li_7DA4D06F70964E34872265B77F9F6526">Inicio de sesión o eventos de fin de sesión. </li> 
     <li id="li_AB9A28929C6444C9A7E555A48431DED6">Cualquier acción o secuencia de acciones en el sitio, como formularios y aplicaciones incompletos. </li> 
    </ul> <p>Configuración: </p> 
    <ul id="ul_3113B4C40D6E458CAB4C6ECA2A95A4BE"> 
     <li id="li_B98B6922063645E2BA78833D27425F08"> <a href="https://docs.adobe.com/content/help/es-ES/core-services/interface/activation/triggers.translate.html" format="html" scope="external"> Cree activadores a partir de los datos de Analytics</a> en <span class="uicontrol">Experience Cloud</span> &gt; <span class="uicontrol">Activation</span> &gt; <span class="uicontrol">Activadores </span>. </li> 
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Se añadió un nuevo tipo de mensaje que abre un URI de vínculo profundo. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Android: Seguimiento de vínculos profundos </p> </td> 
   <td colname="col2"> <p>Se añadió la capacidad de habilitar el seguimiento de vínculos profundos diferidos de terceros. </p> <p> 
...
<p>Adobe ha lanzado una <a href="https://helpx.adobe.com/es/security/products/analytics/apsb16-13.html" format="https" scope="external">actualización de seguridad APSB16-13</a> para <span class="term">AppMeasurement para Flash</span>. Esta actualización resuelve una importante vulnerabilidad de la biblioteca, que solo es relevante cuando <span class="codeph">debugTracking</span> está habilitado y podría forzar que ocurrieran <a href="https://www.owasp.org/index.php/DOM_Based_XSS" format="https" scope="external">ataques XSS basados en DOM </a>. </p> <p> <p class="important">Nota: Este problema afecta a <span class="term">AppMeasurement para Flash </span>únicamente cuando <span class="codeph">debugTracking</span> ha sido habilitado (<span class="codeph">debugTracking</span> se encuentra deshabilitado en la configuración predeterminada). <b>Si se ve afectado, le recomendamos encarecidamente que deshabilite <span class="codeph">debugTracking</span> inmediatamente.</b> Esta es una muestra de código: </p> </p> 
  ...
  <tr> 
   <td colname="col1"> <p>SiteCatalyst 14, ExcelClient, etc. fin de vida en septiembre de 2016 </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Selección de huso horario para grupos de informes virtuales </p> </td> 
   <td colname="col2"> <p>Ahora puede elegir una zona horaria al crear un grupo de informes virtuales. </p> <p>Si elige una, se guardará junto con el grupo de informes virtual. Si no selecciona ninguno, se utiliza la zona horaria del grupo de informes principal. </p> <p>A la hora de editar un grupo de informes virtual, la zona horaria con la que se haya creado se mostrará en el selector desplegable. Si el grupo de informes virtuales se creó antes de que se agregara la compatibilidad con huso horario, la zona horaria del grupo de informes principal se muestra en el selector desplegable. </p> <p>Además, si crea un grupo de informes virtuales con un huso horario distinto del huso horario del grupo de informes principal y, a continuación, copia ese grupo de informes virtuales, el grupo de informes virtuales copiado hará referencia al huso horario del grupo de informes principal, a menos que actualice manualmente el huso horario. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Cambios de permisos en Analysis Workspace (AN-125014) </p> </td> 
   <td colname="col2"> <p>Los siguientes cambios de permisos se implementaron para Analysis Workspace. </p> <p>Anteriormente, necesitaba los siguientes permisos para crear segmentos o métricas en Analysis Workspace: </p> 
    <ul id="ul_E31EDD5966BA4114B39C472399A8BAFE"> 
     ...
     <li id="li_FF6AF50592B64BC0AB2619212E003BC0">Crear/depurar proyectos en Analysis Workspace </li> 
    </ul> <p>Con esta versión, solo necesita estos permisos: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_4E34357C5DB94CA891D228031C039BAC"> 
     ...
     <li id="li_4ACEC4300F4A4F26AFB337CA8F8A28DF">Se habilitaron las sobrescrituras de zonas horarias para los grupos de informes virtuales. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2016/09152016.md#mcvid" format="dita" scope="local"> Servicio de Experience Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Servicios web de Analytics (API de SOAP y REST) </td> 
   <td colname="col2"> <p> <b>Aviso de fin de compatibilidad</b> </p> <p> La versión 1.2 de la API de servicios Web quedó obsoleta oficialmente el 20 de febrero de 2014. Llegará a su fin el 15 de septiembre de 2016. En ese momento, Adobe eliminará la capacidad de los servidores de API para responder a las solicitudes de API de la versión 1.2. Cualquier solicitud de API efectuada al extremo <span class="filepath">https://api.omniture.com/admin/1.2</span> devolverá un error 410. 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Mejora de la Audiencia direccionable 1.1 </p> </td> 
   <td colname="col2"> <p>Esta actualización mejora la precisión de la audiencia direccionable a nivel de segmento y presenta el alcance de audiencia actual a nivel de segmento para la planificación y revisión de campañas. Consulte <a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html" format="https" scope="external">Audiencias a las que puede dirigirse </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Existen nuevas métricas de vídeo a nivel de página y a nivel de publicación de Facebook. [Consulte las nuevas métricas.](https://marketing.adobe.com/resources/help/es_ES/social/c_fb-video-metrics.html)
* Ahora las publicaciones que se retwitteen desde [!DNL  Adobe Social] tendrán el mismo aspecto que si se hubieran retwitteado directamente en Twitter.  Para obtener más información, consulte [Moderar un tweet](https://marketing.adobe.com/resources/help/en_US/social/t_mod_individual_tweet.html) individual y [Publicar un tweet](https://marketing.adobe.com/resources/help/en_US/social/t_post-quoted-retweet.html)citado.
* Las etiquetas sociales estarán disponibles en Adobe Analytics a partir del 1 de octubre (fecha exacta por determinar).
   * Después del 1 de octubre, [!DNL  Adobe Social] los usuarios podrán utilizar etiquetas [](https://marketing.adobe.com/resources/help/en_US/social/c_settings_tag_manr.html) sociales para clasificar el contenido saliente e informar sobre este contenido en [!DNL  Adobe Analytics]. Para entrar en esta lista para obtener acceso a esta nueva función, póngase en contacto con su gestor de cuentas de [!DNL  Adobe Social] o con la asistencia técnica de Social. A partir de entonces recibirá actualizaciones sobre los pasos siguientes relativos a la obtención de acceso así como ayuda de capacitación.
...
<table id="table_5AB641198DF34491AE6D411A9BA32B51"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> <a href="https://docs.adobe.com/docs/en/aem/6-2/release-notes/communities.html#Feature%20Pack%201" format="https" scope="external">El paquete de funciones 1 de Communities 6.2</a> y el <a href="https://docs.adobe.com/docs/en/aem/6-1/release-notes/communities.html#Feature%20Pack%205" format="https" scope="external">paquete de funciones 5 6.1</a> se lanzaron el 30 de agosto de 2016. La versión incluye lo siguiente: </p> 
    <ul id="ul_D560F15F3ED64CD69E3D32CC48AA2740"> 
     ...
     <li id="li_1F479A90D5354A01A209FF083D507DBB">Mejoras en el marco de componentes sociales. </li> 
     <li id="li_64A4A029E43D4BDABFB8F677B6799749">Moderación masiva. </li> 
     <li id="li_D0BAD5C6DCDF47EDB285050E0ADFDE2C">Sitios de la comunidad llave en mano. </li> 
     <li id="li_ED2EE64CB05143559D007F466EDD03C0">Actualizaciones de plataformas y muestras. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.1 Service Pack 2 incluye lo siguiente: </p> 
    <ul id="ul_83264665F5074087B793358B37CBDFB8"> 
     ...
     <li id="li_0FBFB1A818D745489F0E5FF6F3BB44D3"> Se realizaron mejoras entre las versiones 1.2.7 de Oak (incluidas en AEM 6.1 SP1) y 1.2.16 (incluidas en SP2). </li> 
     <li id="li_D414073C0B3E473E9B3352649C2B48C2">Eliminación de discrepancias y errores en el proceso de edición de ajustes preestablecidos de recursos. </li> 
     <li id="li_D8B8C9D43F804D44875D6D343AD630CE"> Se ha aumentado la capacidad de respuesta de los modos de creación y se han mejorado los componentes funcionales en los sitios, como el componente carrusel. </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Para mejorar la experiencia del cliente en el mantenimiento de la AEM, el modelo de envío de corrección urgente para AEM está cambiando para AEM 6.1. </p> <p>En lugar de lanzar correcciones urgentes para problemas aislados, tenemos previsto el lanzamiento de un CFP (Cumulative Fix Pack) para cada mes. Un CFP tiene las siguientes ventajas para las correcciones rápidas únicas: </p> 
    <ul id="ul_DFA24E2E62124EC4AF43F3FB7DC83A04"> 
     <li id="li_1C01F055E5CB42F996C811B248AA161C"> Mayor nivel de garantía de calidad. </li> 
     <li id="li_53AAAC84D1BF4DEE94101BC843A26231"> Simplifica la experiencia de instalación. Es decir, ninguna dependencia excepto el último Service Pack. </li> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM seminarios web de GEM </p> </td> 
   <td colname="col3"> <p>El último seminario web grabado de GEM titulado "Configurar y configurar medios dinámicos AEM" está disponible para verlo en los siguientes enlaces: </p> 
  ...
  <tr> 
   <td colname="col2"> <p>adaptarTo() </p> </td> 
   <td colname="col3"> <p>AEM evento de la comunidad de desarrolladores organizado por Pro!Vision, del 26 al 28 de septiembre en Berlín. </p> <p>Entradas disponibles en: <a href="https://adapt.to/2016/en.html">https://adapt.to/2016/en.html</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Anuncio importante sobre los cambios de permisos que se producirán en otoño de 2016. </p> </td> 
