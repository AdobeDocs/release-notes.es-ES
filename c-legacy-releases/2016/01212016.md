...
<table id="table_FDDBAC10B423475289A83A653402E2F3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Actualización del evento <span class="varname">prodView</span> </p> </td> 
...
|---|---|
| Inicio de sesión único | Compatibilidad agregada para el inicio de sesión único de Marketing Cloud. [Más...](https://marketing.adobe.com/resources/help/en_US/arb/login.html) |
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_703C6AE547154BB9A6D535E376DC6479">(AN-113889) Problema conocido: no puede usar la vinculación de informes (URL) si su empresa usa el inicio de sesión único preexistente o inicia sesión mediante Marketing Cloud. También se aplica a los proyectos de Analysis Workspace. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2016/01212016.md#mcvid" format="dita" scope="local"> Servicio de Marketing Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Importantes actualizaciones y adiciones a la documentación de Adobe Marketing Cloud. 
