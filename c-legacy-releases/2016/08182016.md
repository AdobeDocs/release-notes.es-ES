...
* Funciones agregadas para el código VisitorAPI.js que determinan si el servicio de ID ha generado el ID de [!DNL  Marketing Cloud] del lado del cliente o lado del servidor, o si se agotó el tiempo de espera de las llamadas de ID. Consulte las [funciones de seguimiento de tiempo de espera](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-timeout-functions.html) y [la generación de seguimiento de la ID de visitante del lado del cliente](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-client-side-id.html). (MCID-116)
