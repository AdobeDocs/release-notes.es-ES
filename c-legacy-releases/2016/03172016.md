...
La versión 1.5.4 incluye los siguientes cambios:

| Función | Descripción |
|--- |--- |
| Compatibilidad con la exclusión | El servicio de ID de Experience Cloud ofrece soporte para las solicitudes de anulación de la suscripción de visitantes. (AAM-21725) |
...
Se han revisado los procedimientos de implementación de servicio de ID para los clientes de [!DNL  Analytics]. Consulte [Configuración del servicio de ID de Marketing Cloud con Analytics](https://docs.adobe.com/content/help/es-ES/id-service/using/home.html).
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A477D5A9DEAE4B4092990612AB2A0A59">Se ha corregido un problema con la Análisis de contribución que provocaba que las etiquetas del panel de exploración en profundidad se duplicaran. (AN-118627) </li> 
      ...
      <li id="li_680B0AA9884B450B9E88CA9885C698FD">Se ha corregido un problema con la configuración del separador de miles que volvía al formato de EE.UU. (de un formato alemán). (AN-117894) </li> 
...
* Se ha corregido un problema de la interfaz de usuario por el que las publicaciones en fuentes de moderación con vínculos largos contenían barras de desplazamiento horizontales.
* Se ha corregido un problema que impedía que algunas publicaciones se mostraran en las fuentes de moderación de escalación.
...
|--- |--- |
| Foro de AEM Assets | Ya está en marcha nuestro nuevo subforo de AEM Assets. Este foro abarca: Recursos (in situ), Recursos On Demand, Brand Portal, Medios dinámicos y Scene7. Cualquiera puede iniciar sesión y publicar, solo tiene que iniciar sesión con su Adobe ID. |


| Conferencia | Descripción |
|--- |--- |
| Adobe Immerse | Immerse es una conferencia virtual para desarrolladores de Adobe Experience Manager que se celebrará entre el 25 y el 29 de abril. Este evento es una cita obligatoria para todo aquel que sea responsable del diseño, el desarrollo, la implementación o el mantenimiento de las implementaciones de Adobe Experience Manager.  Para obtener más detalles y entradas, consulte la página web de Adobe Immerse. |

| Dispatcher | Descripción |
|--- |--- |
| Dispatcher 4.1.12 | Hay una nueva versión de Dispatcher disponible para su descarga. |
