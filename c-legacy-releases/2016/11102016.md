...
### Interfaz de Marketing Cloud 16.11.1 {#marketing_cloud_interface}
...
* Se ha corregido un problema con las contraseñas técnicas que provocaba un error al compartir carpetas entre Creative Cloud y Marketing Cloud. (MAC-31067, MAC-32014)
...
<table frame="all" colsep="1" rowsep="1" id="table_812CAB7DDC364DAABB7CDEDE55532E39"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Se ha añadido la marca de fecha y hora y el ID de organización de Marketing Cloud al parámetro <span class="codeph">adobe_mc</span>. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2016/11102016.md#mcvid" format="dita" scope="local"> Servicio de Marketing Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
  <tr> 
...
* Si usa una cuenta de usuario de Marketing Cloud para iniciar sesión en Audience Manager y se ha olvidado de la contraseña, tiene que ir a la página de inicio de sesión de Marketing Cloud para restablecerla. Consulte [Requisitos de contraseña, cuentas bloqueadas y contraseñas olvidadas](https://marketing.adobe.com/resources/help/en_US/aam/c_password_requirements.html)
* Pequeños cambios de flujo de trabajo e interfaz de usuario en el vínculo de perfil para ofrecer compatibilidad con las opciones de cooperación entre dispositivos de Adobe Marketing Cloud. (AAM-25988) Consulte [Vínculo de perfil](https://marketing.adobe.com/resources/help/en_US/aam/profile-link-intro.html).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Facebook Exchange (FBX), de Facebook, está obsoleto desde el 1 de noviembre de 2016. Los anuncios existentes de FBX ya no se muestran. Todo el material y las estrategias publicitarias de FBX que haya creado quedarán en pausa en Media Optimizer en todo lo referente a los informes. Los puede eliminar, pero no activar ni editar. Tampoco puede crear materiales ni estrategias publicitarias nuevas de FBX. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora se puede acceder al foro de la comunidad de Media Optimizer desde ? &amp;gt; Comunidad, en la parte superior de cualquier página. </p> </td> 
  </tr> 
 </tbody> 
</table>
