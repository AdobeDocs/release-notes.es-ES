...
>* Al utilizar la biblioteca del servicio Marketing Cloud ID 2.0.0 +, la sincronización de ID se iniciará de forma predeterminada para Adobe Advertising Cloud. Consulte [Conceptos básicos de sincronización de ID y tasas de coincidencia](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Facebook Exchange (FBX), de Facebook, está obsoleto desde el 1 de noviembre de 2016. Los anuncios existentes de FBX ya no se muestran. Cualquier estrategia publicitaria y de publicidad de FBX que haya creado permanecerá pausada en Advertising Cloud para generar informes. Los puede eliminar, pero no activar ni editar. Tampoco puede crear materiales ni estrategias publicitarias nuevas de FBX. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora puede acceder al foro de la comunidad de Marketing Cloud desde? &amp;gt; Comunidad, en la parte superior de cualquier página. </p> </td> 
  </tr> 
 </tbody> 
</table>
