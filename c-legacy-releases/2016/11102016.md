...
>[!IMPORTANT]
>
>**EnterpriseTV** dejó de estar disponible el **9 de diciembre de 2016**. Los vídeos de producto están disponibles en [Adobe Video Learning](https://www.adobe.com/training/video.html). Tenga paciencia, ya que pueden aparecer vínculos rotos al migrar vídeos a la nueva ubicación. Cuando la migración se complete, el contenido de vídeo quedará incrustado en las páginas relevantes de la documentación del producto.
...
Para obtener ayuda sobre el producto, consulte [Documentación del producto de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcloud/).
...
>* Al usar la versión 2.0.0 o posterior de la biblioteca del servicio de Experience Cloud ID, la sincronización de ID para Adobe Media Optimizer se iniciará de forma predeterminada. Consulte [Explicación de la sincronización de ID y Tasas de coincidencia](https://marketing.adobe.com/resources/help/es_ES/mcvid/mcvid-match-rates.html).
...
Consulte documentación del producto [Experience Cloud ID Services ](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
[Inicio Ayuda de Primetime ](https://help.adobe.com/es_ES/primetime)
