...
Consulte [Eventos](https://experienceleague.adobe.com/events/?lang=en) en Experience League para mantenerse informado.
...
| [!DNL Inventory Inspector] | (Versión del 29 de junio) El [!UICONTROL Inventario] de la colocación [!UICONTROL Inspector] ahora incluye gráficos de visualización de datos personalizables y métricas de rendimiento ampliadas, como [!UICONTROL Tasa de visualización], [!UICONTROL Clics]y [!UICONTROL El CPM de ayer]. |
