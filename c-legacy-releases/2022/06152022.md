...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Junio de 2022 | [Texto del enlace](https://experienceleague.adobe.com/?lang=es&recommended=Target-D-1-2021.1&amp;lang=es) | Curso | Obtenga información sobre cómo implementar Adobe Target en el sitio web. A partir de temas administrativos, incluidos los requisitos y los permisos de usuario, el curso abarca métodos de implementación, consideraciones y prácticas recomendadas. |
