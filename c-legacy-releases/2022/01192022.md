...
## Guías del Experience Manager {#xml-doc}
...
* Para obtener información sobre la versión actual, consulte [Notas de la versión de Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=es).
