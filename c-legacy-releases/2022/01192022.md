...
| Enero de 2022 | [Trabaje de forma más inteligente con Acrobat DC y Microsoft® 365](https://experienceleague.adobe.com/?lang=es&recommended=Acrobat-U-1-2021.microsoft365&amp;lang=es) | Curso | Descubra poderosas herramientas de PDF dentro de [!DNL Microsoft® 365] y [!DNL Acrobat DC] para reemplazar flujos de trabajo de documentos obsoletos y rotos. Aprenda a automatizar los procesos manuales de documentos para evitar retrasos y errores, mejorar la seguridad y la productividad y ofrecer experiencias excepcionales para clientes y empleados, todo ello dentro de las herramientas Microsoft® y Acrobat que ya utiliza. |
