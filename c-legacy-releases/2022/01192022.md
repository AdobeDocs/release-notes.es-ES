...
* Para obtener información sobre la versión preliminar de Adobe Target, consulte las notas de la versión de la [Versión preliminar de Adobe Target](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html).
* Para obtener información actual, consulte [Notas de la versión de Target](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
