...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Las funciones [!UICONTROL Recorte inteligente de imagen] y [!UICONTROL Muestra inteligente] de Dynamic Media ahora cuentan con la tecnología de los servicios más recientes de Sensei, que genera recortes y muestras mejorados. Además, se ha iniciado una mejora para generar diferentes contenidos de recortes para la misma proporción de aspecto, pero en diferentes resoluciones. Además, las ediciones manuales se conservan cuando se reprocesa si no hay cambios en la anchura y la altura del perfil de imagen.
