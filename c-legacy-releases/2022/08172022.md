...
Vea el [vídeo de información general sobre la versión de julio de 2022](https://video.tv.adobe.com/v/3454199/?quality=12&captions=spa) para obtener un resumen de las funciones añadidas en la versión 2022.7.0 (julio de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
| Agosto de 2022 | [Creación de un calendario personalizado](https://experienceleague.adobe.com/?lang=es&recommended=Workfront-U-1-2022.4.reporting&amp;lang=es) | Curso | Con un calendario personalizado, puede mostrar fechas e información directamente de proyectos, tareas y problemas en formato de calendario. |
