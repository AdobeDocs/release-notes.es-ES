...
| [!UICONTROL Audiencias]<br><br> de Campaign [!UICONTROL Hojas de edición por lotes] de Campaign | (Versión del 12 de marzo, campañas de [!DNL Microsoft® Advertising]). Ahora puede usar cualquiera de sus audiencias de [!DNL Microsoft® Advertising], excepto para audiencias de mercado como objetivos de nivel de campaña o de nivel de [!UICONTROL grupo de anuncios]. Anteriormente, solo podía utilizarlas como objetivos de nivel de [!UICONTROL grupo de anuncios]. |
