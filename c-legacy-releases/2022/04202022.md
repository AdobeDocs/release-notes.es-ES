...
| ------| ----- | ------ | ------ |-----|
| Abril de 2022 | [Generación de documentos mediante la API de comunicación](https://experienceleague.adobe.com/?lang=es&recommended=ExperienceManager-D-1-2022.3.formscs&amp;lang=es) | Curso | Combine datos con la plantilla xdp invocando los extremos HTTP de Forms CS. | AEM Forms |
