...
| [!UICONTROL Campañas], [!DNL Advanced Campaign Management], [!UICONTROL Informes] | (Versión del 16 de julio) (campañas de [!DNL Google Ads] y [!DNL Microsoft Advertising]). Ya está disponible la siguiente compatibilidad para anuncios adaptables de búsqueda:<ul><li>La vista [!UICONTROL Anuncios] ahora muestra vistas previas de anuncios de búsqueda adaptables.</li><li> (Desde el 20 de junio). Ahora puede crear variaciones de anuncios dinámicos de búsqueda adaptables utilizando una plantilla de anuncio específica del motor de búsqueda, basada en el contenido de su inventario, desde [!UICONTROL Campañas] > [!UICONTROL Avanzado (ACM)].</li><li>La variable [!UICONTROL Informe de variación de anuncio] incluye dos nuevas columnas personalizadas: &quot;[!UICONTROL Títulos creativos],&quot; que agrega una columna para cada título de la publicidad (&quot;[!UICONTROL Título creativo]&quot; a &quot;[!UICONTROL Título creativo15]&quot;) y &quot;[!UICONTROL Descripciones],&quot; que agrega una columna para cada una de las filas de descripción de la publicidad (&quot;[!UICONTROL Descripción 1]&quot; a &quot;[!UICONTROL Descripción4]&quot;). Cuando se incluyen estas columnas, no es necesario incluir las demás columnas Título creativo y Descripción .</li></ul> |
