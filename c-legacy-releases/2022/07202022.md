...
| [!UICONTROL Campañas], [!DNL Advanced Campaign Management], [!UICONTROL Informes] | (Versión del 16 de julio) (campañas de [!DNL Google Ads] y [!DNL Microsoft Advertising]). Ya está disponible la siguiente compatibilidad para anuncios adaptables de búsqueda:<ul><li>La vista [!UICONTROL Anuncios] ahora muestra vistas previas de anuncios de búsqueda adaptables.</li><li> (Desde el 20 de junio). Ahora puede crear variaciones de anuncios dinámicos de búsqueda adaptables utilizando una plantilla de anuncio específica del motor de búsqueda, basada en el contenido de su inventario, desde [!UICONTROL Campañas] > [!UICONTROL Avanzado (ACM)].</li><li>El [!UICONTROL Informe de variaciones de anuncios] incluye dos nuevas columnas personalizadas: [!UICONTROL Títulos creativos], que es una lista separada por comas de las filas de títulos del anuncio y [!UICONTROL Descripciones], una lista separada por comas de las filas de descripciones del anuncio.</li></ul> |
