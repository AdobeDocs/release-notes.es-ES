...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Informes personalizados] | (31 de mayo) función beta) Advertising Cloud DSP ahora puede introducir segmentos de origen compuestos de señales autenticadas creadas dentro de una plataforma de datos del cliente (CDP). |
| Objetivos de optimización | (25 de mayo) El vídeo y las ubicaciones nativas ahora se pueden incluir en paquetes con los objetivos personalizados [!UICONTROL ROAS más altos] y [!UICONTROL CPA más baja]. |
...
| Integración con Adobe Analytics | (7 de mayo) En la fuente de datos a la que Advertising Cloud envía [!DNL Analytics], datos para [!DNL Google Ads] los anuncios de búsqueda dinámica solo están disponibles hasta el nivel de grupo de anuncios a partir del 7 de mayo de 2022. |
