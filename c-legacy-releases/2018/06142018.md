...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Ahora los registros de uso de Analytics permiten realizar un seguimiento del momento en el que un usuario abre un proyecto en [!UICONTROL Analysis Workspace], además del seguimiento ya existente al crear, actualizar, dejar de compartir y eliminar acciones. Esto ofrece una mejor visibilidad sobre los usuarios que usan Workspace y la frecuencia con la que lo hacen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
