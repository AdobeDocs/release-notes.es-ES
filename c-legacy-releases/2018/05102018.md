...
>[!NOTE]
>
>Para recibir notificaciones por correo electrónico sobre próximas versiones, suscríbase a [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html) Recibirá el aviso entre tres y cinco días laborables antes del lanzamiento de la versión. La nueva información publicada tras el lanzamiento se marcará con la fecha de publicación.
...
Durante la semana del 7 de mayo de 2018, Adobe lanzó actualizaciones de productos para admitir la [El Reglamento general de protección de datos(RGPD)](https://www.eugdpr.org). La siguiente información está disponible para ayudar a entender e implementar estas mejoras, así como para actualizar cualquier política y procedimiento necesarios.
...
Consulte [la documentación del producto de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcloud/) para obtener ayuda sobre el producto.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Lanzamiento planificado para el 15 de mayo de 2018</b> </p> <p> <span class="term"> Se ha añadido la columna mc_audiences</span>. <span class="term"> mc_audiences</span> es la lista de ID de segmento de Audience Analytics de Adobe [!DNL Audience Manager]. </p> <p>Nota: Esta no incluye nombres descriptivos porque son una clasificación del ID. </p> 
...
* Se ha corregido un error en la visualización de código del[ creador de segmentos](https://marketing.adobe.com/resources/help/es_ES/aam/c_segment_builder.html) en el que los paréntesis se eliminaban de las expresiones que los contenían si los clientes volvían a editar el segmento. (AAM-36393)
