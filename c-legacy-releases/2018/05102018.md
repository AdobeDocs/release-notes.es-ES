...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external">  <span class="wintitle"> Audience Manager </span> y RGPD </a> </p> </td> 
...
<table id="table_FC7B5C6C59BD45238220D606D7BFC0A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Al iniciar sesión en Experience Cloud y navegar a la página Administración, hay una nueva interfaz intuitiva que le ayudará a acceder rápidamente a sus soluciones de Experience Cloud y a los servicios principales. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>10 de mayo de 2018 </p> </td> 
   <td colname="col2"> <p>El informe Actividad de la cuenta se reemplazará con la función Uso de llamadas al servidor en el lanzamiento de verano de Adobe Analytics. El Informe de Actividad de cuentas se eliminará de forma permanente el 9 de agosto de 2018. Para vista de datos de resumen sobre el tráfico de grupos de informes después del 9 de agosto de 2018, utilice la función Uso de llamadas del servidor. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Importante:</b><a href="https://marketing.adobe.com/resources/help/es_ES/arb/t_install_arb.html" format="html" scope="external"> Actualice Report Builder a la versión más reciente. </a> A partir del mes de abril de 2018, esta actualización será un requisito previo para poder llevar a cabo la migración de los ID de usuario de Analytics a Admin Console. </p> </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/es_ES/experience-cloud/admin-console/analytics-migration/" format="https" scope="external"> Migración de usuarios de Analytics a Admin Console </a> para obtener información al respecto.
   </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Analytics le permite pasar los datos del motor de búsqueda a Adobe Analytics desde Google AdWords, Yahoo! y Bing. </p> <p>Dispone de las siguientes métricas disponibles para realizar sistemas de informes en paralelo con el resto de los datos de Analytics: </p> 
    <ul id="ul_12C905738789481BA6C0C5CCF2151EC6"> 
     ...
     <li id="li_68A012A841FF4A0E96FC7682B1A4A044">Posición promedio </li> 
    </ul> <p>Además, dispone de las siguientes dimensiones en Analytics: </p> 
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     <li id="li_B75433D55E0246C1AF2C86FDC830193A">Tipo de coincidencia de palabra clave (ID de AMO) </li> 
     <li id="li_D0C425C5C99C4097B9465BB656872914">Plataforma de publicidad (ID de AMO) </li> 
     <li id="li_6CBD1FC70A134A088B4CD3C4854BBB9D">Cuenta (ID de AMO) </li> 
     <li id="li_3BF0E1D0E86C4E0A8A7CFB612EF728B0">Campaña (ID de AMO) </li> 
     <li id="li_6F8CD2AD76DF4B50A87720F3FE88B39D">Grupo de publicidad (ID de AMO) </li> 
     <li id="li_906E6AA5E2264995884C658B34E436CE">Anuncio (ID de AMO) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics Connector está disponible como conector de datos nativo en la experiencia de escritorio de Power BI. Cuando se inicia, puede autenticarse con el Adobe ID existente. A continuación, puede acceder a un navegador fácil de usar a los elementos de datos del grupo de informes y generar solicitudes de datos. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Las sesiones contextual permiten a los analistas móviles y a los administradores de productos definir cómo les gustaría tratar una visita para su aplicación móvil de forma retroactiva. Agrega la capacidad de procesar visitas en segundo plano fuera de una visita y de realizar visitas de inicio durante el inicio de la aplicación. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Sistema de informes: Cambio en la dimensión Códigos postales de Visitante </p> </td> 
   <td colname="col2"> <p>Hemos actualizado la dimensión Códigos postales de Visitante para ponerla en línea con otras variables geográficas de modo que el primer valor de una visita recibe crédito por esa visita. </p> <p>Por ejemplo: si ejecuta un informe Ciudades y lo desglosa por Códigos postales de Visitante, solo se mostrará el primer valor de cada visita en el desglose. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Cambio en las clasificaciones </p> </td> 
   <td colname="col2"> <p>La interfaz de usuario de Clasificaciones se ha actualizado para finalizar la compatibilidad con tipos de clasificación numéricos y habilitados para datos. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Se han efectuado los cambios siguientes en la interfaz de usuario de etiquetado de control de datos en Analytics: </p> 
    <ul id="ul_67929C32C8064D428216173D06C449BA"> 
     ...
     <li id="li_B6663A0FACA644A3AF11606892186CDC">Los valores de campo etiquetados como <span class="uicontrol"> DEL-DEVICE </span> se convertirán en anónimos solo cuando haya presente una etiqueta <span class="uicontrol"> ID-DEVICE </span> especificada en el evento. No se cambiarán otras instancias de estos valores, que se producen en eventos que no se están eliminando. Como resultado, los informes que calculan recuentos únicos en el campo pueden cambiar. En dispositivos compartidos, se pueden eliminar los identificadores de otras personas que no pertenezcan al asunto de datos. </li> 
     <li id="li_3E30CF2F973B46229D3726FC2320868B">Se ha quitado la etiqueta <span class="uicontrol"> No eliminar </span>. </li> 
     <li id="li_BCB7DF19FA81459E9BE598B19C956460">Se ha añadido la capacidad de exportar las etiquetas de control de datos en las variables a un archivo .csv. Esto facilita el uso compartido de etiquetas con su equipo de abogados. </li> 
     <li id="li_CF202A81A675463BA3BC6783D9C9E0A1">Los valores de muestra añadidos para las dimensiones facilitarán la visualización del tipo de datos que contiene cada variable y de cómo se debe etiquetar. </li> 
    </ul> <p>Además, </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Lanzamiento planificado para el 15 de mayo de 2018</b> </p> <p> <span class="term"> Se ha añadido la columna mc_audiences</span>. <span class="term"> mc_audiencias </span> es la lista de ID de segmento de Audience Analytics del <span class="wintitle"> Audience Manager de Adobes </span>. </p> <p>Nota: Esta no incluye nombres descriptivos porque son una clasificación del ID. </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>API de Media Collection </b> </p> <p> Los editores de medios que no hayan podido cuantificar completamente sus reproducciones de vídeos, ya sea a causa de restricciones del SDK de VA o a que dicho SDK de Video Analytics (VA) no sea compatible, pueden aplicar la API de recopilación de medios a estos dispositivos. Esto permite a los clientes tener transparencia frente a todos los dispositivos en los que sus usuarios vista los vídeos, incluidos dispositivos como auriculares VR, consolas de juegos, etc. La API de Media Collection proporciona métricas granulares y estandarizadas a través de la colección de SDK de VA de Heartbeat. Ahora puede combinar esas métricas para ver el viaje completo del cliente. </p> 
    <ul id="ul_FD2036F9D160400AAB654CEE30657AAB"> 
     <li id="li_5F4D87F536F6436DAD99F6CDB878BD52">Medir Vídeo En Cualquier Dispositivo: Aplique la API de Media Collection en cualquier dispositivo que no sea compatible con SDK actualmente, incluidas las consolas de juegos y los dispositivos VR. </li> 
     <li id="li_2DEE2FE8ED26476CA4C25163D4803345">API RESTful para cumplir con el SDK de VA: La API de recopilación de medios se ha creado para proporcionar un mecanismo de medición eficiente y optimizado para lograr los mismos resultados granulares y métricas disponibles mediante el SDK. </li> 
     <li id="li_F4D509A6904C484AA1F0BDFAEA678F8A">Medición holística de Audiencias: La API de Media Collection ahora puede proporcionar una vista holística de todas las participaciones de los clientes con vídeo para obtener una perspectiva más precisa del alcance total de los clientes. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Componente/herramienta del producto </th> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">Se ha corregido un problema que se producía al abrir el Creador de métricas calculadas de [!UICONTROL Analysis Workspace]. Esto hacía que la lista desplegable Función no mostrara ninguna opción. (AN-160698) </li> 
      <li id="li_C24CD6D3CDF748A0B959D44A4DF41C6A">Se corrigieron varios problemas con la función Buscar en tablas improvisadas. El resultado es una experiencia de edición mejorada para consultas de filtro básicas y avanzadas. (AN-159843) </li> 
      ...
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">Se ha corregido un problema que provocaba que las visualizaciones de texto se establecieran de forma predeterminada en la parte superior de la página y que no se pudieran colocar en la ubicación deseada. (AN-159148) </li> 
      <li id="li_ABD6A21F42664A3EAEE0036388831B8B">Se ha corregido un problema que provocaba un problema de entrada de caracteres japoneses y coreanos en el campo Buscar de las tablas de forma libre. (AN-158778) </li> 
      <li id="li_A4F55515A9CA4845A4662DEA5712EE77">Se ha corregido un problema que provocaba cambios en las fechas de modificación del proyecto cuando los no administradores favorecían, aplicaban etiquetas o aprobaban proyectos. (AN-157398) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">Se corrigió un problema en el Generador de segmentos, en el cual el etiquetado de las opciones Solo antes de la secuencia y Solo después de la secuencia se cambiaba y ahora se restauraba. (AN-160747) </li> 
      <li id="li_ED686B21894E4309841C7E322BB35843">Se ha corregido un problema que provocaba que los usuarios no administradores tuvieran acceso a algunas herramientas de grupos de informes. (AN-159451) </li> 
      ...
      <li id="li_7AF0C1DF79844130B488EDAF27A35B91">Se ha corregido un problema con la función de caducidad de contraseña en Configuración de Compañía. (AN-154927) </li> 
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">Se ha corregido un problema que impedía que la funcionalidad Transferir recursos funcionara si el usuario cuyos recursos se iban a transferir se enumeraba como propietario de alertas. (AN-160747) </li> 
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">Se ha corregido un problema que se producía al iniciar sesión en Analytics a través del Experience Cloud: cuando se asociaban varias compañías de inicio de sesión con un nombre de usuario, a veces se seleccionaba una compañía de inicio de sesión incorrecta. (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>API de Sistema de informes de servicios Web </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Hemos lanzado la versión 7.0 de DIL, que incluye las siguientes mejoras y correcciones: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      ...
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">Se implementaron revisiones UX de la extensión de lanzamiento de DIL. (CORE-8143) </li> 
     </ul> </p> <p>Póngase en contacto con su asesor de Adobe o con el servicio de atención al cliente para obtener la última versión, o bien consígala en <a href="https://marketing.adobe.com/resources/help/es_ES/dtm/c_overview.html" format="https" scope="external"> Dynamic Tag Management (DTM) </a> o <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external"> Adobe Launch </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Preparación para el RGPD </p> </td> 
   <td colname="col2"> <p>As we approach the May 25th, 2018 date at which the European General Data Protection Regulation (GDPR) comes into law, we have prepared documentation to assist you in managing consumer data in  <span class="wintitle"> Audience Manager </span> to meet GDPR obligations. Más información: </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> RGPD en Audience Manager </a> </p> </li> 
...
* Se ha corregido un error que impedía a los clientes recuperar una lista de todas las características mediante llamadas de API. (AAM-36824)
* Se ha corregido un error en la vista de código del Generador [de](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) segmentos por el que las expresiones que contenían paréntesis soltarían los paréntesis si los clientes volvían a editar el segmento. (AAM-36393)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Etiquetas personalizadas inteligentes AEM 2.1 </p> </td> 
   <td colname="col3"> <p>La última versión de Etiquetas inteligentes mejoró las claves, como por ejemplo: </p> <p> 
     <ul id="ul_1F32257EF31548F986B7D547056BDB3C"> 
      <li id="li_4EDD96DF180B436CB817B8E1B150F1DF">Optimizaciones del algoritmo para mejorar aún más la precisión del modelo, recuperar valores. </li> 
      <li id="li_86039BFA4E2E4B16A24F44A2FF710431"> Compatibilidad para restablecer la formación de modelos para todas las etiquetas en el nivel de inquilino. </li> 
      <li id="li_7363B9318FB1492A9F067B7F534C5355">Compatibilidad con Áreas de nombres de etiquetas inteligentes mejoradas para evitar conflictos. </li> 
      ...
      <li id="li_956259E154DC43DDAFE59836511AF87E">Supervisión del uso del servicio por inquilino. </li> 
      <li id="li_352CE4CD51AC4F798B11F6C2C0E9090C">Problemas específicos de clústeres resueltos para mejorar la solidez del servicio. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM y RGPD </p> </td> 
   <td colname="col3"> <p>El RGPD de la Unión Europea (Reglamento general de protección de datos) sobre derechos de privacidad de datos entrará en vigor en mayo de 2018. Obtenga más información sobre AEM y el <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external"> cumplimiento del RGPD </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>La conferencia global virtual anual ofrece sesiones exhaustivas para desarrolladores empresariales, arquitectos y científicos de datos en todos los niveles de experiencia. Las sesiones en directo se llevan a cabo en las zonas horarias estándar de la India, británica de verano y del Pacífico. Los titulares de entradas también tienen acceso ilimitado a todas las grabaciones durante un año. </p> <p>Adobe IMMERSE es la conferencia mundial virtual anual para cualquier desarrollador que esté creando soluciones en Adobe Experience Manager. También tenemos sesiones adicionales este año en Adobe Cloud Platform, E/S de Adobe, Adobe Sensei, ColdFusion y FrameMaker. </p> <p>Obtenga presentaciones detalladas de productos, fórmulas de "cómo", prácticas recomendadas y ejemplos de código de expertos de Adobe y de la comunidad de desarrolladores más amplia. Las sesiones en directo se retransmitirán en tres zonas horarias: </p> <p> 
     <ul id="ul_BDA2A6B569EF422B9327FBF7474D7D98"> 
      <li id="li_69F4FDE29DE14B1A969F428CB3A1A5A6">América (hora estándar del Pacífico) </li> 
      <li id="li_E3EA932CAA4F4122ACC7982CA1856CD1">Europa (hora británica de verano) </li> 
      <li id="li_673F096F6C7541FB8F3FAA21914852F7">APAC (hora estándar de India) </li> 
     </ul> </p> <p>Consulte la programación y, después, regístrese en el siguiente enlace: <b>https://adobe.ly/immerse18 </b>. Use el código <a href="https://adobe.ly/immerse18" format="https" scope="external"> MR765z </a> para disfrutar de un descuento de 25 USD. No se pierda la conferencia de desarrolladores más grande organizada por Adobe! </p> </td> 
  </tr> 
  <tr> 
