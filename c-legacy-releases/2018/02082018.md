...
>[!NOTE]
>
>Para recibir notificaciones sobre las notas de la versión anteriores, suscríbase a [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html). La actualización de producto prioritaria se envía entre tres y cinco días laborables antes del lanzamiento. Vuelva a consultar las actualizaciones cuando se produzca el lanzamiento. La nueva información publicada tras el lanzamiento se marcará con la fecha de publicación.

## Fórmulas de Experience Cloud

[Fórmulas de Experience Cloud](https://helpx.adobe.com/es/marketing-cloud/how-to/use-cases.html) le ayuda a implementar e integrar flujos de trabajo y integraciones entre soluciones.
...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Compromiso de aplicación [!UICONTROL Mobile] </p> </td> 
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Retirada de los flujos de trabajo de [!DNL Target] en [!UICONTROL Mobile] Services </p> </td> 
     <td colname="col2"> <p> A partir de marzo de 2018, como parte del proceso de inhabilitación de los flujos de trabajo de Adobe [!DNL Target] en Adobe [!UICONTROL Mobile] Services, en esta versión se ha eliminado la posibilidad de crear nuevas actividades, audiencias y contenido de [!DNL Target]. </p> <p> Puede seguir consultando, modificando y eliminando las actividades, las audiencias y el contenido existentes hasta marzo de 2018. </p> <p>Para obtener más información, consulte <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Retirada de los flujos de trabajo de [!DNL Target] en Mobile Services </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      ...
      <li id="li_2C28D135394C4B3599E0262BDE761ED5">Se ha corregido un problema que provocaba </li> 
...
* API DCS: hemos incorporado un nuevo código de error (198) que indica que un colaborador bloquea las solicitudes procedentes de este país. Obtenga más información en las referencias de la [API de DCS ](https://marketing.adobe.com/resources/help/es_ES/aam/dcs_error_codes.html).
...
* [Documentation de Adobe Campaign Classic](https://helpx.adobe.com/es/support/campaign/classic.html)
