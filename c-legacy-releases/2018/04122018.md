...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics proporciona herramientas para etiquetar los datos según su sensibilidad y restricciones contractuales. </p> <p>Las etiquetas son importantes y útiles para ayudar a: (1) identificar a los sujetos de datos, (2) determinar qué datos devolver como parte de una solicitud de acceso y (3) identificar los campos de datos que deben eliminarse como parte de una solicitud de eliminación. </p> <p>Nota: El etiquetado es un prerrequisito básico para poder enviar solicitudes de Acceso y Eliminacion a través de la API RGPD de Adobe. La API se lanzará próximamente. </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    <ul id="ul_950CF9A77CB242F0A121A7BE25184318"> 
     ...
     <li id="li_FE78F1A179604EB8AD95596B1A864F5F"> La cookie de seguimiento de vínculos se escribe una vez que se desactiva el seguimiento de vínculos. (AN-156332) </li> 
