...
>[!NOTE]
>
>Para recibir notificaciones por correo electrónico sobre las notas de la versión anteriores, suscríbase a [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html). La actualización de producto prioritaria se envía entre tres y cinco días laborables antes del lanzamiento. Vuelva a consultar las actualizaciones cuando se produzca el lanzamiento. La nueva información publicada tras el lanzamiento se marcará con la fecha de publicación.
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external"> [!DNL Audience Manager] y el RGPD </a> </p> </td> 
...
para obtener ayuda sobre el producto, consulte [La documentación de producto de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcloud/).
...
Consulte la documentación del producto [Experience Cloud ID Services](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
* Esta versión añade dos parámetros DCS: ` d_tdpid` y ` d_tdpid_ic`. Permiten restringir la evaluación de características a aquellas de una lista de fuentes de datos. Los dos nuevos parámetros se describen en su totalidad en nuestro [material de referencia DCS](https://marketing.adobe.com/resources/help/es_ES/aam/dcs-keys.html).
* Hemos actualizado la forma de calcular la métrica de ID entre dispositivos en Reglas de combinación de perfiles. Ahora, esta métrica refleja de forma más precisa los dispositivos totales vinculados a los ID de CRM para clientes que usan la autenticación en su estrategia entre dispositivos. Para obtener información más detallada, consulte la [documentación de reglas para combinar perfiles](https://marketing.adobe.com/resources/help/es_ES/aam/profile-link-metrics.html). (AAM-34509)
...
[Inicio Ayuda de Primetime](https://helpx.adobe.com/es/support/primetime.html ás)
...
* [Inicio Información y asistencia de AEM 6.4](https://helpx.adobe.com/support/experience-manager/6-4.html)
