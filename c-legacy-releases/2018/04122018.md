...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Cómo Adobe y [!DNL Target] trabajan con usted para cumplir con RGPD. </p> </td> 
  </tr> 
  <tr> 
...
* Se ha corregido un problema por el que el diseño del sistema de archivos y la jerarquía de directorios de servidor de Adobe Marketing Cloud era visible a través de Adobe Campaign. Se han realizado mejoras para ocultar la jerarquía de directorios y las carpetas restringidas. (CORE-5963)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td> <p>Adobe Analytics y GDPR </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_16206029F40F4862A56F55DB93987414"><b>[!UICONTROL Reports &amp; Analytics]</b>: se ha corregido un problema que impedía acceder al informe Sistema operativo [!UICONTROL Mobile] con permisos incompatibles. (AN-159152) </li> 
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>A partir del 29 de marzo de 2018, todos los clientes de [!DNL Audience Manager] que se encuentren en <a href="https://www.ampproject.org/learn/overview/" format="https" scope="external">Accelerated Mobile Pages</a> (AMP) tendrán que utilizar la integración del lado del servidor cuando envíen audiencias a DoubleClick for Publishers (DFP) de Google. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.3 SP2 (6.3.2.0), publicado el 5 de abril de 2018, es una actualización importante que incluye correcciones y mejoras clave de cliente relacionadas con el rendimiento, la estabilidad y la seguridad disponibles desde que AEM 6.3 se puso a la venta al público en abril de 2017. </p> <p>Algunas de las mejoras claves destacadas en 6.3.2.0 son las siguientes: </p> <p> 
     <ul id="ul_FAA1F9D8291B45B0BFE256418EF080EB"> 
      ...
      <li id="li_E4FF10EB28DD44B6889B82F47E27755F"> Nuevas API y servlet de ejemplo para satisfacer los requisitos de cumplimiento del GDPR de la UE. </li> 
