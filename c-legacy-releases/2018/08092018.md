...
Consulte [la documentación del producto de Experience Cloud ID Services](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
Para obtener información de versiones acumulativas, consulte [las notas de la versión de Data Workbench](https://marketing.adobe.com/resources/help/es_ES/insight/whatsnew/index.html).
...
Para obtener más información sobre este cambio, consulte [la documentación de Métricas calculadas](https://marketing.adobe.com/resources/help/es_ES/analytics/calcmetrics/m_metric_type_alloc.html).
...
La detección de anomalías y el análisis de contribución se han eliminado del conjunto de funciones de [!UICONTROL Reports &amp; Analytics] y ahora solo están disponibles a través de [Analysis Workspace](https://marketing.adobe.com/resources/help/es_ES/analytics/analysis-workspace/virtual-analyst.html).
...
Importante: Actualice la instalación del [Report Builder]( a la versión más reciente https://marketing.adobe.com/resources/help/es_ES/arb/t_install_arb.html). A partir del mes de abril de 2018, esta actualización será un requisito previo para poder llevar a cabo la migración de los ID de usuario de Analytics a Admin Console.

Para obtener información de migración, consulte [Migración de usuarios de Analytics en Admin Console](https://marketing.adobe.com/resources/help/es_ES/experience-cloud/admin-console/analytics-migration/)
...
Los usuarios de Analytics ya no tienen que vincular manualmente sus cuentas entre Experience Cloud y Analytics. Para solicitar el acceso a Analytics, los usuarios pueden ponerse en contacto con el [administrador de Admin Console](https://helpx.adobe.com/es/enterprise/help/aedash.html).
...
La versión 2.1.0 de [los componentes principales](https://helpx.adobe.com/experience-manager/core-components/user-guide.html) está ahora disponible e incluye [Image](https://helpx.adobe.com/experience-manager/core-components/using/image.html) mejora de componentes[un nuevo Teaser](https://helpx.adobe.com/experience-manager/core-components/using/teaser.html,) y varias correcciones de errores.
...
Consulte las próximas sesiones o vea las sesiones [anteriores aquí](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html).
...
Consulte las próximas sesiones o vea las sesiones [anteriores aquí](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html).
...
Encontrará más información [aquí](https://evolve.3sharecorp.com/).
...
 Busque las coincidencias de grupos de usuarios locales [aquí](https://www.meetup.com/pro/aem/). Si no encuentra un grupo local, pero tiene interés en poner uno en marcha, envíe un correo electrónico a [aemusers@adobe.com](mailto:aemusers@adobe.com).
