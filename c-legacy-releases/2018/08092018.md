...
* Se añadió un indicador de característica para controlar la sincronización de recursos entre Experience Cloud y Creative Cloud. (CORE-15938)
...
* Se ha corregido un problema que bloqueaba el uso compartido de carpetas del Marketing Cloud al Creative Cloud. (CORE-16677)
...
* Mayor seguridad para las cookies AMCV. La solución proporciona una configuración a los clientes para configurar la cookie AMCV como una cookie &quot;segura&quot;. (CORE-15532)
...
Correcciones y actualizaciones de iOS y Android.

| Función | Descripción |
|--- |--- |
| Versión 4.16.1 | <ul><li>Analytics: ahora se omiten las duraciones de acciones temporizadas no válidas.</li><li>Servicio de ID de visitante: se ha corregido un error que impedía que el MID se generara en una configuración de privacidad desconocida.</li><li>General: compatibilidad Añadida para la exclusión de Device Co-op.</li><li>General: se ha corregido un error que impedía que las direcciones URL de vínculos profundos con valores codificados se gestionaran correctamente.</li></ul> |
...
* Se ha corregido un problema con las leyendas de visualización de anillo. En algunos casos, las leyendas no mostraban ni mostraban las etiquetas equivocadas. (AN-164690; AN-164088; AN-164132)
* Se ha corregido un problema que se producía al guardar proyectos como PDF. Este problema provocaba que las visualizaciones se cortaran y que las leyendas no estuvieran visibles. (AN-164219; AN-161951)
* Se ha corregido un problema con la interfaz del Generador de alertas que hacía que, en algunos casos, la configuración de porcentaje se mostrara de formas inesperadas. (AN-163945)
* Se ha corregido un problema que hacía que, en ocasiones, el bloqueo de la selección en una visualización provocase un cambio en la granularidad o los datos seleccionados. (AN-164236; AN-162938)
* Se ha corregido un problema que impedía la descarga simultánea de datos de grupos de informes para varios grupos de informes. (AN-162551)
...
* Se ha actualizado OpenSSL a la versión 1.1.0h, que incluye varias correcciones de vulnerabilidad y nuevos Cifradores SSL.
* Se han actualizado varias de las bibliotecas de código abierto que utiliza el Data Workbench a las últimas versiones más estables. Son las siguientes:
   ...
   * zlib 1.2.11
   * pcre 8.42
* Registro de errores añadido cuando el recuento de filas del archivo de búsqueda supera las 357913908 filas admitidas.
...
* Precisión mejorada para el seguimiento de anuncios de vídeo: El seguimiento de anuncios ahora se produce a intervalos de un segundo.
* Se mejoró la administración del estado del reproductor y la recuperación de errores: Se añadió lógica adicional para mantener mejor los estados del reproductor y garantizar una medición precisa, incluida la identificación del estado &quot;cerrado&quot;.
* Se mejoró la validación de datos de entrada con un mejor registro de depuración.
* Optimizado para el final de la sesión, se ha añadido un nuevo evento &quot;final&quot; de Heartbeat.
...
Actualizado el 21 **de agosto de 2018** (se eliminó la actualización de JavaScript 2.10, que se produce en septiembre de 2018).
...
| **Métricas calculadas (localización)** | Se ha corregido un problema de localización que afectaba a algunas métricas calculadas generadas por el sistema. (AN-164738) |
...
El informe Actividad de la cuenta se reemplazará con la función Uso de llamadas al servidor en el lanzamiento de verano de Adobe Analytics. El Informe de Actividad de cuentas se eliminará de forma permanente el 9 de agosto de 2018. Para vista de datos de resumen sobre el tráfico de grupos de informes después del 9 de agosto de 2018, utilice la función Uso de llamadas del servidor.
...
Cloud Manager 2018.5.0 presenta nuevas funciones como Notificaciones de canalización de CD/CI e Implementaciones de producción programadas. También se han corregido errores.
...
Consulte [Acerca de esta versión.](https://marketing.adobe.com/resources/help/es_ES/s7/is_ir_api/is_api/r_about_this_release.html)

**Guía de referencia del visor**

Ya está disponible Viewers 5.10.1 para Dynamic Media on AEM y Dynamic Media Classic (Scene7).

Consulte las [Notas de la versión de Viewers (5.10.1).](https://marketing.adobe.com/resources/help/es_ES/s7/viewers_ref/c_rn_07_17_18.html)
...
Puede comprar entradas a petición para acceder sin límite a más de 90 sesiones. Vaya [aquí](https://immerse18.adobe-devs.adobeevents.com/register/) y utilice el código de descuento He7B52.
...
 Evolve18 es una conferencia basada en la comunidad y centrada en Adobe Experience Manager, Campaign y Analytics para desarrolladores, expertos en marketing y responsables de TI.  Vea cómo sus colegas en una variedad de industrias producen experiencias digitales extraordinarias. Conozca cómo funciona Adobe Experience Manager con Adobe Campaign y Adobe Analytics Cloud. Obtenga perspectivas sobre las mejores prácticas comerciales y técnicas.
...
 Find local user group meet-ups [here](https://www.meetup.com/pro/aem/). Si no encuentra un grupo local, pero tiene interés en poner uno en marcha, envíe un correo electrónico a [aemusers@adobe.com](mailto:aemusers@adobe.com).
...
* [Notas de la versión de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/whatsnew/)
