...
Nuevas funciones y correcciones en los servicios principales y en los servicios de Adobe Experience Cloud. Incluye [!UICONTROL Mobile] Services, Launch by Adobe, Dynamic Tag Management, la API del RGPD y el servicio Experience Cloud ID.
...
* Se ha implementado una capacidad back-end para controlar el uso compartido de activos entre Marketing Cloud y AEM, y Marketing Cloud y Creative Cloud. (CORE-14386)


* Se ha arreglado un problema que bloqueaba en algunos entornos el aprovisionamiento de nuevos inquilinos. (CORE-15509)


* Se ha corregido un problema que redireccionaba a los usuarios [!DNL  marketing.adobe.com] al acceder [!DNL  experiencecloud.adobe.com] a través de ellos [!DNL  http] en lugar de [!DNL  https] hacerlo (protegidos). (CORE-15587)
