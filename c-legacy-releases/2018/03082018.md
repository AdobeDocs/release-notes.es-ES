...
>[!NOTE]
>
>Para recibir notificaciones sobre las notas de la versión anteriores, suscríbase a [Adobe Priority Product Update](https://www.adobe.com/subscription/priority-product-update.html). La actualización de producto prioritaria se publica entre tres y cinco días laborables antes del lanzamiento. Vuelva a consultar las actualizaciones cuando se produzca el lanzamiento. La nueva información publicada tras el lanzamiento se marcará con la fecha de publicación.

## Actualizaciones de marca de Experience Cloud

Visite [aquí](https://marketing.adobe.com/resources/help/es_ES/mcloud/solutions-core-services.html) para obtener información sobre las últimas actualizaciones de marca para soluciones y servicios principales en Experience Cloud.
...
* Se ha corregido un error por el que el servicio Experience Cloud ID establecía, por equivocación, una cookie AMCV en los dominios sin el punto inicial cuando [!DNL  visitor.cookieDomain] tiene un punto inicial. Por ejemplo, establecería un [AMCV cookie](https://marketing.adobe.com/resources/help/es_ES/whitepapers/cookies/cookies_mc.html) en [!DNL  sampledomain.com] además de [!DNL  .sampledomain.com]. (CORE-10634)
...
<table id="table_6DB2F55C955943EB97DC25C96B6DF526"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> SDK [!UICONTROL Mobile] mejorados con API compatibles con el Reglamento General de Protección de Datos (RGPD) mediante </p> 
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Próximos cambios de soporte para Costo y presupuesto de canal de mercadotecnia </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> AEM Desktop App 1.8 se centra en obtener un mejor control del tamaño de la caché para el usuario, en la experiencia de inicio de sesión para SAML/SSO en Windows, en la compatibilidad con el proxy de red .pac en Mac y en problemas notificados por el cliente. </p> <p> 
     <ul id="ul_995B6859AF3844FDA6EE791104F1D164"> 
      ...
      <li id="li_C9E006C4EABC4EA7958755DA9A9C6616"> <a href="https://helpx.adobe.com/experience-manager/6-3/release-notes/desktop-app-release-notes.html" format="https" scope="external"> Notas de la versión </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
