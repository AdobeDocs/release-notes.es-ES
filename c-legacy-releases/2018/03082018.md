  ...
  <tr> 
   ...
   <td colname="col2"> <p>Un cambio en el mecanismo de búsqueda (de back-end) afectará a la creación de informes de diversas maneras. Tenga en cuenta que estos cambios entraron en vigor hacia <b>finales de febrero de 2018</b>: </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C"> Category reports for rollups and current data in <span class="uicontrol">Reports &amp; Analytics</span> are no longer provided. Sin embargo, la desaprobación de informes de categoría resumidos en la API de Servicios Web se ha pospuesto hasta la actualización de mantenimiento de abril </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En cuanto a las plantillas personalizadas que se han publicado recientemente: </p> 
    <ul id="ul_787F48253F454163B99F6DD50F199FE2"> 
     ...
     <li id="li_EEAA4D115CB74A57BABD524B2561E0CC">Aquellos usuarios que no son administradores pueden crear (guardar como) y editar plantillas de proyectos del espacio de trabajo, siempre y cuando hayan obtenido permiso para <span class="uicontrol">Crear/presentar proyectos en Analysis Workspace</span>. ( 
      <span class="ignoretag"> 
       <span class="uicontrol"> Administración</span> &gt; <span class="uicontrol">Administración de usuarios</span> &gt; <span class="uicontrol">Grupos</span> &gt; <span class="uicontrol">Editar acceso a todos los informes</span> &gt; <span class="uicontrol">Personalizar herramientas de Analytics</span> &gt; <span class="uicontrol">Crear/presentar proyectos en Analysis Workspace </span> 
      </span>). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      ...
      <li id="li_BDCE922D714C4341AEC388AA948AAF49">Fixed an issue that caused the CSV separator setting specified in Components &amp;gt; Report Settings to not be reflected in <span class="uicontrol"> Analysis Workspace</span>. (AN-155596) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_F15E1A5F9EBB4A1AA5A7233D94051187"> <b><span class="uicontrol"> Informes y análisis</span></b>: se ha arreglado un problema por el que los informes de Target no registraban correctamente los totales trimestrales. (AN-153933) </li> 
