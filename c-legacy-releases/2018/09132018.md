...
Ahora puede cambiar la combinación de colores utilizada en Workspace seleccionando una paleta de colores diferente o especificando su propia paleta. Esta función afecta a muchos elementos del Workspace, incluidas la mayoría de visualizaciones. Esto **no afecta** al cambio de resumen, al formato condicional en tablas improvisadas ni a la visualización de mapa.
...
* Deje de admitir XDomainRequest. (AN-165733)
