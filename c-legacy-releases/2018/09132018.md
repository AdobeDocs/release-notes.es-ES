...
Nuevas funciones y correcciones en [!DNL Adobe Experience Cloud] la interfaz, incluidos [!UICONTROL Recursos], [!UICONTROL Fuente], [!UICONTROL Notificaciones]y el servicio principal [!UICONTROL Personas] .
...
* Se han actualizado las URL de [!UICONTROL Mobile] Services relacionadas [!DNL *.marketing.adobe.com][!DNL *.experiencecloud.adobe.com]con.
...
* Se ha quitado el permiso _[!UICONTROL Crear/Organizar proyectos en Analysis Workspace]_, que impedía a algunos usuarios crear un nuevo proyecto de Workspace (por ejemplo, ver el botón azul Crear) u organizar los componentes de los proyectos.
...
* [Notas de la versión de AEM ](04122018.md#section_8CD42C5750254AA88D6ACA7DBFA0D9A1)
...
Para configurar las integraciones de oAuth, el servicio de puerta de enlace de Adobe I/O está disponible en [https://legacy-oauth.cloud.adobe.io](https://legacy-oauth.cloud.adobe.io/).
