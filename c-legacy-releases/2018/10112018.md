...
Consulte [Actualización del servidor FTP de Adobe](https://marketing.adobe.com/resources/help/es_ES/whitepapers/ftp/ftp_upgrade.html).
...
Fecha de incorporación: 9 de agosto de 2018
...
Consulte la [documentación de métricas calculadas](https://marketing.adobe.com/resources/help/es_ES/analytics/calcmetrics/m_metric_type_alloc.html) para obtener más información sobre este cambio.
...
La detección de anomalías y el análisis de contribución se han eliminado del conjunto de funciones [!UICONTROL Reports &amp; Analytics] y ahora solo están disponibles a través de[Analysis Workspace](https://marketing.adobe.com/resources/help/es_ES/analytics/analysis-workspace/virtual-analyst.html).
...
Consulte [Migración de usuarios de Analytics a la Admin Console](https://marketing.adobe.com/resources/help/es_ES/experience-cloud/admin-console/analytics-migration/) para obtener información de migración.
...
[Obtenga más información sobre la migración del ID de usuario de Analytics](https://marketing.adobe.com/resources/help/es_ES/experience-cloud/admin-console/analytics-migration/).
...
Esta opción también está disponible en el grupo de prueba [de segmentos API](https://bank.demdex.com/portal/swagger/index.html#/Segment_Test_Group_API/get_segment_test_groups_), a través del parámetro de consulta groupStatus.
...
* **Cloud Manager 2018.7.0**
   ...
   Esta versión de Cloud Manager ofrece mejoras esenciales en el escalado automático, el análisis de calidad del código, la vista detallada de los entornos y las pruebas de rendimiento. [Notas de la versión ](https://helpx.adobe.com/es/experience-manager/cloud-manager/using/release-notes-2018-7-0.html).
...
Consulte el [Vídeo de funciones](https://helpx.adobe.com/es/experience-manager/kt/sites/using/spa-editor-framework-feature-video-use.html) y el [Vídeo técnico](https://helpx.adobe.com/es/experience-manager/kt/sites/using/spa-editor-components-technical-video-understand.html).
...
* **AEM 6.3 Service Pack 3**
   ...
   * [Lanzamiento de AEM Forms CFP](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html)
...
* **AEM Screens**
   ...
   [Utilizar Secuencia integrada dinámica](https://helpx.adobe.com/es/experience-manager/6-4/sites/authoring/using/dynamic-embedded-sequences.html) permite al usuario seguir una jerarquía donde los cambios y actualizaciones realizados en un canal se propagan a otro en relación. Sigue una jerarquía principal-secundario y también incluye elementos como imágenes y vídeos.

* **AEM Cloud Manager**

   El escalado automático se habilita mediante el escalado horizontal de segmentos Dispatcher/Publish en el entorno de producción para que sea posible incrementar de forma repentina la carga, el volumen, el acceso y otras métricas supervisadas definidas. Siga las  [Notas de la versión de 2018.7.0](https://helpx.adobe.com/es/experience-manager/cloud-manager/using/release-notes-2018-7-0.html) para obtener más información.
...
[Inicio de Ayuda de Primetime](http://help.adobe.com/es_ES/primetime/)
