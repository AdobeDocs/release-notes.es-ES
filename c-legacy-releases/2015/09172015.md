...
Administradores de soluciones, consulte [Usuarios y grupos ](https://marketing.adobe.com/resources/help/es_ES/mcloud/?f=user_mgmt_admin) para obtener información importante sobre cómo asignar grupos de soluciones a grupos de Adobe más amplios y agregar usuarios de forma masiva en [Enterprise Dashboard](http://adminconsole.adobe.html/#).
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>El SDK 4.x de plataforma universal de Windows (UWP) para Soluciones de Experience Cloud ya está disponible. </p> <p>Este nuevo SDK permite medir aplicaciones nativas de Windows 10, entregar contenido con objetivo en la aplicación y aprovechar y recopilar datos de audiencias mediante la gestión de público. </p> <p>Consulte el <a href="https://marketing.adobe.com/resources/help/en_US/mobile/uwp/" format="https" scope="external">SDK 4.x de plataforma universal de Windows para Soluciones de Experience Cloud</a> </p> </td> 
  </tr> 
  <tr> 
...
Administradores de Analytics: Si es administrador de Experience Cloud, consulte [Usuarios y Grupos ](https://marketing.adobe.com/resources/help/es_ES/mcloud/?f=user_mgmt_admin) para obtener información actualizada sobre cómo asignar grupos de Analytics a grupos de Adobe más amplios y agregar usuarios de forma masiva en [Enterprise Dashboard ](http://adminconsole.adobe.html/#).
...
Consulte [el historial de la versión de AppMeasurement en ](https://marketing.adobe.com/resources/help/es_ES/sc/appmeasurement/release/index.html) lo siguiente para ver un historial de versiones [!DNL  AppMeasurement] en las plataformas siguientes:
...
* Se ha incluido nueva documentación que explica cómo usar archivos de metadatos para sustituir ID numéricos por texto legible en los informes de [!UICONTROL Advertising Analytics]. Consulte [Archivos de metadatos y datos para Advertising Analytics Reports ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=metadata-files-intro.html).
* Se ha revisado [Capturing Campaign Data impresión de datos a través de Píxel Calls](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_capturing_camp_data.html) para incluir nuevos pares clave-valor requeridos por los informes de [!UICONTROL  Advertising Analytics].
* Se ha revisado [Capturing Campaign Click Data a través de Píxel Calls ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_capturing_camp_click_data.html) para incluir nuevos pares clave-valor requeridos por los informes de Advertising Analytics.
...
* Página inicio de ayuda: [Ayuda de Adobe Experience Manager ](https://docs.adobe.com)
...
* AEM Assets on Demand: [Notas de la versión ](https://helpx.adobe.com/es/support/experience-manager/6-3.html)
