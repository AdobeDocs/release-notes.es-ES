...
Durante noviembre y diciembre, Adobe prevé que recibirá un gran volumen de cargas de clasificación en toda la base de clientes. Procesaremos las cargas lo más rápido posible, pero puede que el procesamiento tarde algo más de lo habitual. Para obtener sugerencias sobre cómo minimizar el tiempo de procesamiento, consulte [Classification Processing Time ](https://helpx.adobe.com/analytics/kb/saint-processing-time.html).
