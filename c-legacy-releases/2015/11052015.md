...
La versión 4.8.0 de los SDK para iOS y Android (2 de noviembre de 2015) incluye los siguientes cambios:
...
Durante noviembre y diciembre, Adobe prevé un gran volumen de cargas de clasificaciones en nuestra base de clientes. Procesaremos las cargas lo más rápido posible, pero puede que el procesamiento tarde algo más de lo habitual. For tips on minimizing processing time, see [Classification Processing Time](https://helpx.adobe.com/analytics/kb/saint-processing-time.html).
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Se ha agregado un cuadro de búsqueda a los selectores de desglose y métrica. Ahora es más fácil encontrar una variable o segmento específico, ya que ya no necesita desplazarse por toda la lista. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">Se ha resuelto un problema por el que la característica de gráfico derecho o izquierdo aparecía en el informe Métrica clave, aunque dicha característica no sea compatible con los informes de tendencias. Los iconos de gráficos ahora se han eliminado de los informes de tendencias. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>JavaScript 1.5.2: </p> 
    <ul id="ul_B5B69A24247F452E9C9D0452B707F07D"> 
     ...
     <li id="li_C7836A3010C8480B9F89A054CC14F162"> Se corrigió la detección de Internet Explorer 11 para el truncamiento de URL a 2047. (AN-114914) </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_193CB58F22D14FE4AB4759418A00848B"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Eventos cuartil </p> </td> 
   <td colname="col2"> Se han añadido los siguientes parámetros y eventos nuevos de Video Core: 
...
<!-- 
 <draft-comment> 
  ...
  <tr> 
   <td colname="col1"> <p>Evento de Audiencia promedio por minuto </p> </td> 
   <td colname="col2"> Se ha añadido el siguiente nuevo evento de Video Core: 
...
>[!NOTE]
>
>Desde el 1 de octubre, todos los nuevos vínculos acortados con t.co de Twitter emplearán el esquema de URL “https”. Este cambio programado aumenta la longitud de las direcciones URL ajustadas en un solo carácter.
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> Herramientas de edición de fotos de Publish Anywhere </td> 
...
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   <td colname="col1"> Ocultar comentarios de anuncios de Facebook en Moderación </td> 
   <td colname="col2"> <p>Oculte o muestre un comentario en una publicación en Facebook. Es útil para ocultar comentarios sin llegar a eliminarlos de la página. Cuando los clientes problemáticos regresan a la página, siguen viendo sus comentarios, pero estos se ocultan a todos los demás. </p> 
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Ahora puede enviar mensajes directos que contengan hasta 10.000 caracteres en lugar del límite anterior de 140 caracteres. </p> 
<!-- <draft-comment> 
  ...
  <tr valign="top"> 
   <td colname="col1"> Actualización de la API de LinkedIn </td> 
...
Esta versión de Social se centra en agilizar la creación, distribución y flujos de trabajo de participación de contenido social para que pueda crear y ofrecer contenido social visual de alta calidad más rápido y garantizar que las interacciones en torno a dicho contenido sean productivas y adecuadas para la marca.
