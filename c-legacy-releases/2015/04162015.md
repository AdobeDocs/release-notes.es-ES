...
<table id="table_04854D12F4C241AE86F24C12C4F0FA28"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La funcionalidad de administración de usuarios y grupos se ha trasladado a Enterprise Panel. La nueva ruta de navegación es: </p> <p> <span class="uicontrol"> Experience Cloud</span> &gt; <span class="uicontrol">Herramientas</span> &gt; <span class="uicontrol">Iniciar Enterprise Dashboard </span></p> <p> Además, se ofrece compatibilidad con Enterprise ID y Federated ID. Puede utilizar Enterprise ID, Federated ID y Adobes en la misma implementación empresarial. Por ejemplo, utilice un Adobe ID para los usuarios que puedan utilizar otros productos y servicios de Adobe. Utilice Enterprise ID o Federated ID para los usuarios en los que desee administrar estrictamente sus cuentas. </p> <p>Consulte <a href="https://docs.adobe.com/content/help/es-ES/core-services/interface/manage-users-and-products/admin-getting-started.html" format="https" scope="external"> Usuarios y grupos - Administración de identidad </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se ha corregido un problema que impedía el inicio de sesión único entre [!DNL  Marketing Cloud] y [!DNL  Advertising Cloud].
...
* Cuando cree un mensaje en la aplicación, ahora puede dirigir el mensaje mediante  *`Lifetime Value`* O bien *`Locale`*.
...
<table id="table_E8F149CB37804A42878657728501997B"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Etiquetas Social </p> </td> 
...
* La función Social Applications se ha desaprobado oficialmente en la versión de Adobe Social 15.4.1.0 (abril de 2015). Esto incluye la eliminación de todas las métricas, los datos y los métodos de API relacionados con la aplicación. Si tiene alguna pregunta, póngase en contacto con el administrador de su cuenta de Social. Para obtener más información, consulte la hoja informativa Aplicaciones de [Adobe Social - Desuso](https://helpx.adobe.com/social/kb/social-applications---deprecation-fact.html).
...
* Se ha corregido un problema que provocaba discrepancias de hora posterior entre anuncios secundarios y maestros al duplicar anuncios.
...
* Se ha corregido un problema que provocaba un mal funcionamiento de las direcciones URL abreviadas publicadas en páginas de LinkedIn.
