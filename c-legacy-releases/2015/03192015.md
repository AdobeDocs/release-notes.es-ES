...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> La gestión de la adquisición </span> y <span class="term"> los mensajes </span> en la aplicación ahora solo son accesibles para los usuarios del grupo Administración <span class="wintitle"></span> de aplicaciones móviles administradas mediante Herramientas de administración en <span class="wintitle"> Analytics </span>. Esto permite que las empresas gestionen quién tiene acceso a estos recursos. <a href="https://marketing.adobe.com/resources/help/en_US/mobile/index.html?f=t_admin_group" format="https" scope="external"> Más... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Cuando inicie sesión en Mobile Services con Adobe ID, si dispone de varias empresas de <span class="wintitle">Analytics</span>, puede alternar entre ellas en Mobile Services. </p> <p>Para cambiar de empresa, haga clic en su icono de usuario en la parte superior derecha del encabezado. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Los datos se marcan con la hora si los datos sin conexión están habilitados en el SDK móvil (configuración predeterminada) o en cualquier momento en el que un grupo de informes se <a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/timestamp.html" format="https" scope="external"> configure para aceptar datos con marca de hora </a>. Puede que los datos recogidos sin conexión en dispositivos móviles se envíen horas o semanas después de la fecha en la que se produjeron. Estas visitas se pueden poner en cola dentro de la plataforma <span class="wintitle"> Analytics </span> durante más minutos u horas que las visitas sin marca de hora: 
  ...
  <tr> 
   ...
   <td colname="col2"> Ahora dispone de acceso a eVars y eventos adicionales. El número exacto depende del producto de Adobe <span class="wintitle"> Analytics </span> que haya contratado. <a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/evars_events.html" format="https" scope="external"> Más… </a> </td> 
  </tr> 
  <tr> 
