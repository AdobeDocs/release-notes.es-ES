...
<table id="table_371D2B21B8EF411FA2DD33DD585F1F8F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La página de <a href="https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/organizations.html" format="https" scope="external"> Administración de grupos </a> se ha rediseñado como interfaz administrativa que permite crear grupos, agregar usuarios a grupos y aplicar permisos en las soluciones de Experience Cloud. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Asignación de uno a muchos </p> </td> 
   <td colname="col2"> <p>Al vincular cuentas de soluciones en Experience Cloud, si cuenta con varias soluciones y organizaciones, ahora puede asignar varios productos y servicios a una única organización. </p> <p>Consulte <a href="https://docs.adobe.com/content/help/en/core-services/interface/manage-users-and-products/organizations.html" format="https" scope="external"> Cuentas y organizaciones </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se ha agregado el tema de <a href="https://docs.adobe.com/content/help/en/core-services/interface/experience-cloud.html" format="https" scope="external">Habilitación de soluciones para servicios principales</a> para ayudarle a implementar servicios principales. </p> </td> 
  </tr> 
 </tbody> 
</table>
