...
* Seguimiento de Campaña de adquisición
...
* La expiración para el seguimiento de las campañas de adquisición ha cambiado de visita a visitante para todos los clientes. Este cambio facilita la atribución de campaña para publicar la actividad de descarga en el visitante para todas las visitas en lugar de solo la primera visita.
* Se han reorganizado y mejorado las guías siguientes:

   * [Guía de usuarios de Adobe Mobile Services](https://docs.adobe.com/content/help/es-ES/mobile-services/using/home.html)
   * [Guía de administración del SDK 4.x de iOS para Soluciones de Marketing Cloud](https://docs.adobe.com/content/help/es-ES/mobile-services/ios/overview.html)
...
La versión del 18 de junio de 2015 de Video Stream Analytics (Heartbeat) incluye los siguientes cambios:
     ...
     <ul id="ul_F49FF181E93744F8BAD180B994073F20"> 
      ...
      <li id="li_8913320B99114DE881B5F4E8B3BD0D84"> <p> <b>Ruta de vídeo</b> </p> 
       <ul id="ul_CCC6EA9299644D48935146DDD988DE36"> 
        <li id="li_70DBC48AD34A4893B7FB2C92DA0F2E72"> <p>Ésta es una variable de solución. </p> </li> 
        <li id="li_5146C2C8E86F4DACB07A99E7939B360F"> <p>La profundidad máxima de la ruta es de tres. </p> </li> 
       </ul> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Calidad de vídeo </p> </td> 
...
* Se han cambiado nombres de variables y eventos para que reflejen mejor la finalidad de los componentes (vídeo, contenido, anuncios). Ahora, el vídeo incluye tanto el contenido principal como los anuncios.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Las métricas calculadas ahora permiten métricas segmentadas, matemáticas más avanzadas y la capacidad de organizar y compartir métricas. </p> <p>Puede crear métricas nuevas que se apliquen históricamente sin actualizar la implementación, compartir y conservar métricas para eliminar el desorden y realizar análisis estadísticos básicos. Puede comparar segmentos con mucha más facilidad. </p> <p>Puede aplicar estas métricas nuevas en cualquier lugar de Reports &amp; Analytics, Analysis Workspace, Report Builder y Ad Hoc Analysis. </p> <p> <a href="https://marketing.adobe.com/resources/help/es_ES/analytics/calcmetrics/" format="https" scope="external"> Más... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Analysis Workspace: análisis de forma libre </td> 
   <td colname="col2"> <p>El análisis de forma libre le permite arrastrar y soltar dimensiones, métricas y segmentos para crear el informe que quiera. Puede desglosar los datos según sus necesidades específicas, proporcionando un lienzo para generar consultas usando métricas, dimensiones, segmentos, líneas de tiempo y otros valores de desglose de análisis relevantes. </p> <p>Las últimas funciones incluyen: </p> <p> 
     ...
     </ul> </p> <p> <a href="https://docs.adobe.com/content/help/es-ES/analytics/analyze/analysis-workspace/home.html" format="https" scope="external"> Actualmente, análisis de forma libre</a> es una función beta abierta que admite, principalmente, el equipo de la comunidad de Analytics. Si desea información actualizada o tiene alguna duda sobre el análisis de forma libre, visite el <a href="https://help-forums.adobe.com/content/adobeforums/en/analytics-forum/freeform-analysis.html" format="http" scope="external">foro de análisis de forma libre (beta)</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Sobrescritura SFTP en Data Warehouse </td> 
   <td colname="col2"> Ahora, SFTP permite la sobrescritura durante las transmisiones. Le recomendamos que actualice el servidor SFTP a una versión compatible con el cambio de nombre. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Aumento del límite de reglas de procesamiento </td> 
   <td colname="col2"> <p>El número permitido de reglas de procesamiento ha aumentado de 100 a 150. Además, el tamaño permitido del XML de reglas de procesamiento también ha aumentado a 4 MB (antes era de 65 KB). Este cambio de tamaño evita un error que se producía cuando se superaba la limitación de XML. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p>Compatibilidad con nuevas métricas calculadas. </p> <p> <a href="https://marketing.adobe.com/resources/help/arb/calculated_metrics.html" format="html" scope="external"> Más... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Ad Hoc Analysis </td> 
   <td colname="col2"> <p>Compatibilidad con nuevas métricas calculadas. La interfaz de usuario del creador de métricas calculadas en Ad Hoc Analysis ahora se parece a la de Reports &amp; Analytics. </p> </td> 
  </tr> 
  <tr> 
...
Analytics Premium ofrece las siguientes funciones nuevas en la versión [Data Workbench 6.4](https://docs.adobe.com/content/help/es-ES/data-workbench/using/release-notes/release-notes.html):
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> Configure Data Workbench (cliente) siguiendo un asistente de instalación paso a paso. Descargue, defina las opciones, instale el área de trabajo y sincronice con los servidores. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Experiencia de configuración de estación de trabajo mejorada </td> 
   <td colname="col2"> Tras la instalación de la estación de trabajo, se abrirá el espacio de trabajo <b>Configurar conexiones al servidor</b> con información adicional sobre la instalación de un certificado y la introducción de información de conexión al servidor en el archivo Insight.cfg. También puede vista el estado de la conexión a los servidores y seleccionar perfiles. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Capa de presentación </td> 
   <td colname="col2"> Comente y aclare visualizaciones usando una superposición de presentación. Añada llamadas de texto, flechas, imágenes y codificación de color para resaltar y aclarar los datos y, a continuación, compartirlos con otros usuarios. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Asistente para nuevo Dimension de métricas </td> 
   <td colname="col2"> Utilice un asistente paso a paso para facilitar la creación de dimensiones de métricas. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Administración de usuarios del acceso de miembros del grupo </td> 
   <td colname="col2"> Los administradores pueden dar a los usuarios de las estaciones de trabajo la capacidad parcial de administrar controles de acceso para grupos personalizados. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Impedir cambios en perfiles </td> 
   <td colname="col2"> Impedir que los usuarios que trabajen en los administradores de Perfiles, Dimension, informes, espacios de trabajo, métricas o Filtros sobrescriban los perfiles. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Nuevas actualizaciones de la interfaz de usuario de Workstation </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> Ahora, Data Workbench usa un marco de registro ampliado conocido como "L4" que ofrece la capacidad de configurar el registro según las necesidades. La implementación predeterminada que viene con el paquete 6.4 proporciona información fundamental sobre el procesamiento de software. El registro se puede ampliar con información adicional para solucionar problemas de eventos del servidor y ayudar a analizar los problemas subyacentes, incluida información adicional para servidores, clientes y servidores de informes asociados. <p>Para obtener asistencia adicional en la implementación de registro L4 adicional, póngase en contacto con el administrador de cuentas. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Nuevo archivo cfg para las opciones de registro de ExportIntegration.exe </td> 
   <td colname="col2"> <p>El nuevo archivo de configuración httpLoggingEI.cfg (ubicado en <span class="filepath">server\Admin\Export\httpLoggingEI.cfg</span>) le permite detener el registro de información en el archivo HTTP.log durante las exportaciones Exportar integración. (Las exportaciones de CRS, TNT y MMP ya capturan el registro detallado en archivos de registro de exportación individuales). </p> <p>La configuración "true" inicia el registro de información (con fines de pruebas y creación de informes detallados) en el archivo HTTP.log, mientras que la configuración "false" detiene el registro detallado. Para una configuración falsa, solo se enviarán mensajes de nivel ADVERTENCIA/ERROR al archivo HTTP.log. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Función de zoom para visualizaciones de gráficos </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> Estos ejecutables ahora se firman digitalmente para garantizar que las descargas de software no se hayan alterado ni dañado. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Opciones de formato de fecha </td> 
   <td colname="col2"> Puede cambiar el formato de fecha según la configuración regional en el archivo <i>Dimension de hora estándar.cfg</i> . Cambie el formato predeterminado <i>MM/DD/AAAA</i> al formato <i>DD/MM/AAAA</i> o elija otras opciones. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Visualización de archivos interrumpida </td> 
   <td colname="col2"> La visualización de archivos (<span class="uicontrol">Administración</span> &gt; <span class="uicontrol">Archivos</span>) de los perfiles base no incluirá los directorios de mayor tamaño al crear informes (se han eliminado Registros, Exportaciones y búsquedas). Esto aumentará la velocidad al mostrar el informe. Los directorios más grandes ahora tienen sus propios informes individuales (Administración / Exportar archivos, Archivos de búsqueda y Archivos de registro). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Transformaciones de DeviceAtlas mejoradas </td> 
   <td colname="col2"> El archivo DeviceAtlas.bundle ahora utiliza la caché en memoria para mejorar considerablemente el rendimiento de las búsquedas. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Visualización de acordes actualizada </td> 
   <td colname="col2"> Se ha mejorado la visibilidad al pasar el ratón sobre una sección al ver la visualización de <b>acordes</b> . </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Arrastrar dimensiones desde Finder a una tabla de detalles </td> 
...
* Se ha corregido un problema que hacía que no hubiera dimensiones contables disponibles al abrir la matriz de correlación por primera vez.
* La exportación de los segmentos de Target provocaba error porque faltaba el campo  *`mboxPC`*. Esto se ha solucionado.
* La solicitud de ID tiene el formato correcto. Si se usa  *`mbox3rdpartyId`* en lugar de los PCID predeterminados, [!UICONTROL Adobe Target] rechazaba las solicitudes generadas a través de la integración de Target y Data Workbench (usando [!DNL  ExportIntegration.exe]). Esta solicitud de ID se ha formateado correctamente y el rendimiento se ha realizado correctamente.
* Se corrigió una fuga de memoria del servidor de informes al exportar a Excel.
...
* Se han realizado cambios en la lógica comercial Tiempo de visita/Tiempo del sitio:

   * Use *`visit_start_time_gmt`* as the starting time of a visit. Ahora, las visitas que empezaron antes del intervalo de fechas de creación de informes no se ven afectadas negativamente.
...
* Estamos mejorando la documentación de la API con Swagger. See the [Audience Manager API Docs](https://bank.demdex.com/portal/swagger/index.html) section for new and revised methods.
...
* Se ha corregido un problema que impedía que los códigos de seguimiento se anexaran a las publicaciones de álbumes de Facebook.
* Se ha corregido un problema que, en ocasiones, provocaba errores en las publicaciones debido a errores de tiempo de espera.
* Se ha corregido un problema que impedía que los usuarios asignados de flujo de trabajo de moderación se mostraran en los navegadores Internet Explorer 11.
* Se ha corregido un problema que impedía a los usuarios crear reglas de escucha para WordPress que contuvieran un operador O.

See [Release Notes for Adobe Social](https://docs.adobe.com/content/help/es-ES/social/using/home.html) for more information.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En <span class="uicontrol"> Herramientas de administración </span> &gt; <span class="uicontrol"> Generador de reglas de clasificación </span> &gt; <span class="term"> &lt;nombre del conjunto de reglas&gt; </span>, dos nuevas opciones le permiten seleccionar un modo de sobrescritura: </p> 
    <ul id="ul_14E61CC9E94B431090539CB47A9B83D6"> 
     ...
     <li id="li_0E82075DFBF04D1D8D686A5B95FCFB3E"> <b>Las reglas sobrescriben solo los valores no configurados:</b> rellenar solo las celdas en blanco (no configuradas). Las clasificaciones existentes no cambiarán. </li> 
