...
* Las siguientes guías se han reorganizado y mejorado:
   ...
   * [Guía de usuarios de Adobe Mobile Services](https://marketing.adobe.com/resources/help/es_ES/mobile/)
   * [iOS SDK 4.x para la guía de administración de Soluciones de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mobile/ios/)

Para acceder a la documentación del producto, consulte [Adobe Mobile Services ](https://marketing.adobe.com/resources/help/es_ES/mobile/). Para ver las notas de versiones anteriores, amplíe *Notas de la versión anterior* en el panel izquierdo.
...
Para ver las notas de la versión actuales y acumulativas, la ayuda y las actualizaciones de documentación, consulte [Novedades en la Dynamic Tag Management ](https://marketing.adobe.com/resources/help/es_ES/dtm/whatsnew.html).
...
Analytics Premium proporciona estas nuevas funciones adicionales en la [versión Data Workbench 6.4](https://marketing.adobe.com/resources/help/es_ES/insight/whatsnew/):
...
>[!NOTE]
>
>Se ha eliminado el acceso al Data Warehouse desde la versión 14.[Más información en](https://marketing.adobe.com/resources/help/es_ES/reference/?f=whatsnew_segments)
...
Consulte [el historial de la versión de AppMeasurement en](https://marketing.adobe.com/resources/help/es_ES/sc/appmeasurement/release/index.html)[!DNL  AppMeasurement] en las plataformas siguientes:
...
* Estamos mejorando la documentación de la API con Swagger. Consulte la[ sección API Docs de Audience Manager](https://bank.demdex.com/portal/swagger/index.html) para conocer los métodos nuevos y revisados.
* Se ha añadido nueva documentación sobre [Experience Cloud Visitor ID ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_visitor_id_versions.html). En ocasiones, se necesita un ID de visitante al crear o editar un origen de datos.
...
Para más información, consulte [las Notas de la versión de Adobe Social](https://marketing.adobe.com/resources/help/es_ES/social/c_rel_notes.html).
