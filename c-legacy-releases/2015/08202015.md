...
* Se ha corregido un problema que impedía que el [!UICONTROL servicio de identificación del visitante] estableciera correctamente una cookie de dominio superior de varias partes. Por ejemplo, si tiene un dominio como ` my_company.co.uk`, en determinadas circunstancias, el [!UICONTROL servicio de identificación del visitante] establecería una cookie solo en ` co.uk`. (AN-104683)
   ...
   * Se ha habilitado un [periodo de gracia ](https://marketing.adobe.com/resources/help/es_ES/mcvid/?f=mcvid_grace_period.html)* o * utilizan cookies de origen y los usuarios bloquean cookies de terceros.
...
Consulte [el historial de versiones de AppMeasurement](https://marketing.adobe.com/resources/help/es_ES/sc/appmeasurement/release/index.html) lo siguiente para ver un historial de versiones [!DNL  AppMeasurement] en las plataformas siguientes:
...
* La nueva documentación describe cómo importar los datos de un administrador de Google Doubleclick Campaign Manager (DCM) a [!DNL  Audience Manager]. Consulte [Importación de archivos de DCM en Audience Manager ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=t_dcmlogs.html).
* La nueva documentación describe cómo usar las [!UICONTROL herramientas de administración en masa]. Para más información, consulte [herramientas Bulk Management ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_bulk.html).
* Para actualizar la variable de datos de contexto, se ha revisado el [perfil de integración de marketing principal](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_mmp.html). La variable debería terminar con un guion bajo. Anteriormente, terminaba con un punto.

**Problemas conocidos**

Los clientes de [!DNL  Analytics] necesitan establecer un código de integración al utilizar el [perfil de integración de marketing pincipal](https://marketing.adobe.com/resources/help/es_ES/aam/?f=c_mmp.html) y al pasar los ID declarados al [!DNL  Audience Manager] con el [servicio de ID de visitante](https://marketing.adobe.com/resources/help/es_ES/mcvid/?f=mcvid_service.html). Para más información, consulte [Habilitación para fusionar perfiles de clientes](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_profile_merge_enablement.html).
...
<table id="table_3C13024F4D754E2C98D7B8434A3497EF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mobile/" format="html" scope="external"> Dispositivo móvil </a> </p> </td> 
