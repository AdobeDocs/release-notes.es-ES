---
description: Requisito de contraseña actual para editar usuarios en Analytics User Management; Generador de reglas de clasificación de Analytics actualizado, nuevas características de Socia y correcciones generales en las soluciones de Adobe Marketing Cloud.
keywords: notas de la versión
seo-description: Requisito de contraseña actual para editar usuarios en Analytics User Management; Generador de reglas de clasificación de Analytics actualizado, nuevas características de Socia y correcciones generales en las soluciones de Adobe Marketing Cloud.
...
* Se corrigió un problema con el archivo Tableau en el que la extensión [!DNL  .csv] de archivo no se agregó cuando *` .csv`* formaba parte del nombre del archivo. (AN-106466)
