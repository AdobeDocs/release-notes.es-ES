...
Para obtener ayuda sobre el producto, consulte[ la documentación de productos de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcloud/).
...
* Se han migrado métodos de la API de Fuentes de datos a Swagger. Para métodos, sintaxis y muestras de código, consulte[ Audience Manager API Docs ](https://bank.demdex.com/portal/swagger/index.html).
...
* Se mejoraron las etiquetas en la ventana de información básica de un destino. La etiqueta cambió de [!UICONTROL Restricciones de ] a Etiquetas de exportación de datos de [!UICONTROL ] (AAM-19824).
