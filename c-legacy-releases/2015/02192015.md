...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La página de <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/groups.html" format="https" scope="external"> Administración de grupos </a> se ha rediseñado como interfaz administrativa que le permite crear grupos, agregar usuarios a grupos y aplicar permisos en las soluciones de Experience Cloud. </p> </td> 
  </tr> 
  <tr> 
...
Consulte [la documentación de Experience Cloud y Core Services](https://marketing.adobe.com/resources/help/es_ES/mcloud/) para obtener más información.
...
>[!NOTE]
>
>En esta versión ya no se permitirá acceder al Data Warehouse desde la Versión 14.[Más información](https://marketing.adobe.com/resources/help/es_ES/reference/?f=whatsnew_segments)
...
Consulte [Configuración de fuentes de datos](https://marketing.adobe.com/resources/help/es_ES/sc/clickstream/datafeeds_configure.html) para obtener más información.
...
Consulte las [notas de la versión de Adobe Target](https://marketing.adobe.com/resources/help/es_ES/target/rn/) para obtener la información más reciente sobre fechas y versiones.
