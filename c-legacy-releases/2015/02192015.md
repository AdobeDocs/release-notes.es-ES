...
* Instancia entre actualizaciones para segmentos secuenciales. Inicialmente, esta función permitía combinar un evento en un segmento secuencial, como el final de una visita y configurar la hora durante o después según la lógica de estos puntos de comprobación del evento. Ahora, una nueva función de restricción de contenedor le permite especificar un límite y un recuento, así como identificar el contenedor en la creación de un segmento, permitiéndole generar segmentos secuenciales más complejos y centrados.
* Dimensión entre actualizaciones para segmentos secuenciales. Al igual que la lógica Instancia entre que identifica coincidencias entre contenedores, la dimensión entre ahora incluye una función de restricción de dimensión que proporciona lógica basada en valores de dimensión, determinando coincidencias basadas en valores específicos (filas de tabla) para rastrear si una dimensión seleccionada está configurada (o no) y luego le permite proporcionar lógica de segmento basada en estos valores de dimensión.
