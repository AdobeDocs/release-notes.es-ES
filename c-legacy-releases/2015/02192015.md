...
### Interfaz de Marketing Cloud 15.3.1 {#section_57CB69C044DD47BDBC1A1BEC38957551}
...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La página de <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/groups.html" format="https" scope="external">Administración de grupos</a> se ha rediseñado como interfaz administrativa que le permite crear grupos, agregar usuarios a grupos y aplicar permisos en las soluciones de Marketing Cloud. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Asignación de uno a muchos </p> </td> 
   <td colname="col2"> <p>Al vincular cuentas de soluciones en Marketing Cloud, si cuenta con varias soluciones y organizaciones, ahora puede asignar varios productos y servicios a una única organización. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/organizations.html" format="https" scope="external">Cuentas y organizaciones </a>. </p> </td> 
  </tr> 
  <tr> 
...
### Interfaz de Marketing Cloud 15.2.1 {#marketing_cloud_interface}

Nuevas funciones y correcciones en la interfaz de colaboración y uso compartido de [!DNL  Adobe Marketing Cloud].

* Se ha corregido un problema de carpeta de recursos que impedía que [!DNL  Marketing Cloud][!DNL  Adobe Campaign] se mostraran jerarquías de carpeta idénticas.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Novedades en la navegación de Informes y [!DNL Analytics] </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nota:  </p> <p>1. La polaridad de métrica le permite indicar si Adobe [!DNL Analytics] debe considerar el aumento de un evento personalizado determinado (métrica) como positivo o negativo. </p> <p>2. Permitirá a Adobe [!DNL Analytics] mostrar indicadores de dirección (flechas) para añadir contexto en diversas métricas (por ejemplo, comparaciones de una semana a otra). Ejemplo: si "Errores enviados" sube de una semana a otra, ¿Adobe [!DNL Analytics] debe considerarlo positivo o negativo? Otros ejemplos: un aumento de los registros de correo electrónico es probablemente positivo. Sin embargo, un aumento de los errores de envío de formulario es probablemente negativo. </p> <p>En 
