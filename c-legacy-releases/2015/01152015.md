...
Desde el 30 de enero de 2015, solo la versión actual del Creador [!DNL Analytics] de informes de Adobe (5.0.50), [!DNL Analytics] Adobe Add-in para Excel, podrá conectarse a Adobe [!DNL Analytics]; las versiones anteriores dejarán de conectarse. Este cambio se debe a unas mejoras de seguridad realizadas en esa fecha. Todos los usuarios deben actualizar el software a la versión 5.0.50 o superior (lanzada el 21 de octubre de 2014) antes del 30 de enero de 2015. Si decide no actualizar la versión de su software, no podrá acceder al Creador de informes o recuperar datos con el Creador de informes después del 30 de enero de 2015 hasta que no instale la última versión. Consulte [Actualización del Creador de informes](https://marketing.adobe.com/resources/help/en_US/arb/?f=upgrade_arb) para saber cómo comprobar qué versión utiliza y cómo actualizar el software a la última versión.

## Funciones principales lanzadas en 2014

Funciones principales de Marketing Cloud lanzadas en 2014.
...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/audience_library.html" format="https" scope="external"> Audiencias de Marketing Cloud</a>: permite crear, editar y administrar audiencias, de forma parecida a como se trabaja con segmentos. Puede compartir audiencias para usarlas en soluciones como [!DNL Analytics], <span class="keyword">Target</span> y gestión de público. </p> </td> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/access.html#concept_04341546E8B44CDF833F9DDF351A50B9" format="https" scope="external"> Cuentas de vinculación</a>: otorga a los usuarios acceso a Marketing Cloud vinculando o asignando cuentas de solución con el Adobe ID. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Cambio de nombre: se ha cambiado el nombre de <span class="term">Target Advanced</span> a <span class="term">Target Classic</span>. La tarjeta "Target Advanced" de <span class="keyword">Adobe Marketing Cloud</span> ha cambiado a <span class="term">Target - Classic Workflow</span>. </p> </td> 
...
### Interfaz de Marketing Cloud 15.1.1 {#marketing_cloud_interface}
...
* Se ha resuelto el problema en el que un segmento usa el *` Then`* el operador mostró compatibilidad con Análisis específicos en el Generador de informes y [!DNL Analytics] segmentos. Sin embargo, al ejecutar un informe con el segmento en Ad Hoc Analysis, se ha producido un error. El segmento presentaba otro error al intentar guardarlo en el Creador de segmentos de Ad Hoc Analysis.
...
**Servicio de Marketing Cloud ID**
