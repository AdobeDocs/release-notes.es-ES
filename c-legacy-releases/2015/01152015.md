...
|---|---|
| Data Warehouse | Compatibilidad añadida para fuentes de datos de resumen en informes de Data Warehouse. Esto le permite informar sobre métricas como datos de motor de búsqueda (preclic) desde Adobe Advertising Cloud. |
