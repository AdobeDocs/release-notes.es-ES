...
[Uso de la precarga de DNS con diferentes Soluciones de Experience Cloud y Services ](https://marketing.adobe.com/resources/help/es_ES/mcloud/dns-prefetch.html)

Consulte [Experience Cloud ID Service ](https://marketing.adobe.com/resources/help/es_ES/mcvid/) documentación del producto.
...
* Se ha actualizado el diagrama de Venn para explicar la idea de audiencia abordable. Consulte [Documentación de Audiencia accesible ](https://marketing.adobe.com/resources/help/es_ES/aam/addressable-audiences.html). (AAM-27559)
* Se ha agregado una nueva macro de contenido &lt;DPUUIDS&gt; en los archivos de datos de salida. Consulte [Plantilla de macros de salida ](https://marketing.adobe.com/resources/help/es_ES/aam/outbound-template-macros.html) y [Ejemplos de macros de salida ](https://marketing.adobe.com/resources/help/es_ES/aam/outbound-macro-examples.html). (AAM-28000)
...
Para obtener la información más reciente sobre la versión, consulte las notas de la versión [de Primetime ](https://help.adobe.com/es_ES/primetime/release_notes/index.html).
...
* Página principal de las notas de la versión: [Versión de Adobe Experience Manager 6.2](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html)
