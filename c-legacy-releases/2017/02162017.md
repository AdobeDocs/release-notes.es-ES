---
description: Nueva interfaz de fuente de datos de análisis; desglose de Analysis Workspace por ubicación fija en tablas; correcciones generales para las versiones de mantenimiento en Adobe Marketing Cloud.
keywords: notas de la versión
seo-description: Nueva interfaz de fuente de datos de análisis; desglose de Analysis Workspace por ubicación fija en tablas; correcciones generales para las versiones de mantenimiento en Adobe Marketing Cloud.
...
Correcciones y actualizaciones de poca envergadura aplicadas a las herramientas y los componentes de la interfaz de Adobe Analytics (como Analysis Workspace, Informes y análisis, Creador de informes, etc.).
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Se ha corregido un problema que hacía que, pasados <span class="term"></span> 2 meses, el calendario no mostrara datos. (AN-137808) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_EE874B3A8F77478F818663664AA2752E">Se ha corregido un problema por el que la fecha de inicio de sesión del usuario no se actualizaba en la Admin Console al emplear el inicio de sesión único de Marketing Cloud. (AN-130665) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement</span> para JavaScript</b> </p> 
    ...
    </ul> <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2017/02162017.md#mcvid" format="dita" scope="local"> Servicio de Marketing Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
