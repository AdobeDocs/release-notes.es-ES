...
>[!IMPORTANT]
>
>El código de servicio de ID v2.0 sincroniza automáticamente los ID con [!DNL  Adobe Media Optimizer] de forma predeterminada. Consulte también [Conceptos básicos de sincronización de ID y tasas de coincidencia ](https://marketing.adobe.com/resources/help/es_ES/mcvid/mcvid-match-rates.html).
...
La ayuda del servicio de Experience Cloud ID se encuentra [aquí ](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
[Archivos CSV para informes de superposición ](https://marketing.adobe.com/resources/help/es_ES/aam/overlap-csv-files.html). Puede solicitar un archivo .csv para un [!UICONTROL  Informe superpuesto] cuando ese informe alcance su límite de 1 millón de registros.

Revisado:

* [Características y funciones del producto FAQ ](https://marketing.adobe.com/resources/help/es_ES/aam/faq_features_functions.html) incluye una nueva entrada sobre cómo encontrar el ID [!UICONTROL  de su organización].
* [Recopilación de datos e integración de productos FAQ ](https://marketing.adobe.com/resources/help/es_ES/aam/faq_data_collection_integration.html) de recopilación de datos e integración del producto incluye una nueva entrada sobre la inclusión en lista blanca de direcciones IP y FTP de [!DNL  Audience Manager].
* [Privacidad y retención de datos FAQ ](https://marketing.adobe.com/resources/help/es_ES/aam/faq_privacy.html) incluyen contenido de privacidad revisado.
* [Tráfico DIL en Google Tag Manager (GTM)](https://marketing.adobe.com/resources/help/es_ES/aam/t_dil_google_tagmanager.html) describe cómo se puede cargar código DIL en la sección HTML personalizada de una etiqueta.
* [TraitWeight](thttps://marketing.adobe.com/resources/help/es_ES/aam/traitweight.html) incluye información nueva sobre un paso extra en el proceso de detección algorítmica.
* [Tasas de error de muestreo de datos en informes seleccionados de Audience Manager ](https://marketing.adobe.com/resources/help/es_ES/aam/report-sampling.html) incluyen información nueva sobre cómo funciona el muestreo de datos.
* [Requisitos de tamaño de archivo y nombre de Amazon S3 para datos de entrada](https://marketing.adobe.com/resources/help/es_ES/aam/inbound-s3-filenames.html) incluyen información nueva sobre cómo el proceso de validación reacciona a archivos de datos vacíos.
...
>[!NOTE]
>
>Hemos eliminado de la navegación los vínculos de Adobe Analytics a todos los productos de puntos de Adobe, incluido Search y Promote. Los usuarios de dichas herramientas pueden iniciar sesión a través de Experience Cloud (si es compatible) o directamente. Para iniciar sesión en Search y Promote, utilice este vínculo:[https://center.atomz.com/center/](https://center.atomz.com/center/).
...
* Notas de la versión: [Versión de Adobe Experience Manager 6.2 ](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html)
* Página principal de ayuda: [Ayuda de Adobe Experience Manager ](https://docs.adobe.com)
* Scene7 Publishing System: [Notas de la versión de Scene7 Publishing System ](https://marketing.adobe.com/resources/help/es_ES/s7/release_notes/index.html)
* AEM Assets on Demand: [Notas de la versión ](shttps://helpx.adobe.com/es/support/experience-manager/6-3.html)
