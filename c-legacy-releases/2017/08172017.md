...
<table id="table_2D2E3E490C7347399F25F056AC601E39">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Una configuración booleana opcional que determina si el servicio de ID envía datos o no a Cooperación entre dispositivos de Adobe Marketing Cloud. Consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-coopsafe.html" format="https" scope="external">isCoopSafe </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Consulte [Adobe Mobile Services](https://marketing.adobe.com/resources/help/en_US/mobile/) para obtener documentación del producto. Para ver las notas de versiones anteriores, amplíe *Notas de la versión anterior* en el panel izquierdo.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C4E913B41B1E46E7821A312C42FFDADB"> 
      ...
      <li id="li_6CFDD8DDB0F345A498786663BDC24A40">Se ha corregido un problema que impedía que los segmentos de audiencia se publicaran de Analytics en Marketing Cloud. (AN-146486) </li> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Ver también:</b> <a href="../../c-legacy-releases/2017/08172017.md#mcvid" format="dita" scope="local"> Servicio de Marketing Cloud ID </a> (antes <span class="term">Servicio de ID de visitante</span>) </p> </td> 
  </tr> 
  <tr> 
...
* La pantalla Búsqueda de Audience Marketplace incluye ahora un enlace a [Audience Finder](https://www.adobe-audience-finder.com/). Utilice Audience Finder para descubrir socios que puedan proporcionarle el tipo de suministro de datos adecuado para su campaña. (AAM-30241)
...
[DIL](https://marketing.adobe.com/resources/help/en_US/aam/dil-overview.html) es el código de recopilación de datos de API para Audience Manager. Esta actualización de agosto corresponde a la versión 6.11 de DIL.
