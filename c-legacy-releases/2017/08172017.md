...
Consulte [Documentación de producto de Experience Cloud](https://marketing.adobe.com/resources/help/es_ES/mcloud/) para obtener ayuda sobre el producto.
...
Consulte [Experience Cloud ID Services](https://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
El 22 de agosto, Adobe Analytics habilitará [Geosegmentación](https://marketing.adobe.com/resources/help/es_ES/reference/reports_geosegmentation.html) para todos los clientes. Este cambio es un adelanto de la próxima eliminación de los ajustes de geosegmentación en la Admin Console.
...
* Usuarios vinculados con [ID de organización ](https://marketing.adobe.com/resources/help/es_ES/aam/ids-in-aam.html) ahora pueden iniciar sesión en la interfaz de usuario de Audience Manager con su Adobe ID en lugar de usar el nombre de usuario y la contraseña. (AAM-28161)
...
[DIL](https://marketing.adobe.com/resources/help/es_ES/aam/dil-overview.html) es el código de recopilación de datos API para Audience Manager. La versión de agosto incrementa el DIL a la versión 6.11.

* Se ha añadido una nueva configuración ` isCoopSafe`. Es una configuración booleana opcional que determina si DIL envía datos al [!DNL  Adobe Marketing Cloud Device Co-op]. Consulte [isCoopSafe](https://marketing.adobe.com/resources/help/es_ES/aam/?f=dil-coopsafe.html). (CORE-4334)

**Actualizaciones importantes en la documentación**

Hemos reescrito la documentación relativa al trabajo con nuestras API de Data Collection Server (DCS). Comience con los [métodos y códigos de la API del servidor DCS](https://marketing.adobe.com/resources/help/es_ES/aam/dcs-intro.html) y enfoque su trabajo hacia operaciones más complicadas con nuestras API de DCS.

>[!NOTE]
>
>Desde el 1 de junio de 2017, Adobe Social ha limitado el análisis de opiniones al inglés y al japonés. Para obtener más información, consulte la [información y las preguntas frecuentes sobre el análisis de opinión de escucha](https://marketing.adobe.com/resources/help/en_US/social/listening-sentiment-language-changes-faq.pdf).
...
* [Notas de la versión de Adobe Campaign Standard](https://docs.campaign.adobe.com/doc/standard/esn/RN.html)
* [Documentación de Adobe Campaign Standard ](https://docs.campaign.adobe.com/doc/standard/en/home.html)
* [Notas de la versión de AEM](../../c-legacy-releases/2017/08172017.md#section_A26CA0B1CC014A59A59EE6406C61771C)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora Media Optimizer sincroniza los enlaces de sitios compartidos de Yahoo Gemini creados en Yahoo y atribuye ingresos por clics en enlaces de sitios al anuncio y la palabra clave correspondientes. </p> <p>También puede editar enlaces de sitios compartidos en hojas de edición masiva. Aún no se admite el parámetro “Descripción”, pero Media Optimizer no cambiará sus valores existentes. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Solo para administradores y gestores de clientes con acceso directo) Puede permitir que Media Optimizer extraiga metadatos, datos de jerarquía y datos de audiencia única para segmentos de Audience Manager en la vista Publicidad de búsqueda &amp;gt; Campañas beta &amp;gt; Audiencias. Para configurar un anunciante, introduzca el ID de socio del anunciante para Adobe Audience Manager en Publicidad de búsqueda &amp;gt; Admin &amp;gt; Configuración de Audience Manager. </p> </td> 
  </tr> 
 </tbody> 
</table>
