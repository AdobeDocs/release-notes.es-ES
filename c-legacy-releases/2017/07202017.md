...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>(Portafolios con la configuración para «Modelar y optimizar la búsqueda de forma intradía»), Advertising Cloud ahora tiene en cuenta los datos de ingresos al cambiar ofertas y presupuestos de campaña para satisfacer tendencias intradía. Anteriormente, solo se tenían en cuenta los datos de clics. </p> <p>Ahora, las ofertas aumentan durante las partes de mayor rendimiento del día. </p> </td> 
  </tr> 
  <tr> 
