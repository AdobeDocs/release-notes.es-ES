...
Consulte [SDK 4.x de Android para Soluciones de Experience Cloud ](https://marketing.adobe.com/resources/help/es_ES/mobile/android/) y [iOS SDK 4.x para Soluciones de Experience Cloud ](https://marketing.adobe.com/resources/help/es_ES/mobile/ios/) para la documentación de SDK. Para ver las notas de versiones anteriores, amplíe *Notas de la versión anterior* en el panel izquierdo.
...
<table id="table_DAFBC066DDA74493BDC42AB40E85E04C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Anteriormente, si se iniciaba sesión en Experience Cloud y se navegaba hasta Analytics, no se podía utilizar la función “obtener vínculo del proyecto” en Analysis Workspace. Este problema está resuelto. Para que esta opción esté disponible, aún es necesario haber guardado el proyecto. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
...
* Mejoras en las [!UICONTROL reglas de combinación de perfiles]: todos los dispositivos cualificados para un segmento en tiempo real empleando una regla de combinación de perfiles creada mediante la opción de gráfico de dispositivo (p. ej., Device Graph Co-op o un gráfico de dispositivo externo) se incluyen ahora en el recuento Población total del segmento. Además, el ID de estos dispositivos cualificados también se envía a cualquier destino de lote configurado para ese segmento. Consulte [Reglas de combinación de perfiles y gráfico de dispositivos FAQ ](https://marketing.adobe.com/resources/help/es_ES/aam/profile-merge-faq.html) y [Datos de población de rasgos y segmentos en creador de segmentos ](https://marketing.adobe.com/resources/help/es_ES/aam/segment-builder-data.html). (AAM-27726)
* Los archivos CSV para [!UICONTROL informes de superposición] encerraban los datos de cadena entre comillas dobles. Consulte [Archivos CSV para superponer informes ](https://marketing.adobe.com/resources/help/es_ES/aam/?f=overlap-csv-files.html).
