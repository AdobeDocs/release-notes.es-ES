...
[Understanding ID Synchronization and Match Rates](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html) incluye nueva información acerca de la llamada ` cm.eversttech.net` que el servicio ID realiza a [!DNL  Adobe Advertising Cloud].
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Cuando se habilita la opción para optimizar automáticamente la ubicación o los ajustes de oferta de listas de remarketing, Advertising Cloud cambia ahora los ajustes de oferta relevantes para las campañas relevantes en el portafolio optimizado, según sea necesario, como parte del proceso de optimización. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
