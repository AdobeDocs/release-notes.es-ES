...
[Conceptos básicos de la sincronización de ID y las tasas de coincidencia ](https://marketing.adobe.com/resources/help/es_ES/mcvid/mcvid-match-rates.html) incluye información nueva sobre la llamada ` cm.eversttech.net` que hace el servicio ID a [!DNL  Adobe Media Optimizer].
...
* Se han añadido comas a la cantidad máxima de límite de uso para características, segmentos, destinos, etc. Consulte [Límites de uso ](https://marketing.adobe.com/resources/help/es_ES/aam/usage-limits.html). (AAM-29310)
...
* [Conceptos básicos de las llamadas al dominio Demdex ](https://marketing.adobe.com/resources/help/es_ES/aam/demdex-calls.html) proporciona una explicación sobre por qué [!DNL  Audience Manager] realiza llamadas a este dominio.
* [Archivos de secuencias de salida de Hadoop ](https://marketing.adobe.com/resources/help/es_ES/aam/outbound-seq-files.html) describe cómo se pueden exportar datos desde [!DNL  Audience Manager] Hadoop a través de archivos de secuencia binaria.
* [Reglas de combinación de perfiles FAQ ](https://marketing.adobe.com/resources/help/es_ES/aam/profile-merge-faq.html) proporciona respuestas a algunas preguntas comunes sobre [!UICONTROL  reglas de combinación de perfiles] y gráficos de dispositivos.
* [Casos de uso de Audience Lab](https://marketing.adobe.com/resources/help/es_ES/aam/audience-lab-use-cases.html) proporciona ejemplos de cómo utilizar esta función para realizar comparaciones y pruebas.
...
* [Notas de la versión de Adobe Campaign v 7](https://docs.campaign.adobe.com/doc/AC/en/RN.html)
...
* [Inicio AEM Help ](https://docs.adobe.com)
...
* [Inicio AEM Assets on Demand Help ](https://helpx.adobe.com/es/support/experience-manager/6-3.html)
