...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Asignación de grupos de informes en lotes </td> 
   <td colname="col2"> <p>En <span class="uicontrol"> Administración </span> &gt; <span class="uicontrol"> Report Suite Mapping </span>, ahora es posible seleccionar varios grupos de informes y asignarlos a una organización. (Anteriormente, había que hacerlo de forma individual).   </p> <p>Asignar grupos de informes a una sola organización ayuda a habilitar en Experience Cloud funciones y servicios entre soluciones. Consulte <a href="https://marketing.adobe.com/resources/help/es_ES/mcloud/report-suite-mapping.html" format="html" scope="external"> Asignación de grupos de informes </a> para obtener más información. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Actualizaciones en las audiencias de Experience Cloud </td> 
   <td colname="col2"> <p> <b>Aplicación de grupos de informes</b> </p> <p>Ahora puede aplicar un grupo de informes a todas sus <a href="https://marketing.adobe.com/resources/help/es_ES/mcloud/t_audience_create.html" format="html" scope="external"> reglas de audiencia </a>. (Anteriormente, había que especificar un grupo de informes en cada definición de regla). </p> <p> <b>Propiedades y variables</b> </p> <p>Ahora puede incluir propiedades y variables predeterminadas de Analytics (además de eVars y eventos) en audiencias en tiempo real. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Esta versión actualiza el código de servicio de ID a la versión 2.2. Incluye las siguientes funciones, correcciones y otros cambios.
...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Estas configuraciones se utilizan en conjunto. Permiten que diferentes instancias del código de servicio de ID implementadas en un iFrame y en la página principal se comuniquen entre sí. Están diseñadas para ayudar a resolver problemas con casos de uso específicos en los que puede que sea posible, o no, controlar la página o el dominio principal y en los que tenga el código de servicio de ID cargando en el iFrame de un dominio que controla. Están disponibles en la versión 2.2 o posterior del código de VisitorAPI.js.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E76128234BEC49F3BB95B22CFD917EBF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>La mensajería push ahora admite push enriquecidos, lo que le permite agregar una imagen o un vídeo a los mensajes push. </p> <p>Para obtener información sobre la creación de mensajes push, consulte <a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_experience__push_message.html" format="html" scope="external"> Experience: mensaje push </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Mejoras en el SDK para iOS y Android </p> </td> 
   <td colname="col2"> <p>En la versión 4.13.6, se han realizado las siguientes mejoras en el SDK para iOS y Android: </p> 
...
* Validación añadida de claves de datos de contexto para que coincidan con lo que Analytics acepta. (MOB-7365)
...
* El filtro global se ha eliminado para la página de información general de las aplicaciones. (MOB-1705)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics ha introducido tres nuevas SKU de producto: </p> 
    <ul id="ul_F617128BEA66444EB65DA29787BF19FE"> 
     <li id="li_3854FD42B52746638740897C52200A1D"> <a href="https://www.adobe.com/es/data-analytics-cloud/analytics/ultimate.html" format="html" scope="external"> Ultimate </a> </li> 
     <li id="li_41F95B75A97843A5B47B3F175310EF18"> <a href="https://www.adobe.com/es/data-analytics-cloud/analytics/prime.html" format="html" scope="external"> Prime </a> </li> 
     <li id="li_DB474BBAFBE145D2BD118194A8D867FE"> <a href="https://www.adobe.com/es/data-analytics-cloud/analytics/select.html" format="html" scope="external"> Seleccionar </a> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Mejoras en la recopilación de datos </p> </td> 
   <td colname="col2"> <p>La recopilación de datos se ha mejorado con las siguientes mejoras: </p> <p> 
     <ul id="ul_AA48A413187A40DAAA501C08155A5BA4"> 
      ...
      <li id="li_8CBAE925AD5A403E98D87A415CF890AD">Compatibilidad añadida con la API de Visitante 2.2.0. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_267B24EF2B314D828148D37F0820477E"> 
     <li id="li_D61F285F77B3413C972B671D5AFC097A">Segmentos ilimitados añadidos para la comparación de segmentos </li> 
     <li id="li_EA730D9F90E2490A97029032785A1590">Capacidad añadida para nombrar y administrar más fácilmente grupos de puntos de contacto (agregar, eliminar, mover, etc.) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se han realizado cambios en el calendario para adaptarlo al calendario de Reports &amp; Analytics: </p> 
    <ul id="ul_BD706B07369F4339BF4925F22FEC1C7F"> 
     <li id="li_33A47BAAD3C04C8784D2FC00A6F6782E">El primer clic en un día inicio la selección. A continuación, resalte el intervalo en cualquier dirección y vuelva a hacer clic para determinar la fecha final. Mantenga pulsada la tecla Mayús para anexar fechas a la selección. </li> 
     <li id="li_C3BEC56ABCED482C82A41EA0550B3077">Ampliación de los períodos de consulta para los distintos artículos de fechas móviles (por ejemplo, permitir que los días se remonten hasta dos años). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Búsqueda mejorada de elementos Dimension </p> </td> 
   <td colname="col2"> 
    <ul id="ul_E955585818FF4553A869003B94DDB697"> 
     <li id="li_A37D2DB6290842578FE752DD8E712B73">Se ha mejorado la velocidad de búsqueda. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7B6B794EDF874A4D87770AB9BAB42F33"> 
     <li id="li_0B403D892320434FBAD9A7F7B808947C"> <p> Se añadió una casilla de verificación para denotar recortes porcentuales, especialmente para métricas basadas en porcentajes (también funciona con métricas no basadas en porcentajes). </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/es_ES/analytics/analysis-workspace/alert-manager.html" format="html" scope="external"> Mejoras en el Administrador de alertas</a> </p> </td> 
   <td colname="col2"> 
    <ul id="ul_72464DC499744290BA37DB3B1E143F74"> 
     <li id="li_C687F0A3A99F4CC39B482BDA0F7B75DD">Se añadió la capacidad de habilitar o deshabilitar las alertas. </li> 
     <li id="li_F7415EE7DF29417FAF416594E36A38A4">Se añadió una columna "habilitada / deshabilitada". </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI es un grupo de paneles de análisis de negocios para analizar datos y compartir perspectivas. La integración de Adobe Analytics con Microsoft Power BI incluye la posibilidad de visualizar en este los datos del Report Builder de Analytics. </p> <p>Con Power BI, puede integrar Adobe Analytics con fuentes de datos adicionales (p. ej., puntos de venta, CRM) para descubrir perspectivas, asociaciones y oportunidades únicas de los clientes y compartirlas fácilmente en su organización. Al combinar las capacidades del Report Builder con las características de Power BI, la información se hace más accesible mediante web para todos los miembros de la organización. </p> <p>La integración con el Report Builder de Adobe le permite: </p> 
    <ul id="ul_48CC72D3E88B4CCAB6762A32E68E5764"> 
     ...
     <li id="li_5F609B1158D849F7886EB789CA78488D">Publique todas las tablas con formato del libro como tablas de conjuntos de datos de Power BI. </li> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Nuevo proceso de autorización de reglas de procesamiento (introducido en abril de 2017) </p> </td> 
   <td colname="col2"> <p>Antes del 20 de abril de 2017, todos los usuarios (administradores incluidos) debían superar un examen y recibir autorización del Servicio de atención al cliente de Adobe para utilizar reglas de procesamiento. </p> <p>Actualmente, los administradores tienen derechos para utilizar reglas de procesamiento de forma predeterminada. El examen ya no es necesario. Los administradores también pueden otorgar estos derechos a los no administradores a través de la interfaz de Herramientas de administración. <a href="https://marketing.adobe.com/resources/help/es_ES/reference/processing_rules.html" format="html" scope="external"> Más.. </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_B01BA12B21194F5ABFAEB3370DAEC15E">Se ha corregido un problema que provocaba un error al compartir un componente que contenía usuarios desconocidos (eliminados). (AN-143172) </li> 
     ...
     <li id="li_7639B76F98BF445C85172DD00A60D187">Se ha corregido un problema de permisos que impedía que los usuarios que no eran administradores cambiaran las variables de tráfico en varios grupos de informes al mismo tiempo. (AN-142952) </li> 
     ...
     <li id="li_EE7A01CF12414C03886FDBE1B7166890">Se ha corregido un problema con las alertas heredadas que impedía la transferencia de alertas a otro usuario. (AN-138964) </li> 
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">Se ha corregido un problema por el que los nombres de grupos de usuarios no se ordenaban alfabéticamente en el Admin Console. (AN-142769, AN-142274) </li> 
     ...
     <li id="li_30836B5D43674E9095878F06BB779CC3">Se ha corregido un problema que impedía que se mostraran grandes listas (más de 10.000) de componentes como segmentos o métricas calculadas. (AN-142562) </li> 
     <li id="li_A35A03057FAF418596A1977B629B52A1">Se han actualizado los datos de búsqueda de sistemas de informes relacionados con las actualizaciones de segmentación geográfica ISO de 2017 para 11 países afectados: bhr, civ, cze, fra, gbr, lux, mkd, mrt, omn, tjk, tto. (AN-143396) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> Se ha corregido un problema que se producía cuando se configuraba la visibilidad de una métrica, pero no su polaridad. El color de Cambio de resumen resultante en Analysis Workspace no era el esperado (rojo cuando negativo, verde cuando positivo). (AN-143496, AN-143413) </li> 
      <li id="li_0A722B38C64644089579A53743B9B707">Se ha corregido un problema con algunas configuraciones de visualización que impedía descargar y enviar archivos PDF. (AN-142866, AN-142725) </li> 
      <li id="li_6DE7C39FEAF142C1883651EB14BB5834">Se ha corregido un problema que provocaba que "Compartir automáticamente componentes incrustados [segmentos, métricas calculadas, intervalos de fechas] con Destinatarios" sobrescribiera la configuración "Compartido con" en el Administrador de métricas calculadas, el Administrador de segmentos y el Administrador de intervalos de fechas. Esta cuestión dio lugar a una reducción significativa de la lista de destinatarios. (AN-142804, AN-142378 y AN-142533) </li> 
      <li id="li_86BC59740DC8438089484C7A7466C309">Se ha corregido un problema que impedía descargar o enviar proyectos PDF con una configuración específica de "Desglose por posición". (AN-142794, AN-142618) </li> 
      <li id="li_B2C382D402CF4C088D690468F45C6E04">Se ha corregido un problema que provocaba que la moneda mostrada en los gráficos de Workspace fuera diferente de la establecida para el grupo de informes. (AN-142719) </li> 
      <li id="li_6E0451C8A2E146E6A4C59BB8AE1A173A">Se ha corregido un problema con el formato en los archivos PDF descargados. Los proyectos de Workspace descargados como archivos PDF ahora coinciden con el tamaño de la ventana de Workspace en el momento de la descarga. (AN-142588, AN-142351) </li> 
      <li id="li_9A49959A401043B9BB90233F0BFF01B2">Se ha corregido un flujo de trabajo complejo que provocaba que los proyectos quedaran en blanco. (AN-142467, AN-142287) </li> 
      ...
      <li id="li_DC21401290904879AC1172D8365A6F63">Se ha corregido un problema que provocaba que se mostraran errores al editar algunos proyectos programados. (La hora de inicio no puede ser posterior a la hora de caducidad). (AN-141934) </li> 
      <li id="li_7E255AF1D3CC4F1CBFF487625516F1AD">Se ha corregido un problema de rendimiento que provocaba que los proyectos que utilizan alineación de fechas se cargaran lentamente. (AN-141393) </li> 
      <li id="li_DF9F4B8933444F66A9A60691E932FC28">Se ha corregido un problema con las visualizaciones de visitas en el orden previsto que impedía a los usuarios agregar componentes adicionales a los puntos de contacto. (AN-140737, AN-140264) </li> 
      <li id="li_CF0CE4C306B44EBDA44FC963E539F124">Se corrigió un problema en el cual, en los paneles desplazables, los intervalos de fechas no se representaban correctamente en los archivos PDF. (AN-139443) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_22809FEEE8AE48EBB2B8117A104F3866"> 
      <li id="li_EB93FD6A160F4DECAFF8E344C9DCB3FA">Ya no se pueden crear segmentos que utilicen "Compatibilidad con complementos" como dimensión. Estos segmentos no funcionaban correctamente. (AN-91081) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_7B5A8E435A124A908233FFEF348A63AB">Se ha corregido un problema intermitente con los informes en tiempo real que impedía que se mostraran dimensiones. En la siguiente actualización de datos, este problema debería desaparecer. (AN-139339) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_336B914674184FF9AC9602E0448FEFC0"> 
      ...
      <li id="li_00E7D2FA09084011B0111F36C1BCE129">Se ha corregido un problema que provocaba que las superposiciones de burbujas se desplazaran a la izquierda de los vínculos. (AN-124094) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La recopilación de datos se ha mejorado con las siguientes mejoras: </p> <p> 
     <ul id="ul_653D0E22B43F42BFAB22441312980198"> 
      <li id="li_90139F03D54348B3B8E3189376C9F9EF">Compatibilidad añadida para varios pedidos de creación de instancias de AppMeasurement. </li> 
      <li id="li_4EAD6520A4A24A29B88BE0E4D9DAEAAD">Compatibilidad añadida con la API de Visitante 2.2.0. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Data Warehouse </p> </td> 
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Se ha actualizado la interfaz de usuario para que muestre el texto de estado "Solicitud demasiado grande" en lugar de "Error de procesamiento" para las solicitudes que son demasiado grandes para procesarlas. (AN-92669) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_BFC1B2ABAC8C41B69A7AE72B1BF191DA"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Se ha actualizado a la versión 2.0 de la API de LinkedIn para las organizaciones. Aunque esto no afecta a las funciones, actualiza <span class="keyword"> Adobe Social </span> con respecto a las API más recientes. 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> Desktop App 1.5, publicado el 31 de mayo de 2017, ofrece actualizaciones de estabilidad y correcciones críticas. </p> <p> <a href="https://docs.adobe.com/docs/en/aem/6-3/release-notes/desktop-app-release-notes.html" format="https" scope="external"> Notas de la versión </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>3D Assets 2.0 en AEM 6.3 </p> </td> 
   <td colname="col3"> <p>Feature pack para 3D Assets en AEM 6.3, publicado el 26 de mayo de 2017. </p> <p>Se ha mejorado la funcionalidad AEM 3D de las ingestas de archivos 3D, la administración de DAM y el procesamiento 2D. </p> <p> <a href="https://docs.adobe.com/content/docs/en/aem/6-3/release-notes/aem3d-release-notes.html" format="https" scope="external"> Notas de la versión </a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.1 SP2-CFP9, publicado el 5 de junio de 2017, es una actualización importante que incluye correcciones clave de cliente realizadas tras la disponibilidad general de AEM 6.1 SP2 en agosto de 2016. </p> <p> 
     <ul id="ul_500BCBB0899D4F77B3D2A72F121F4A1B"> 
      ...
      <li id="li_08A790CB5D4740E4B522D59A70174204"> <a href="https://helpx.adobe.com/es/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> Versiones de AEM 6.1 Forms </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.2 SP1-CFP4, publicado el 7 de junio de 2017, es una actualización importante que incluye correcciones clave del cliente realizadas tras la disponibilidad general de AEM 6.2 SP1 en diciembre de 2016. </p> <p> 
     <ul id="ul_3968AE5D0CE04EC98CC5E212727F23DE"> 
      <li id="li_2534E12413994EA2BB4637CF753D18E7"> <p> <a href="https://helpx.adobe.com/es/experience-manager/release-notes--aem-6-2-cumulative-fix-pack.html" format="https" scope="external"> Notas de la versión </a> </p> </li> 
      <li id="li_255BB17A0507445B890E52DC04DD0150"> <p> <a href="https://helpx.adobe.com/es/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> Versiones de AEM 6.2 Forms </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Hay disponibles entradas para las sesiones de IMMERSE17 on Demand. Cómprelas <a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external"> aquí </a> y utilice el código 
     <code>OD#1AEM</code> code. </p> <p>Las sesiones disponibles incluyen: </p> <p> 
     <ul id="ul_75125CE859334A8681B2D6A90741FCB8"> 
      <li id="li_76BAFB6F41D24F76880DD38B6A1FDBC5">Presentaciones a plataformas, capacidades y funciones. </li> 
      <li id="li_00A102886F9A4CE2A7B61CCE93AA151E">Técnicas para desarrolladores. </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Sesión de mayo: Uso de Lazybones y plantillas editables en AEM proyectos. </p> <p> Únete a Ankur Ahlawat y Scott Macdonald para una discusión sobre el uso de Lazybones y plantillas editables en AEM proyectos. </p> <p>Al revisar esta sesión, puede aprender a crear AEM proyectos que aprovechen Lazybones y las nuevas plantillas editables de sus proyectos. Grabado el 30 de mayo de 2017 a las 8:00 horas PDT (<a href="https://bit.ly/ATACE517" format="http" scope="external">https://bit.ly/ATACE517 </a>). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La oferta intradía ya está disponible para todas las estrategias de inversión de portafolio, incluidos ROI, CPT marginal y CPT, mediante la configuración de portafolio para "Modelar y optimizar la búsqueda en forma intradía". </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Buscar </p> </td> 
   <td colname="col2"> <p>Ahora puede probar la creación y actualización de audiencias de coincidencia de clientes de Google mediante listas de correo electrónico de su propio sistema de administración de la relación con los clientes (CRM). Póngase en contacto con el administrador de cuentas de Advertising Cloud para obtener más información. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Todas las plantillas de fuentes de inventario ahora incluyen una ficha "Clasificaciones de etiquetas", desde la cual puede asignar valores de clasificación de etiquetas estáticas a los diferentes componentes de campaña que se crean o editan desde la plantilla. </p> <p>Las clasificaciones de etiquetas aún no son compatibles con los grupos de productos. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Buscar en campañas beta </p> </td> 
   <td colname="col2"> <p>(Solo anunciantes incluidos en la lista de permitidos beta) Las nuevas funciones incluyen: </p> <p> 
     <ul id="ul_A658564B515E4D93A85629F44EC1CBEA"> 
      <li id="li_5A4D795BFE6F4811BEC4261E8C5F6FFD">Capacidad para editar una sola publicidad </li> 
      <li id="li_206DAB6B4AFA4EA29B0179D9D9D42EC6">Vista Colocaciones </li> 
      <li id="li_A583A0544E2C4146AF314BB3EC3C19FF">Vista de Destinatarios automáticos </li> 
      <li id="li_3EC6958CED6F4E6CB226F1EC1CB0C989">Gráficos de tendencias en algunas vistas </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
