...
Nuevas funciones y correcciones de errores en Adobe Experience Cloud (anteriormente, Marketing Cloud).
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En la versión 4.13.6 se realizaron las siguientes mejoras en el SDK para iOS y Android: </p> 
    <ul id="ul_B4DC25FD25B745A6BB39B8965D22ECAD"> 
     <li id="li_17282AB9A66A4484917CB9B703AA6DE8">En el servicio de Marketing Cloud ID, las API   <span class="varname">syncIdentifiers</span> ahora permiten sobrescribir un valor de ID existente. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">Se ha corregido un problema que causaba un error de creación de segmento al activar la opción “Convertir en audiencia de Marketing Cloud”. (AN-142218, AN-143300) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">Se ha corregido un problema por el que la opción “Vínculo a este informe” no estaba disponible cuando el usuario iniciaba sesión mediante Marketing Cloud. (AN-118492) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C375006CB8A4723B3FC07A8FF7FF6E6"> 
      ...
      <li id="li_BC279F05086144CE8BE0A9A60C5FE865">Se ha corregido un problema que impedía iniciar sesión en el Report Builder con el inicio de sesión único de Marketing Cloud. (AN-138557) </li> 
...
<table id="table_BFC1B2ABAC8C41B69A7AE72B1BF191DA"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Actualizado a la versión 2.0 de la API de LinkedIn para organizaciones. Aunque esto no afecta a las funciones, pone <span class="keyword">Adobe Social</span> al día respecto a las API más recientes. 
     <!--AS-39691--></p> </td> 
  </tr> 
 </tbody> 
</table>
