...
* Puede usar nuestras API de DCS usando los métodos GET o POST. [Métodos DCS API ](https://marketing.adobe.com/resources/help/es_ES/aam/dcs-api-methods.html) describe la sintaxis que debe utilizar, en cada caso.
...
La documentación del producto está disponible en [documentación de Adobe Campaign Standard ](https://docs.adobe.com/docs/es/campaign/ACS.html).

* [Notas de la versión de Adobe Campaign Standard](https://docs.campaign.adobe.com/doc/standard/en/RN.html)
* [Documentación de Adobe Campaign Standard](https://docs.adobe.com/docs/es/campaign/ACS.html)
* [Notas de la versión de Adobe Campaign v7](https://docs.campaign.adobe.com/doc/AC/en/RN.html)
* [Documentación de Adobe Campaign v7](https://docs.adobe.com/docs/es/campaign/AC.html)
* [Documentación de Adobe Campaign v6](https://docs.adobe.com/docs/es/campaign/AC6.html)
