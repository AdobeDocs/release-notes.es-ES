...
* Se han migrado los métodos de API de carpeta y característica a Swagger. Consulte [el Código de API de Audience Manager Migration ](https://marketing.adobe.com/resources/help/es_ES/aam/c_api_swagger.html). (AAM-28221 y AAM-27133)
...
En esta versión se ha corregido un error que causaba que ` GA.submitUniversalAnalytics` no pudiera enviar datos a los servidores de recopilación de datos. Consulte [GA. submitUniversalAnalytics ](https://marketing.adobe.com/resources/help/es_ES/aam/dil-google-universal-analytics.html). (MCID-354)

**Documentación nueva y revisada**

**Nuevas**

[Uso de la precarga de DNS con diferentes Soluciones de Experience Cloud ](https://marketing.adobe.com/resources/help/es_ES/mcloud/dns-prefetch.html de Experience Cloud) describe cómo utilizar la precarga de DNS para reducir los tiempos de carga de la página.

**Revisado**

* [Códigos de error DCS, mensajes y ejemplos ](https://marketing.adobe.com/resources/help/es_ES/aam/dcs_error_codes.html) incluye advertencias de integración.
* [Nombre de fichero de datos de salida ](https://marketing.adobe.com/resources/help/es_ES/aam/c_name_reqs_outbound.html) incluye el ` PID-ALIAS` parámetro opcional.
* [Vista resumen de segmentos ](https://marketing.adobe.com/resources/help/es_ES/aam/c_segment_summary.html) incluye intervalos retrospectivos de informes.
* [Crear DIL ](https://marketing.adobe.com/resources/help/es_ES/aam/r_dil_create.html) incluye información nueva sobre ` containerNSID` la propiedad.
* [Métricas de audiencia dirigible ](https://marketing.adobe.com/resources/help/es_ES/aam/addressable-audience-metrics.html) incluye definiciones revisadas y organización de contenido.
...
[Inicio de la Ayuda de Primetime](https://helpx.adobe.com/es/support/primetime.html es)
...
* [Notas de la versión AEM 6.1 ](https://docs.adobe.com/docs/es/aem/6-1/release-notes.html)
* [Notas de la versión AEM 6.2](https://docs.adobe.com/docs/en/aem/6-2/release-notes.html)
* [Inicio Adobe Experience Manager Help ](https://docs.adobe.com)
...
* [Notas de la versión AEM Assets on Demand](https://helpx.adobe.com/es/support/experience-manager/6-3.html)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Las opciones de “Optimizar automáticamente los ajustes de oferta” permiten a Media Optimizer cambiar de forma automática la configuración de los ajustes de oferta en grupos de anuncios del portafolio cuando este se optimiza con el fin de mejorar el rendimiento. Media Optimizer permite optimizar los ajustes de oferta para Google, Yahoo! y Bing. Concretamente, las segmentaciones de dispositivos móviles en Japón, las segmentaciones de equipos y tabletas de Google y Bing, las segmentaciones RLSA de Google y las segmentaciones de ubicación de Google. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Cuentas de Bing Merchant Center con URL finales) Existe un campo “Plantilla de seguimiento” disponible para grupos de productos en las plantillas y en las hojas de edición masiva de Bing Shopping. </p> <p>Para el seguimiento de conversiones de Media Optimizer, si dispone de una plantilla de seguimiento a nivel de cuenta, campaña o grupo de anuncios, no es necesario indicar ningún valor. </p> </td> 
  </tr> 
  <tr> 
