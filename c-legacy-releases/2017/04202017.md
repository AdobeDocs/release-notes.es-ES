...
* Se han migrado los métodos de API de segmentos a Swagger. Consulte [el Código de API de Audience Manager Migration ](https://marketing.adobe.com/resources/help/es_ES/aam/c_api_swagger.html). (AAM-28601)
