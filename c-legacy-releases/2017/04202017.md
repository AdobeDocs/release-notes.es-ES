  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora puede crear audiencias de Google (listas de remarketing para anuncios ligados a la búsqueda) con listas o segmentos de correo electrónico de sus audiencias existentes de Adobe Experience Cloud: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmentos de Adobe Audience Manager: (Beta solo para anunciantes con lista blanca) Desde Campañas Beta &amp;gt; Audiencias &amp;gt; Audiencias, puede crear una audiencia basada en etiquetas de un sitio web de Google a partir de cualquiera de los segmentos de Audience Manager que tengan a Advertising Cloud como destino. Esto puede incluir segmentos de Adobe Analytics que se publique en Adobe Experience Cloud y segmentos que se creen en Adobe Experience Cloud con el servicio principal Personas. Advertising Cloud automáticamente enviará una URL de seguimiento de Google a los segmentos de Audience Manager para que Google pueda realizar un seguimiento de la audiencia. </li> 
