...
* Added new documentation, [Content Security Policies and the Marketing Cloud ID Service](https://docs.adobe.com/content/help/es-ES/id-service/using/reference/csp.html) that explains how to allow calls to Adobe domains used by the ID service.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Los Dimension basados en la marca de tiempo se han agregado de forma predeterminada a Analysis Workspace. Los Dimension incluyen: </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud ahora puede realizar un seguimiento del rendimiento de asistentes inteligentes con voz habilitada, como Amazon Alexa, Google Assistant, Microsoft Cortana y Apple Siri. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">Preguntas más frecuentes </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se corrigió un problema en el cual los nombres de segmentos de Audience Manager actualizados no se enviaban a los destinos DFP de Google. (AAM-31677)
...
* Se ha corregido un error relacionado con Chrome que provocaba que el DIL emitiera un error al hacer clic en el botón Atrás de ese explorador. (CORE-5135)
* Se han eliminado los módulos de código no utilizados. (CORE-4554)
* Ahora, el DIL vuelve a activar la sincronización de ID cuando cambia el ID de región en la respuesta de llamada de evento. (CORE-4304)
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Ahora es posible enviar datos de comportamiento de Adobe Campaign Standard a Adobe Campaign v7, permitiendo así que los especialistas en marketing y analistas de datos creen una vista de 360° de campañas de marketing; crear audiencias y segmentos avanzados que incorporen datos de comportamiento de ACS; y medir de manera más eficaz el ROI de las actividades de mercadotecnia. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Conector SAP HANA </p> </td> 
   <td colname="col2"> <p>Rompa los silos y aproveche todos sus ‪ de datos externos en ‪ Adobe Campaign en tiempo real con conectores de ‪ Acceso de datos federado, que ahora también admiten SAP HANA. El ‪ de acceso a datos federado ‪ permite a los usuarios conectar varias bases de datos ‪ externas ‪ dispares con Adobe Campaign. Consulta de datos en tiempo real desde cualquier origen sin importar ‪ conjunto de datos de ‪ ni almacenarlos en la plataforma Adobe Campaign. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Conector Hadoop mediante HiveSQL </p> </td> 
   <td colname="col2"> <p>Cuando se trata de manejar grandes conjuntos de datos, Hadoop tiene la ventaja sobre los sistemas de administración de bases de datos relacionales, y su valor para cualquier empresa de tamaño seguirá aumentando a medida que los datos no estructurados sigan creciendo. Adobe Campaign puede aprovechar la potencia de Hadoop mediante el conector Hadoop mediante HiveSQL, donde los clientes pueden acceder a esquemas directamente desde la interfaz de usuario de Adobe Campaign para crear audiencias avanzadas y altamente segmentadas de forma rápida, flexible y escalable. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Paquete de funciones de Dynamic Media de AEM 6.3 (NPR-14410 y NPR-18912) </p> </td> 
   <td colname="col3"> <p>Esta versión ofrece nuevas funciones de automatización y envío para los clientes de Dynamic Media, y es la primera versión dirigida a clientes existentes de Dynamic Media Classic (S7)-AEM para la transición a Dynamic Media. </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p>Forms adaptable </p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p>Instalación y actualización de Forms JEE </p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p>Tutorial de introducción al desarrollo de AEM Sites 6.3 - WKND </p> </td> 
   <td colname="col3"> <p>El nuevo tutorial de introducción para desarrolladores 6.3 está disponible en función de las siguientes tecnologías de AEM más recientes: </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads comenzará a migrar las cuentas administradas por Advertising Cloud al nuevo modelo de enlaces de sitios compartidos el 25 de septiembre; se espera que el proceso dure cuatro días. Entre el 22 de septiembre y la finalización de la migración de cuentas, los enlaces de sitios no serán accesibles en Advertising Cloud y se mostrarán incorrectamente como eliminados. Si necesita realizar cambios en los vínculos de sitio antes de completar la migración, trabaje directamente en el editor de Bing Ads; los cambios se migrarán al nuevo modelo y Advertising Cloud los sincronizará una vez finalizada la migración. La funcionalidad para admitir enlaces de sitios compartidos estará disponible en la versión de octubre. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Buscar en campañas beta </p> </td> 
