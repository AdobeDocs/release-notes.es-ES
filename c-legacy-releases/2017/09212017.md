...
* Se ha añadido nueva documentación, [Políticas de seguridad de contenido y el servicio de Marketing Cloud ID](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid-csp.html), que explica cómo incluir en la lista de elementos permitidos las llamadas a dominios de Adobe usados por el servicio de ID.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_5BA908ECDF46494081D73CA9602553CF"> 
      ...
      <li id="li_BDB795408EDD40B5858A684BF1828098"> <b>Autenticación</b>: se ha solucionado un problema que se producía al iniciar sesión desde Marketing Cloud y que impedía a los usuarios acceder a algunos grupos de informes virtuales. (AN-148185 y AN-147504) </li> 
      ...
      <li id="li_3051E23A85544CA997778CE515D62D5C"> <b>Segmentación</b>: se ha solucionado un problema que se producía al crear un segmento en Analytics y compartirlo con Marketing Cloud: se creaban 2 segmentos a la vez en Audience Manager con el mismo nombre, pero en distintos grupos de informes. De ahora en adelante, publicaremos el segmento en un solo grupo de informes. (AN-148432) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se ha solucionado un problema que impedía que [Laboratorio de audiencias](https://marketing.adobe.com/resources/help/en_US/aam/?f=audience-lab.html) se cargara a tiempo. (AAM-32249)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads empezará a migrar las cuentas administradas por Media Optimizer al nuevo modelo de vínculos de sitio (vínculos de sitio compartidos) el 25 de septiembre. Se espera que el proceso dure cuatro días. Entre el 22 de septiembre y la fecha en que se complete la migración de sus cuentas, los vínculos de sitio no serán accesibles en Media Optimizer y aparecerán, por error, como eliminados. Si necesita hacer cambios en los vínculos de sitio antes de que se complete la migración, trabaje directamente en el editor de Bing Ads. Los cambios se migrarán al modelo nuevo y Media Optimizer los sincronizará una vez finalizada la migración. La funcionalidad que admite los vínculos de sitio compartidos estará disponible en la versión de octubre. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Buscar en campañas beta </p> </td> 
