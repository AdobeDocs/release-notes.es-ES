...
| 17 de agosto de 2020 | [Introducción a HTML5 Forms para desarrolladores](https://experienceleague.adobe.com/?lang=es&recommended=ExperienceManager-D-1-2020.forms&lang=es) | Curso | Ofertas de formularios HTML5 que representan plantillas de formulario XFA en formato HTML5. Esta capacidad permite procesar formularios en dispositivos móviles y navegadores de escritorio en los que no se admite PDF basado en XFA. |
