...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: disponibilidad en EMEA y APAC | 31 de agosto de 2020 | Los clientes de EMEA y de APAC pueden acceder a gráficos privados y de [Cross-Device Analytics](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html). |
...
Consulte las [Pruebas de auditoría de contenido.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)
...
| 12 de agosto de 2020 | [Desarrollo local con SDK de AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/commerce/develop.html) | Vídeo | Aprenda a configurar un entorno de desarrollo local para [!UICONTROL AEM Commerce] y el SDK de [!UICONTROL AEM as a Cloud Service]. |
