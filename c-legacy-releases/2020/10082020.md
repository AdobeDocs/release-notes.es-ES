...
Versión de septiembre: consulte [Notas de la versión para Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html#september-release).
...
| 14 de septiembre de 2020 | [Uso de métricas en una tabla improvisada](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-metrics-in-a-freeform-table.html?lang=es) | Vídeo | Conozca las distintas formas en que puede utilizar las métricas en una tabla [!UICONTROL improvisada] en [!UICONTROL Analysis Workspace]. |
...
[La documentación de accesibilidad](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/accessibility-in-aam.html) ya está disponible para Audience Manager.
...
| 14 de septiembre de 2020 | [Creación de características integradas](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-onboarded-traits.html) | Vídeo | Conozca sugerencias para crear características integradas en Audience Manager. |
...
| 25 de septiembre de 2020 | [Verifique usuarios con sus números de teléfono móvil](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/two-factor-authentication.html) | Artículo | Aprenda a verificar el OTP mediante SMS en sus formularios adaptables. |
...
| 21 de septiembre de 2020 | [Configuración de manifest.yml](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/develop/manifest.html) | Artículo | El cómputo de recursos manifest.yml del proyecto describe todos los trabajadores de esta aplicación que se implementarán. |
...
* Versión 20.2.3: [más información](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html#release-20-2-3-build-9182)
...
* Versión 20.4: [más información](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html#release-20-4---october-2020)
...
| 11 de septiembre de 2020 | [Delegación de subdominios](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/subdomain-delegation.html) | Campaign Classic | El Panel de control de Adobe Campaign le permite delegar completamente un subdominio a Adobe Campaign. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| 30 de septiembre de 2020 | [Explicación rápida de Adobe Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/quick-tour.html) | Vídeo | Haga un rápido recorrido por la interfaz de Adobe Sign para ponerse en marcha. |
