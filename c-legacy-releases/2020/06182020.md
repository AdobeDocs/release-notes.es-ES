...
* [Notas de la versión de Experience Platform Launch](https://experienceleague.corp.adobe.com/docs/launch/using/intro/release-notes/current.html)
...
Para obtener las últimas actualizaciones de la versión, consulte las [notas de la versión de Journey Orchestration](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html)
...
* **AEM 6.5.5.0**
   ...
   * [Notas de la versión](https://experienceleague.corp.adobe.com/docs/experience-manager-65/release-notes/service-pack/sp-release-notes.html)
...
* **AEM as a Cloud Service**
   ...
   * Herramientas de transición para apoyar la aceleración en la nube.
   ...
   [Notas de la versión de AEM as a Cloud Service 2020.6.0](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* **Accesibilidad y directrices WCAG 2.1**
   ...
   * [Adobe Experience Manager as a Cloud Service y las directrices de accesibilidad web](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/onboarding/accessibility/web-accessibility.html)
   * [Guía rápida de WCAG 2.1](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/onboarding/accessibility/quick-guide-wcag.html)
   * [Crear contenido accesible (Conformidad con WCAG 2.1)](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/accessible-content.html)
...
| [Creación de un documento de canal de impresión en AEM Forms](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/forms/ic-print-channel-tutorial/introduction.html) | Artículo | Aprenda los pasos necesarios para crear una comunicación interactiva para el canal de impresión. |
...
| [Búsqueda de recursos](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/asset-search.html) | Tutorial de vídeo | Los usuarios creativos pueden buscar recursos almacenados en AEM Assets mediante palabras clave o realizar una búsqueda en una ubicación específica. |
...
| [Representación de Solo para ubicación para AEM Assets](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/for-placement-only.html) | Tutorial de vídeo | Descubra cómo crear y utilizar una representación de Solo para ubicación (FPO) para AEM Assets. |
| [Colocar copia](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/place-copy.html) | Tutorial de vídeo | Aprenda a utilizar recursos de AEM Assets mediante la operación Colocar copia. |
| [Descargar y cargar](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/download-and-upload.html) | Tutorial de vídeo | Obtenga información sobre cómo descargar y cargar archivos de recursos desde y a AEM Assets mediante el panel de Asset Link. |
| [Archivos y colecciones](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/adobe-asset-link/files-and-collections.html) | Tutorial de vídeo | Obtenga información sobre cómo acceder rápida y fácilmente a archivos y colecciones de AEM Assets desde el panel de Asset Link. |
| [Descargar](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/sharing/download.html) | Tutorial de vídeo | Obtenga información sobre cómo descargar recursos y sus representaciones en su equipo local para usarlos y compartirlos. |

### Recursos adicionales

* [AEM como Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
[La versión de Adobe Campaign Classic 20.2](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html) incluye:

* _Compatibilidad con Emoticon_ - _Conector de sinapsis de Azure_ - _Nuevas regulaciones de privacidad_
* Panel de control de Campaign: [monitoreo activo del perfil](https://experienceleague.corp.adobe.com/docs/control-panel/using/performance-monitoring/active-profiles-monitoring.html)
