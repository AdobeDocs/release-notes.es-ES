...
| [!DNL Adobe Campaign]: Destinos de audiencia | Vídeo: [Cambiar la dimensión de segmentación de una entrega para una audiencia de otra plataforma](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/changing-targeting-dimension.html?lang=es) | Descubra cómo cambiar la dimensión de segmentación de una entrega para una audiencia de otra plataforma fuera de la tabla de perfil principal en Adobe Campaign Standard. |
