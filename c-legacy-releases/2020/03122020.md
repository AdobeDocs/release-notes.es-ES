...
* [[!DNL Campaign]](#ac)
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html?lang=es) (vínculos a la ayuda de la solución)
...
**Nota:** La   página de fuentes dejó de usarse en enero de 2020. Busque un aviso de obsolescencia del producto.

Para obtener documentación del producto, consulte la página de ayuda de [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en).
...
Para obtener documentación del producto, consulte la sección [Ayuda de Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/landing/home.html?lang=en).
...
| Fin de la vida útil de la configuración **[!UICONTROL Archivo de tablero]** | 27 de marzo de 2020 | La configuración **[!UICONTROL Ver archivo]** en **[!UICONTROL Administrar tableros]** en [!UICONTROL Informes y análisis] dejará de estar disponible a partir de octubre de 2020. |
...
Consulte [Notas de la versión de AppMeasurement para JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en). La versión 2.20.0 se publicó 5 de marzo de 2020.
...
Consulte [Trabajar con el Recorte inteligente](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/adding-dynamic-media-assets-to-pages.html?lang=en).
...
* [Página de inicio de Learn &amp; Support de AEM 6.2](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
* Adobe Campaign Classic: [Documentación](https://experienceleague.adobe.com/docs/campaign-classic.html) - [Notas de la versión](https://final-docs.campaign.adobe.com/doc/AC/en/RN.html) - [Vídeos de presentación](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=es)
