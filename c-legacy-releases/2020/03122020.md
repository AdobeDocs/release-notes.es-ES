...
* [[!DNL Analytics]](#analytics) - Fecha de versión: **12 de marzo de 2020** (Actualización: 7 de abril de 2020)
...
| [!UICONTROL Administración] > [!UICONTROL Propiedades de la transacción] | La nueva columna [!UICONTROL ID de propiedad] muestra el ID de propiedad exclusivo de cada propiedad de transacción. Puede buscar cualquier cadena contenida en los valores de columna. |
