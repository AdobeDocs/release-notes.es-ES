...
* [[!DNL Target]](https://experienceleague.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html) (lleva a la página de ayuda de Target)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
¿Necesita ayuda? Visite [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/?lang=es#home) para encontrar cursos seleccionados por Adobe, documentación técnica, respuestas rápidas, perspectiva de la comunidad y formación dirigida por instructores.
...
* [Compatibilidad con Atributos del cliente para CCPA](https://experienceleague.adobe.com/content/help/en/core-services/interface/customer-attributes/ccpa.html) (Ley de Privacidad del Consumidor de California)
* [Compatibilidad de atributos del cliente con el RGPD](https://experienceleague.adobe.com/content/help/en/core-services/interface/customer-attributes/gdpr.html) (Reglamento General de Protección de Datos)
...
* [Documentación](https://experienceleague.adobe.com/content/help/en/journeys/using/journey-orchestration-home.html)
* [Notas de la versión](https://experienceleague.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html)
* [Vídeotutoriales](https://experienceleague.adobe.com/content/help/en/platform-learn/tutorials/journey-orchestration/introduction.html)
...
Consulte [Acerca del seguimiento del estado del reproductor](https://experienceleague.adobe.com/content/help/en/media-analytics/using/player-state-tracking/player-state-overview.html).
...
| -----------| ---------- | ---------- |
| Migración al dominio de producto unificado | Fecha de entrada en vigor: 28 de mayo de 2020 | La migración a un dominio de producto unificado para Adobe Analytics, que comenzó en enero de 2020, finalizó el 28 de mayo de 2020. Aunque Adobe Analytics trabaja para eliminar todas las referencias al dominio `omniture.com` de su arquitectura, es importante permitir `omniture.com` como una cookie de terceros. En breve, cuando la migración total de la arquitectura se complete, se lo comunicaremos mediante las notas de la versión. A partir de entonces, ya no será necesario incluir el dominio en la lista de dominios permitidos. [](https://helpx.adobe.com/es/analytics/kb/adobe-ip-addresses.html) Esta es una lista completa de los dominios y las direcciones IP recomendados que debe permitir.<br>Si su organización bloquea las cookies de terceros, póngase en contacto con el Servicio de atención al cliente para recuperar el acceso a Adobe Analytics. |
...
| Inclusión en la lista de permitidos de tecnología de terceros | (Fecha de entrada en vigor: 12 de marzo de 2020) | Adobe Analytics ha comenzado a aprovechar las tecnologías de terceros para administrar el despliegue de funciones y la compatibilidad con el producto. Las siguientes direcciones URL deben agregarse a cualquier lista de permitidos de cortafuegos de red necesaria para garantizar el acceso completo a las funciones:<ul><li>Perspectiva: https://esp.aptrinsic.com</li><li>LaunchDarkly: https://app.launchdarkly.com</li></ul> |
| Redundancia mejorada para la disponibilidad de Analysis Workspace | 21 de mayo de 2020 | Para garantizar la disponibilidad de Analysis Workspace, agregamos una CDN (red de distribución de contenido) secundaria para mejorar la redundancia. Las siguientes direcciones URL deben agregarse a las listas de dominios permitidos necesarias del cortafuegos de la red:<ul><li>https://aaui-879784980514.s3.us-east-2.amazonaws</li><li>https://d30ln29764hddd.cloudfront.net</li><li>https://awaascicdprodva7.blob.core.windows.net</li><li>https://aauicdnva7.azureedge.net</li></ul> |
...
Consulte [Notas de la versión de AppMeasurement para JavaScript](https://experienceleague.adobe.com/content/help/en/analytics/implementation/appmeasurement-updates.html). La versión 2.20.0 se publicó 5 de marzo de 2020.
...
| [Extensión de modo oscuro para Analysis Workspace](https://experienceleague.adobe.com/content/help/en/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html) | Active la extensión oscura de Reader Chrome para oscurecer Analysis Workspace. |
...
* **Formatos de imagen no compatibles en Dynamic Media**
   ...
   Consulte [Formatos de imagen de trama no admitidos en Dynamic Media](https://experienceleague.adobe.com/content/help/en/experience-manager-65/assets/administer/assets-formats.html#unsupported-image-formats-dynamic-media).

* **Fragmentos de contenido**

   Información sobre la [compatibilidad con fragmentos de contenido en la API HTTP de AEM Assets](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html), junto con la [personalización y ampliación de fragmentos de contenido](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-customizing.html) y la [configuración de fragmentos de contenido para la representación](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-configuring-components-rendering.html).
...
* [Notas de la versión de AEM as a Cloud Service](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [Documentación de AEM as a Cloud Service](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html)
...
* [Versión de Adobe Campaign Standard 20.3](https://experienceleague.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html)
...
| Contenido | Descripción |
| -----------| ---------- |  
| [Administración de datos en cantidad en Snowflake](https://experienceleague.adobe.com/content/help/en/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html) | Sepa aprovechar el conector Snowflake en Adobe Campaign Classic. |
...
* Panel de control de Adobe Campaign: [Documentación](https://experienceleague.adobe.com/content/help/en/control-panel/using/control-panel-home.html) - [Notas de la versión](https://experienceleague.adobe.com/content/help/en/control-panel/using/release-notes.html) 
