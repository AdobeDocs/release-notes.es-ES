...
| -----------| ------------ | ---------- |
| [!UICONTROL Panel de Analytics para Destinatario] en [!UICONTROL Workspace] | 25 de junio de 2020 | El panel [!UICONTROL Analytics para Destinatario] (A4T) le permite analizar sus actividades y experiencias de Adobe Target en [!UICONTROL Analysis Workspace.] [Más información...](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/a4t-panel.html) |
