...
| Informes | (Beta for Adobe Experience Platform customers only) A new Cross Channel Report in Advertising Cloud Search provides a unified view of media spend across DSP and Search, with daily key metrics for DSP placements and Search campaigns. |
