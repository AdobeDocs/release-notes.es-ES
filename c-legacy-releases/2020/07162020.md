...
| 3 de junio de 2020 | [Gestión del envío de formularios HTML5: tutorial](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/html5-forms/handle-mobile-form-submission.html) | Artículo | Obtenga información sobre cómo acceder a los datos enviados en el controlador de envío personalizado. |
