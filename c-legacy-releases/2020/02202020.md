...
| [DIL 9.4](https://docs.adobe.com/content/help/es-ES/audience-manager/user-guide/dil-api/dil-release-notes.html) | Hemos actualizado el [!DNL Data Integration Library] ([!DNL DIL]) a la versión 9.4. Esta actualización mejora la compatibilidad con [!DNL Google Chrome] las [!DNL SameSite] cookies. |
...
Consulte las [Notas de la versión de Adobe Campaign Classic](https://docs.adobe.com/content/help/es-ES/campaign-classic/using/release-notes/latest-release.html) para saber más sobre las correcciones y mejoras.
