...
* **Navegador Microsoft® Edge basado en Chromium:**  Esta versión incluye cambios para reconocer el navegador Microsoft® Edge basado en Chromium (versión 79 y superior) para la generación de informes.
