...
| Mejora de la experiencia del usuario en cuanto a las suscripciones y las notificaciones | <ul><li>Especifique las preferencias de región y evento en una sola selección para todos los productos a los que desee suscribirse.</li><li>Reciba una notificación cuando se promocionen _problemas potenciales_ a _menores_ o _mayores_.</li><li>La página del explorador se vuelve a cargar automáticamente cuando se actualiza cualquier producto o evento.</li></ul> |
...
* **Navegador Microsoft® Edge basado en Chromium:** Esta versión incluye cambios para reconocer el explorador Microsoft® Edge basado en Chromium (versión 79 y superior) con fines de creación de informes.
...
| Fecha de fin de uso de la opción **[!UICONTROL Ver archivo]** | 30 de octubre de 2019 | Anuncio de la fecha de finalización en enero de 2020 del **[!UICONTROL Ver archivo]** en el Administrador de tableros (**[!UICONTROL Componentes > Tableros]**). |
...
* **Cloud Manager 2020.2.0**
   ...
   Cloud Manager 2020.2.0 simplifica la administración de autoservicio de los entornos limitados de Adobe Experience Manager as a Cloud Service.
...
* **Tutorials para Experience Manager as a Cloud Service**

   Comience rápidamente con la [tutoriales para Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en).
...
* Adobe Campaign Classic: [Documentación](https://experienceleague.adobe.com/docs/campaign-classic.html) - [Vídeos explicativos](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/overview.html?lang=en)
