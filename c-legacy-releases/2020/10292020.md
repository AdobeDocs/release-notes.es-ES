...
Consulte las [notas de la versión de Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html) para obtener información sobre Platform Launch.
...
| 5 de octubre de 2020 | [Uso de métricas en una tabla improvisada](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-metrics-in-a-freeform-table.html?lang=es) | Vídeo | Conozca las distintas formas en que puede utilizar las métricas en una [!UICONTROL tabla improvisada] en [!UICONTROL Analysis Workspace]. |
...
* [Documentación del producto de Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/landing/home.html?lang=es)
...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * El analizador de preparación para la nube (CRA) tiene una consola de estado de inicio que muestra un botón **[!UICONTROL Generar informe]** explícito que el usuario puede seleccionar para ejecutar el CRA.
