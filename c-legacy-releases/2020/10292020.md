...
* **AEM as a Cloud Service**
   ...
   * **Cloud Readiness Analyzer**
      ...
      * El analizador de preparación para la nube (CRA) tiene una consola de estado de inicio que muestra una **[!UICONTROL Generar informe]** para que el usuario seleccione para ejecutar el CRA.
