...
| Mejoras en la interfaz de usuario de los [!UICONTROL paneles de control de Analytics] | 23 de octubre de 2020 | Al crear un cuadro de resultados móvil en el [!UICONTROL espacio de trabajo], el estilo del cuadro de resultados ahora coincide con la aplicación. |
...
| 8 de octubre de 2020 | [Tablas de forma libre: la base del análisis](https://video.tv.adobe.com/v/346851?captions=spa) | Vídeo | Aprende lo que debes saber y lo que aprenderás cuando comiences este viaje de curso. |
...
| Publicadas | Nombre | Solución | Descripción |
| ----------- | ----------- | ---------- | ---------- |
| 14 de noviembre de 2020 | [Creación de paneles de control de Advertising Cloud con Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html?lang=es) | Vídeo | Técnicas para crear un panel de control de Advertising Cloud para supervisar campañas en directo. |
