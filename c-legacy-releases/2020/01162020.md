...
El Adobe está ajustando el `same-site` configurar cookies para prepararse para los cambios que Chrome realiza en Chrome 80 (que se lanzará en febrero de 2020).
...
La organización de recorridos ahora se conoce como GA. [Más información](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)
