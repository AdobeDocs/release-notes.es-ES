...
* Con su Adobe ID, puede suscribirse a las notificaciones de eventos en función de sus preferencias de productos, regiones y eventos. A los usuarios que configuran sus preferencias de suscripción solo se les notifican los eventos de mantenimiento e incidencias del producto relevantes cuando se abren, actualizan o cierran. Empiece por [status.adobe.com/subscriptions](https://status.adobe.com/proactive-notifications/subscriptions/edit).
...
| Envío de correo electrónico personalizado y más rápido | <ul><li>Las notificaciones de eventos se envían cuando se abren, actualizan o cierran eventos</li><li>Recibir solo las notificaciones de eventos relevantes que coincidan con las preferencias configuradas</li><li>Recibir notificaciones localizadas basadas en el idioma configurado en las preferencias de la cuenta</li></ul> |
...
Para obtener documentación del producto, consulte [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en).

### Cookies de Experience Cloud

Adobe está ajustando la configuración `same-site` de las cookies para prepararse para los cambios que Chrome haga en Chrome 80 (que se lanzará en febrero de 2020).
...
Consulte [Notas de la versión de AppMeasurement para JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
* **NUEVO: AEM as a Cloud Service**
   ...
   [Adobe Experience Manager](https://business.adobe.com/products/experience-manager/adobe-experience-manager.html) (AEM) ya está disponible as a Cloud Service.

   * [Introducción](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html?lang=en)
   * [Información de versión](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html?lang=en)
   * [Documentación](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)
...
* **Servicio automatizado de conversión de formularios**
   ...
   * [Introducción](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/introduction.html?lang=en)
   * [Configurar el servicio](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=en)
   * [Convertir formularios PDF en formularios adaptables](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=en)
...
Consulte [Previsualización de recursos 3D](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html?lang=en).

* **Componentes principales**

   La versión 2.8.0 de Componentes principales ya está disponible junto con la [documentación de creación](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html?lang=en) y los [detalles del desarrollador y la descarga del proyecto disponibles en GitHub](https://github.com/adobe/aem-core-wcm-components).

* **Arquetipo de AEM Project**

   El [módulo ui.frontend ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uifrontend.html?lang=en)del [Arquetipo de proyecto de AEM](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=en) es una herramienta útil y flexible para facilitar el desarrollo del front-end de su proyecto de AEM.
...
* Configuración de un nuevo subdominio: [Más información](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=en)
* Renovación del certificado SSL de un subdominio: [Más información](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/renewing-subdomain-certificate.html?lang=en)
...
* Panel de control de Adobe Campaign: [Documentación](https://experienceleague.adobe.com/docs/control-panel/using/control-panel-home.html?lang=en) - [Notas de la versión](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=en)
