...
| Envío de correo electrónico personalizado y más rápido | <ul><li>Event notifications are sent when events are opened, updated, or closed</li><li>Recibir solo las notificaciones de eventos relevantes que coincidan con las preferencias configuradas</li><li>Recibir notificaciones localizadas basadas en el idioma configurado en las preferencias de la cuenta</li></ul> |
