...
Para obtener documentación del producto, consulte la [ayuda de la interfaz de Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en).
...
* [Vídeotutoriales](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/understanding-journey-orchestration.html?lang=en)
...
* [Notas de la versión de Experience Platform Launch](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=en)
...
>[!IMPORTANT]
>
>La versión de mantenimiento de abril de Adobe Analytics se ha retrasado hasta el 21 de mayo de 2020. Para obtener la información más reciente sobre la versión de Analytics, consulte las notas de la versión de marzo de 2020.
...
| -----------| ---------- |
| [Adobe Labs (Previsualizaciones tecnológicas) con Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/analytics-basics/adobe-labs-technology-previews.html?lang=en) | Adobe Labs (Previsualizaciones tecnológicas) permite interactuar con tecnologías emergentes, descubrir perspectivas valiosas e influir en el desarrollo y las prioridades futuras de las funciones de [!DNL Analytics]. |
| [Publicación de audiencias de Experience Cloud mejorada](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/integrations/experience-cloud/improved-experience-cloud-audience-publishing.html?lang=en) | Se han realizado mejoras en la [!UICONTROL Publicación de audiencias de Experience Cloud]. Ahora puede publicar audiencias (segmentos) y ponerlas a disposición de los usuarios seis veces más rápido. Esto reduce el tiempo de latencia actual de 48 horas a aproximadamente 8 horas, y posiblemente más rápido, según el tráfico y el tamaño del segmento. |
| [Varios grupos de informes en Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/multiple-report-suites-in-analysis-workspace.html?lang=en) | Se pueden analizar varios grupos de informes en un solo proyecto de [!UICONTROL Workspace] seleccionando grupos de informes en el nivel de panel. Esto le permite llevar a cabo un análisis de panel en paralelo en diferentes conjuntos de datos. |

Consulte la [página de inicio de la Ayuda de Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/landing/home.html?lang=en) para obtener documentación del producto.
...
* **AEM as a Cloud Service: Configuración del servicio en la nube de Dynamic Media**
   ...
   **Publicación selectiva**: Al seleccionar esta opción, significa que los recursos se publican automáticamente solo para una previsualización segura y se pueden publicar explícitamente en AEM sin publicarlos en DMS7 para su envío en el dominio público.
   ...
   Consulte [Configuración del servicio en la nube de Dynamic Media.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/config-dm.html?lang=en)
...
* **Dynamic Media: Imágenes inteligentes**
   ...
   Consulte [Imágenes inteligentes](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/imaging-faq.html?lang=en).
...
* **Configuración de Dynamic Media: modo Scene7**
   ...
   Consulte [Creación de una configuración de Dynamic Media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/dynamic/config-dms7.html?lang=en).
...
| [Navegación](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html?lang=en) | Explore los conceptos básicos para la navegación con AEM Assets. |
| [Versiones](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/collaboration/versions.html?lang=en) | Explore cómo AEM crea y mantiene versiones de recursos. |
| [AEM:  [!DNL Magento] Integración con el [!UICONTROL marco de integración comercial]](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content-and-commerce/home.html) | Este vídeo lo acompaña durante la configuración de la integración entre AEM y [!DNL Magento]. |
| [Introducción a la pila de arquitectura de AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-architecture.html?lang=en) | El arquetipo de proyecto de CIF crea un proyecto de Adobe Experience Manager (AEM) básico como punto de partida para proyectos de clientes que utilizan componentes principales de CIF. |
| [Introducción a OSGi](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-osgi.html?lang=en) | Introducción a OSGi, una arquitectura modular dinámica para aplicaciones Java™ que es la base de Adobe Experience Manager. |
| [Introducción al repositorio de contenido Java™ (JCR)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html?lang=en) | Introducción al repositorio de contenido Java™ (JCR) utilizado por Adobe Experience Manager. |
| [Introducción a Sling](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-sling.html?lang=en) | Introducción a [!DNL Sling], un marco web de código abierto RESTful que forma parte del conjunto de tecnología subyacente de Adobe Experience Manager. |
| [Introducción al nivel de Author y Publish](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-author-publish.html?lang=en) | Introducción a los niveles [!UICONTROL Author] y [!UICONTROL Publish] como parte de la arquitectura en Adobe Experience Manager. |
| [Introducción a Dispatcher](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-dispatcher.html?lang=en) | Introducción a las funciones y características de Dispatcher como parte de la arquitectura de AEM. |
| [Introducción al desarrollo de componentes](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/components/component-development.html?lang=en) | Información general sobre el desarrollo de componentes con Adobe Experience Manager Sites. Incluye una introducción a los [!UICONTROL cuadros de diálogo], los [!UICONTROL modelos Sling], los [!UICONTROL scripts HTL] y las [!UICONTROL bibliotecas del cliente]. |
| [Arquetipo de AEM Project](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/developing/aem-project-archetype.html?lang=en) | El proyecto de AEM contiene todo el código y las configuraciones de una implementación. [!UICONTROL El arquetipo de proyecto de AEM] crea un proyecto de Adobe Experience Manager mínimo basado en las recomendaciones como punto de partida para sus propios proyectos de AEM. |
| [Explicación de los componentes principales](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/components/core-components-feature-video-understand.html?lang=en) | Los [!UICONTROL componentes principales] de AEM son un conjunto de componentes estándar que se utilizan con Adobe Experience Manager. |
...
* [Versiones anteriores de la documentación de AEM](https://docs.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
* Adobe Campaign Classic: [Documentación](https://experienceleague.adobe.com/docs/campaign-classic.html) - [Notas de la versión](https://final-docs.campaign.adobe.com/doc/AC/en/RN.html) - [Vídeos de presentación](https://experienceleague.adobe.com/docs/campaign-learn/campaign-classic-tutorials/overview.html?lang=es)
