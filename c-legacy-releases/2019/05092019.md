...
* Audience Analytics: Se ha corregido un problema que se producía después de que se cambiara un nombre de audiencia en el Audience Manager (AAM): el nombre actualizado no se reflejaba en el Audience Analytics. (AN-176237)
...
* Se ha corregido un problema que se producía cuando los usuarios iniciaban sesión en Analytics mediante el Experience Cloud y luego se agotaba el tiempo de espera de la sesión. Al reanudar la sesión, se redirigía al usuario a una dirección URL defectuosa. (AN-176812)
* Se ha corregido un problema con los desplazamientos de zona horaria en las solicitudes de Data Warehouse. (AN-177585)
...
| Cambio en el comando de Analysis Workspace Debugger | 4 de abril de 2019 | El comando Console para activar el Analysis Workspace Debugger cambia a adobeTools.debug.includeOberonXml el **13 de junio de 2019**. |
...
AEM 6.5, disponible a partir del 8 de abril de 2019, es una versión de actualización del código base de AEM 6.4. Nuestras últimas actualizaciones de AEM 6.5 le proporcionan acceso instantáneo a las emocionantes mejoras que hacen que su negocio avance aún más rápido.
...
Es posible que AEM instancias con versiones antiguas del conector S3 Datastore no estén disponibles debido a errores de acceso S3 tras el fin de la compatibilidad con la versión de firma 2 el 24 de junio de 2019. Como cliente AEM, Adobe recomienda comprobar la versión del conector del almacén de datos S3 que está utilizando. Si es necesario, actualice a una versión reciente.
...
**Editor de texto enriquecido AEM: análisis profundo**
...
Consulte [AEM Editor de texto enriquecido (RTE) Análisis Profundo](https://helpx.adobe.com/es/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
...
| Actividades de Automated Personalization (AP) y Segmentación automática | Puede seleccionar una experiencia para utilizarla como control mientras crea una actividad de PA o de segmentación automática. Esto permite dirigir todo el tráfico de control a una experiencia específica, según el porcentaje de asignación de tráfico configurado en la actividad. A continuación, puede evaluar el rendimiento de los envíos personalizados con respecto a la experiencia de control. (TGT-26572) |
