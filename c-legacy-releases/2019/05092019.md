...
* Audience Analytics: Se corrigió un problema que se producía después de que se cambiara el nombre de una audiencia en el Audience Manager (AAM); el nombre actualizado no se reflejaba en el Audience Analytics. (AN-176237)
...
AEM 6.5, disponible a partir del 8 de abril de 2019, es una versión de actualización a la base de código de AEM 6.4. Nuestras últimas actualizaciones de AEM 6.5 le proporcionan acceso instantáneo a las emocionantes mejoras que impulsan su negocio aún más rápido.
...
AEM 6.4, Service Pack 4 (6.4.4.0 publicado el 4 de abril de 2019) es una actualización importante que incluye correcciones clave de cliente realizadas tras la disponibilidad general de AEM 6.4, abril de 2018.
...
Es posible que AEM instancias con versiones anteriores del conector del almacén de datos S3 no estén disponibles debido a errores de acceso a S3 tras finalizar la compatibilidad con la versión 2 de firma el 24 de junio de 2019. Como cliente AEM, Adobe recomienda que verifique la versión del conector del almacén de datos S3 que está utilizando. Si es necesario, actualice a una versión reciente.
...
Descubra cómo sacar el máximo partido a las últimas tecnologías de AEM para modernizar la base de código de AEM Sites. [Modernización de la base de códigos de Adobe Experience Manager Sites existente](https://expleague.azureedge.net/labs/L761/index.html)
...
Consulte División profunda [AEM editor de texto enriquecido (RTE)](https://helpx.adobe.com/es/experience-manager/kt/eseminars/gems/AEM-Rich-Text-Editor-RTE-Deep-Dive1.html)
...
| actividades de Automated Personalization (AP) y Destinatario automático | Puede seleccionar una experiencia para utilizarla como control mientras crea una actividad de PA o de segmentación automática. Esto permite dirigir todo el tráfico de control a una experiencia específica, según el porcentaje de asignación de tráfico configurado en la actividad. A continuación, puede evaluar el rendimiento de los envíos personalizados con respecto a la experiencia de control. (TGT-26572) |
