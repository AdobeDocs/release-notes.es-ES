...
* Consulte [Experience Platform Launch](https://docs.adobe.com/content/help/es-ES/launch/using/overview.html) para conocer las últimas novedades.
...
| Protección, solidez y escalabilidad | Se ha añadido una serie de mejoras a Campaign Classic. Las mejoras en la protección, solidez y escalabilidad se incluyen en las [Notas de la versión de Campaign Classic](https://docs.campaign.adobe.com/doc/AC/es/RN.html). |
