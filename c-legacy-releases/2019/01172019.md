...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) : vínculos a la ayuda de la solución
...
* [Inicio](https://docs.adobelaunch.com/) : vínculos a la ayuda del producto
...
Desde la versión 8.1, DIL cumple directivas de seguridad más estrictas de Google Tag Manager. This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. Este cambio se incluirá en futuras versiones. (CORE-24189)
