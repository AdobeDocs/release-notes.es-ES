...
* [Launch](https://docs.adobelaunch.com/): Vínculos a las páginas de ayuda de la solución
...
Para acceder a esta configuración, vaya a **[!UICONTROL Proyecto]** > **[!UICONTROL Información del proyecto y configuración]**.
...
Desde la versión 8.1, DIL cumple directivas de seguridad más estrictas de Google Tag Manager. Esta versión solo está disponible desde DTM y se trata de código independiente, no de un módulo de [!DNL Launch] o AppMeasurement de Audience Manager. Este cambio se incluirá en futuras versiones. (CORE-24189)
