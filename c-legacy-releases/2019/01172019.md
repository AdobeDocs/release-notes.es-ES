...
* [Launch](https://docs.adobelaunch.com/): vínculos a la ayuda del producto
...
Desde la versión 8.1, DIL cumple directivas de seguridad más estrictas de Google Tag Manager. Esta versión solo está disponible desde DTM y se trata de código independiente, no de un módulo de Gestión de público AppMeasurement o [!DNL Launch]. Este cambio se incluirá en futuras versiones. (CORE-24189)
