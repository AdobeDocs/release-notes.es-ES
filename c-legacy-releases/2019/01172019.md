...
* Hemos realizado una actualización en la interfaz de usuario del Audience Marketplace para permitirle introducir valores decimales con coma para impresiones de Oracle Payables. (AAM-42994)
* Se ha corregido un error en el Audience Marketplace, por el cual los clientes que quisieran crear un informe propio de los volúmenes de impresión correspondientes a diciembre encontrarían que las impresiones de noviembre todavía se mostraran en los campos de los informes. (AAM-43814)
...
* Compatibilidad con campos de variables y metadatos en PDF y AEM Nombres de sitio.
...
* AEM Editor XML desordena las columnas incluidas entre líneas.
