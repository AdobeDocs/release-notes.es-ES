...
* Personalice la dimensión de cohorte (para agrupar visitantes en función de un eVar, no solo del tiempo).
...
* Compatibilidad con variables y campos de metadatos en los nombres de sitios PDF y AEM.
...
* El Editor XML de AEM desordena las columnas que se encuentran entre las capas.
