...
Desde la versión 8.1, DIL cumple directivas de seguridad más estrictas de Google Tag Manager. Esta versión solo está disponible desde la DTM y como código independiente, no [!DNL Launch] desde Módulo de gestión de público de appmeasurement. Este cambio se incluirá en futuras versiones. (CORE-24189)
