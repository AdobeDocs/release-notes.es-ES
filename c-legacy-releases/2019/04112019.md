...
* Se ha añadido compatibilidad con el complemento de Audience Manager para IAB TCF, disponible a través del objeto de inclusión ECID.
...
| Actualizaciones de Advertising Analytics | Estamos publicando un par de actualizaciones para Advertising Analytics: <ul><li>El 31 de marzo, Microsoft Bing absorbió Yahoo Gemini. Como resultado, la opción de cuenta publicitaria de Yahoo Gemini ya no está disponible. </li><li>Google ha implementado un nuevo patrón de seguimiento y, en lugar de utilizar _Plantilla de seguimiento_, ahora utilizamos _Sufijo de URL final_.</li></ul> |
