...
| DIL 9.3 | Se ha actualizado el módulo de Audience Manager a DIL 9.3 |
...
Digital Publishing Suite Classic (DPSC) caducará el 31 de agosto de 2019. Para obtener más información, consulte las preguntas más frecuentes [sobre el fin de vida útil de](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html)Digital Publishing Suite Classic.
...
[Las nuevas funciones](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html) del Panel de control incluyen la capacidad de agregar direcciones URL a las que se conecta Campaign Classic para transferencias de datos y archivos.
