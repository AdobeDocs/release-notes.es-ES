...
# Notas de la versión, agosto de 2019
...
| DIL 9.3 | Módulo de Audience Manager actualizado a DIL 9.3 |
...
Digital Publishing Suite Classic (DPSC) caducará el 31 de agosto de 2019. Para obtener más información, consulte las [Preguntas frecuentes sobre el fin de vida útil de Digital Publishing Suite Classic](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html).
...
[Versión 19.3 de Campaign Standard](https://docs.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html)
...
[Las funcionalidades del nuevo Panel de control](https://helpx.adobe.com/campaign/kb/control-panel-instance-settings.html) incluyen la posibilidad de agregar direcciones URL con las que se conecta Campaign Classic para realizar transferencias de datos/archivos.
