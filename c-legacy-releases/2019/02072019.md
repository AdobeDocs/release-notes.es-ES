...
* **Informes y análisis:** Se ha corregido un problema que impedía a los usuarios compartir informes con otros usuarios. (AN-172301)
* **Administrador:** Se ha corregido un problema con la función de edición de Administración de usuarios de administración heredada: Después de seleccionar un usuario y hacer clic en Editar, no se mostraba ningún dato sobre el usuario. (AN-170705)
* Se ha agregado lógica de reintento para errores específicos en Analysis Workspace. (AN-172801)

### Appmeasurement para JavaScript {appm}

JavaScript 2.11.0 - Lanzamiento del 11 de febrero
...
Para obtener sugerencias relativas a la solución de problemas de integración de AEM, consulte [Solución de problemas de integración](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html).
