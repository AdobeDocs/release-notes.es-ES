...
* La definición de segmento Dimensión de cohorte personalizada ahora aplica el elemento de dimensión solo como parte del periodo de inclusión, no como parte de la definición de devolución.
...
Sugerencias de solución de problemas para problemas de integración de AEM, consulte [Resolución de problemas de integración](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html).
