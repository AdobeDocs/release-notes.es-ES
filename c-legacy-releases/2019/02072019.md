...
| Función | Descripción |
| -----------| ---------- |  
| Cambios en la Análisis de cohorte | Hicimos dos pequeños cambios en la forma en que funciona Cohort Análisis, que publicó una importante actualización en enero de 2019. Estas modificaciones pueden provocar cambios en los datos devueltos.<ul><li>La definición de segmento del Dimension de cohorte personalizado ahora aplica el elemento de dimensión solo como parte del período de inclusión, no como parte de la definición de devolución.</li><li> Para el cálculo móvil, se aplicaban los criterios de inclusión a través de cada uno de los períodos de retorno subsiguientes. Ahora, los criterios de devolución se aplican a cada uno de los períodos anteriores al período seleccionado.</li></ul> |
| Función B | Texto |
| Función C | Texto |
...
* La definición de segmento del Dimension de cohorte personalizado ahora aplica el elemento de dimensión solo como parte del período de inclusión, no como parte de la definición de devolución.
...
* Se añadió alguna lógica de reintentos para errores específicos en Analysis Workspace. (AN-172801)
...
Sugerencias para la solución de problemas de integración AEM, consulte [Resolución de problemas](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html)de integración.
