...
* [[!DNL Launch, by Adobe]](https://docs.adobelaunch.com/) (vínculos a la ayuda del producto)
...
Para obtener más información sobre los SDK para móviles, consulte: [Android SDK 4.x para Experience Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/android/) and [iOS SDK 4.x para Experience Cloud Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/ios/).
...
* La [página resumen de características](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_tb_trait_summary.html) ahora muestra el tipo de característica. (AAM-25784)
* La [página de resumen de segmentos](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_summary.html) ahora contiene un hipervínculo al origen de datos del segmento para facilitar la navegación. (AAM-40015)
...
Leer el artículo sobre [monitorización de ID e inclusión en listas negras](https://marketing.adobe.com/resources/help/en_US/aam/id-monitoring-blacklisting.html) para comprender cómo el DCS supervisa los ID que recibe e incluye en lista negra a los que se envían a una tasa inusualmente alta en un corto periodo de tiempo.
