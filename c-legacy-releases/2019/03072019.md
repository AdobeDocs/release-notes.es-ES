...
Para obtener más información sobre los SDK para móviles, consulte: [Android SDK 4.x para Experience Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/android/) y [iOS SDK 4.x para Experience Cloud Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/ios/).
...
Consulte [las notas de la versión asociada](https://docs.adobe.com/content/help/es-ES/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).
...
Consulte [las notas de la versión de Livefyre](https://docs.adobe.com/content/help/es-ES/livefyre/using/release-notes/c-rn.html) para obtener la información más reciente.
