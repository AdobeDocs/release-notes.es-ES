...
* Se ha corregido un problema en el cual el nombre/apellido del usuario (migrado) de Analytics era diferente al nombre vinculado al Adobe ID del usuario en Experience Cloud. To update the Analytics name with the one in Experience Cloud, go to **[!UICONTROL Admin]** > **[!UICONTROL User Management (Legacy)]** > **[!UICONTROL Edit Users]** and click the User ID. A continuación, haga clic en **[!UICONTROL Actualizar desde Experience Cloud]**. (AN-172825)
...
Para obtener más información, consulte [Novedades de AEM Assets Brand Portal](https://helpx.adobe.com/es/experience-manager/brand-portal/using/whats-new.html) y [Notas](https://helpx.adobe.com/es/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)de la versión.
