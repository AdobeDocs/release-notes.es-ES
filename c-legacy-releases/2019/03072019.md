...
* Se ha corregido un problema en el cual el nombre/apellido del usuario (migrado) de Analytics era diferente al nombre vinculado al Adobe ID del usuario en Experience Cloud. Para actualizar el nombre de Analytics con el del Experience Cloud, vaya a **[!UICONTROL Administración]** > **[!UICONTROL Administración de usuarios (heredado)]** > **[!UICONTROL Editar usuarios]** y haga clic en el ID de usuario. A continuación, haga clic en **[!UICONTROL Actualizar desde Experience Cloud]**. (AN-172825)
