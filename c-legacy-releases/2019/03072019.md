...
* [Primetime](https://helpx.adobe.com/es/support/primetime.html) (vínculos a la ayuda de solución)
...
### SDK 2.2 de Media Analytics para: Chromecast, Roku, Apple TV y la extensión web de Launch {#aa-va}
...
* La [página resumen de características](https://experiencecloud.adobe.com/resources/help/es_ES/aam/c_tb_trait_summary.html) ahora muestra el tipo de característica. (AAM-25784)
* La[ página de resumen de segmentos](https://experiencecloud.adobe.com/resources/help/es_ES/aam/c_segment_summary.html) ahora contiene un hipervínculo al origen de datos del segmento para facilitar la navegación. (AAM-40015)
...
* Se ha corregido un error en el que la casilla **[!UICONTROL Seleccionar todo]** faltaba en Modelos algorítmicos, en [la página Seleccionar características a excluir](https://experiencecloud.adobe.com/resources/help/es_ES/aam/trait-exclusion-algo-models.html). (AAM-42462)
...
### Lanzamiento de integración para aplicaciones móviles
...
Para obtener más información, consulte [Uso de Adobe Experience Platform SDK](https://helpx.adobe.com/es/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
Para obtener más información, consulte [Acerca de la aplicación In-App messaging](https://helpx.adobe.com/es/campaign/standard/channels/using/about-in-app-messaging.html) y la aplicación [interna integrada tutorial](https://helpx.adobe.com/es/campaign/kt/acs/using/acs-in-app-message-tutorial.html).

### Mejoras en el flujo de trabajo

Se han añadido las siguientes capacidades de flujo de trabajo:

* Ahora puede copiar y pegar las actividades dentro de un flujo de trabajo o en otro flujo de trabajo de la misma instancia de Campaign. De esta forma, puede duplicar fácilmente un flujo de trabajo completo o actividades específicas y conservar la configuración definida inicialmente. Para obtener más información, consulte la [documentación detallada](https://helpx.adobe.com/es/campaign/standard/automating/using/workflow-interface.html#duplicating-workflow-activities detallada). (CAMP-20014)
* Al utilizar la actividad **Cargar archivo**, ahora se puede añadir una marca de hora al nombre del archivo que contiene los registros rechazados. Para obtener más información, consulte la [documentación detallada](https://helpx.adobe.com/es/campaign/standard/automating/using/load-file.html#configuration detallada).
...
Consulte [las notas de la versión asociada](https://docs.adobe.com/content/help/en/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).

**AEM 6.5**

[Presentación del nuevo Adobe Experience Manager: Cloud](https://theblog.adobe.com/adobe-experience-manager-2019-cloud-content-personalization-CXM/), contenido y mejoras de personalización de la Advance Customer Experience Management (CXM) para comerciantes y TI.
...
Para obtener más información, consulte [Novedades de AEM Assets Brand Portal](https://helpx.adobe.com/es/experience-manager/brand-portal/using/whats-new.html) y [notas de la versión](https://helpx.adobe.com/es/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html).
...
Consulte [las notas de la versión de Livefyre](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html) para obtener la información más reciente.
