...
Consulte [Servicio de ID de Experience Cloud](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) para ver notas de versiones acumulativas.
...
* Se ha actualizado la definición de ayuda para [la documentación de sintaxis](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) de la métrica de registro (X, B). (AN-180527)
