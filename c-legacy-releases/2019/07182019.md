...
Consulte [Servicio de Experience Cloud ID](https://marketing.adobe.com/resources/help/es_ES/mcvid/mcvid-release-notes.html) para ver notas de versiones acumulativas.
...
Para obtener más información sobre los SDK para móviles, consulte: [Android SDK 4.x para Experience Solutions](https://docs.adobe.com/content/help/en/mobile-services/android/overview.html) y [iOS SDK 4.x para Experience Cloud Solutions](https://docs.adobe.com/content/help/en/mobile-services/ios/overview.html).
...
Consulte [los boletines de seguridad y avisos](https://helpx.adobe.com/es/security.html) para obtener información importante acerca de las vulnerabilidades de seguridad que podrían afectar a versiones específicas de productos de Adobe.
...
* Se ha actualizado la definición de ayuda para el [registro (X, B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) de la documentación de sintaxis métrica. (AN-180527)
...
Hay disponible un parche importante de AEM para la invalidación de caché de clientlibs de AEM 6.5 mediante la [actualización AEM 6.5.1.0](https://helpx.adobe.com/es/experience-manager/6-5/release-notes/sp-release-notes.html) o este [artículo de KB](https://helpx.adobe.com/es/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html).
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/es/RN.html) - compilación 9029
...
* [Notas de la versión Magento Commerce 2.3.2](https://devdocs.magento.com/guides/v2.3/release-notes/ReleaseNotes2.3.2Commerce.html)
