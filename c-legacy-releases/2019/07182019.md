...
Consulte el servicio [de ID de](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) Experience Cloud para ver las notas de la versión acumulativas.
...
Un parche importante de AEM para la invalidación de la caché de clientes de AEM 6.5 está disponible mediante la actualización [de](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html) AEM 6.5.1.0 o este artículo [de](https://helpx.adobe.com/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)KB.
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) - compilación 9029
