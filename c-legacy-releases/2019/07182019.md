...
* [[!Análisis DNL]](#analytics) - **(Actualización: 15 de julio)**
...
Consulte [servicio de Experience Cloud ID](https://marketing.adobe.com/resources/help/es_ES/mcvid/mcvid-release-notes.html) para ver las notas de la versión acumuladas.
