...
Vea la [Vídeo de información general sobre la versión de febrero de 2023](https://video.tv.adobe.com/v/3416885) para obtener un resumen de las funciones añadidas en la versión 2023.02.0 (febrero de 2023). <!-- OLD. UPDATE ON JUNE 7 -->
...
* Nuevo protocolo (DASH - Dynamic Adaptive Streaming over HTTP) compatible con el flujo adaptable en la entrega de vídeo de Dynamic Media (con CMAF habilitado):<!-- OLD. UPDATE FOR JUNE 7 -->
   ...
   * Disponible en Asia-Pacífico y América del Norte; [habilitado mediante ticket de asistencia](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html?lang=es#enable-dash). Muy pronto en Europa, Oriente Medio y África.<!-- OLD. UPDATE FOR JUNE 7 -->
* Se ha añadido compatibilidad con imágenes WebP para extraer automáticamente metadatos, generar miniaturas y representaciones personalizadas. Ahora, estas funciones también son compatibles con estos archivos.<!-- OLD. UPDATE FOR JUNE 7 -->
...
* Mientras configura carpetas de proyectos vinculadas con AEM 6.4, [!DNL Experience Manager] no guarda los valores de los campos de **subcarpetas** y **Crear carpeta vinculada en proyectos con portafolios**. El valor del campo **subcarpetas** se actualiza a **indefinido**. El valor de **Crear carpeta vinculada en proyectos con portafolio** actualizaciones de campo a **Portfolio predeterminado** automáticamente después de guardar la configuración. <!-- NEW. LEAVE IN FOR JUNE 7 -->
* Cuando se utiliza la experiencia clásica de Workfront, la opción **Enviar a** disponible en la lista desplegable **Más** no permite seleccionar el destino dentro de Experience Manager. La opción **Enviar a** funciona correctamente utilizando la lista desplegable **Acciones del documento**. El **Enviar a** funciona correctamente para **Más** y la lista desplegable. **Acciones de documento** lista desplegable disponible en la nueva experiencia de Workfront.<!-- NEW. LEAVE IN FOR JUNE 7 -->
