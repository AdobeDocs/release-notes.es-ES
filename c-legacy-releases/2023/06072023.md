---
title: Notas de la versión, junio de 2023
...
* Se ha añadido compatibilidad con imágenes WebP para extraer automáticamente metadatos, generar miniaturas y representaciones personalizadas. Ahora, las funcionalidades Smart Tag y Smart Crop también son compatibles con estos archivos.<!-- OLD. UPDATE FOR JUNE 7 -->
...
Utilice los Forms adaptables sin periféricos para permitir a sus desarrolladores crear, publicar y administrar formularios interactivos a los que se puede acceder e interactuar con ellos a través de API, en lugar de hacerlo a través de una interfaz gráfica de usuario tradicional. Los formularios adaptables sin encabezado le ayudan a:<!-- OLD. UPDATE FOR JUNE 7 -->
