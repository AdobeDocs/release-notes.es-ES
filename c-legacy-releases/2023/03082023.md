...
source-git-commit: d04a529ee7142df7e003c0c9d74d4ee3741dcedc
workflow-type: tm+mt
...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Campañas] | (Campañas de audiencia de [!DNL Microsoft Advertising]; función beta abierta; versión del 18 de marzo) Las campañas de audiencia ahora pueden utilizar la estrategia de oferta de CPC mejorado (eCPC). Puede establecer ofertas dentro de la configuración del grupo de publicidad secundario.<br><br>Las campañas de audiencia con eCPC se pueden incluir en portafolios para la optimización. |
