...
| Septiembre de 2023 | AEM Forms | [Registre el valor de las variables en el flujo de trabajo de AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html) | Artículo | Registre el valor de las variables de flujo de trabajo de AEM. Esto ayuda a los desarrolladores a realizar un seguimiento y comprender cómo se está ejecutando un flujo de trabajo de AEM, diagnosticar problemas y monitorizar el flujo de datos dentro de un flujo de trabajo de AEM. |
