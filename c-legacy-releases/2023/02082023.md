...
>[!IMPORTANT]
>
>Adobe recomienda [actualizar a la última versión, 1.9.6](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html), del [!DNL Workfront]conector mejorado para Experience Manager.
