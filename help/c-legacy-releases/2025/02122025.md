...
[Experience League](https://experienceleague.adobe.com/es?lang=es#home) le ayuda a conocer las aplicaciones empresariales de Experience Cloud y Adobe. Para disfrutar de la mejor experiencia, inicie sesión y personalice su búsqueda en nuestra biblioteca gratuita de recursos.

* **Dejar comentarios:** Buscar **_¿Fue útil este contenido?_** en la parte inferior de cada artículo o vídeo. Los comentarios se seleccionan se envían a los autores de contenido.
...
La nueva [página de inicio de Experience League](https://experienceleague.adobe.com/es?lang=es) incluye recomendaciones de aprendizaje personalizadas con la tecnología de [!DNL Adobe Target].
...
[Más información...](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-cloud/discover-smarter-faster-learning-with-experience-league-s-new/td-p/739750?profile.language=es)
...
| -----------| ---------- | ---------- | ---------- |
|January 2025|[Adobe [!DNL Analytics] & CJA: Quick Start for Basic to Intermediate Analysis Capabilities](https://experienceleague.adobe.com/es/docs/events/adobe-customer-success-webinar-recordings/2024/basic-to-intermediate-analysis-capabilities)|Event |Learn about Adobe [!DNL Analytics] and [!DNL Customer Journey Analytics] with a focus on basic to intermediate analysis capabilities.|
|January 2025|[AEP Web SDK Troubleshooting, Assurance, and Tips and Tricks](https://experienceleague.adobe.com/es/docs/events/tech-sessions/2024/rtcdp-office-hours-2024/aep-web-sdk-troubleshooting)|Event |Gain insights into troubleshooting, assurance, and tips and tricks for the Adobe [!DNL Experience Platform] (AEP) Web SDK.| 
-->
...
| Publicadas | Aplicaciones | Nombre | Tipo | Descripción |
| ----------| ---------- | ---------- | ---------- |---------- |
| Febrero de 2025 | [!DNL Experience Manager] | [Tutorial para desarrolladores de Edge Delivery Services y del Editor universal &#x200B;](https://experienceleague.adobe.com/es/docs/experience-manager-learn/sites/edge-delivery-services/developing/universal-editor/0-overview) | Múltiples | Conozca los conceptos básicos de desarrollo de un nuevo sitio web creado en el Editor universal de AEM y suministrado mediante [!DNL Edge Delivery Services]. |
...
| Febrero de 2025 | [!DNL Experience Manager] | [Tutorial del canal de impresión](https://experienceleague.adobe.com/es/docs/experience-manager-learn/forms/ic-print-channel-tutorial/introduction) | Múltiples | Cree su primera comunicación interactiva para el canal de impresión. Comunicaciones interactivas es nuevo en AEM Forms 6.4. |
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/es/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|New video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/es/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|New video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/es/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|New video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| 
-->
