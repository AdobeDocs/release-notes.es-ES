...
Última versión: **jueves, 28 de septiembre de 2022**
...
_Nuevas funciones disponibles en [!DNL Sites] el canal de versión preliminar_
...
* [Actualizaciones de la versión de Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html?lang=es)
...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Portafolios], [!UICONTROL Campañas] | (Funcionalidad beta de inclusión) Una nueva opción “[!UICONTROL Restricciones del gasto en red]” permite definir límites en las asignaciones presupuestarias para redes de anuncios específicas en portafolios de varias redes. La opción está disponible para portafolios con estrategias de gasto diarias, semanales y mensuales, y solo cuando la opción “[!UICONTROL Habilitar el % de objetivo de gasto máximo de campaña]” no está activada. Cuando se selecciona la opción &quot;[!UICONTROL Ajustar automáticamente los límites presupuestarios de la campaña]&quot;, las restricciones funcionan dentro de los valores configurados para la configuración de presupuesto de campaña múltiple y mínima.<br><br>Un nuevo informe de restricciones de red en los informes básicos muestra todos los presupuestos de motores de búsqueda mínimos y máximos especificados, así como el gasto real (costo) de sus portafolios.<br><br>Para participar en el programa beta, póngase en contacto con el equipo de la cuenta. |
