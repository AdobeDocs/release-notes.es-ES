...
| -----------| ---------- | ---------- | ---------- |
| Septiembre de 2022 | [Crear una visualización de flujo](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analyzing-customer-journeys/flow-visualization.html) | Vídeo | Aprenda a utilizar las visualizaciones de flujo para explorar los recorridos exactos que los clientes tienen con su marca. |
...
_Nueva función disponible en el canal de versión preliminar_
...
| Septiembre de 2022 | [Intercambio de aptitudes: experto en marketing/editor web](https://experienceleague.adobe.com/docs/skill-exchange-events/events/aem/aug2022/marketer/reusability.html) | Vídeo | Aprenda a utilizar fragmentos de experiencia para impulsar la reutilización y la eficacia en todo el ecosistema. Esto afecta al retorno de la inversión y a la velocidad de transmisión. | AEM CS |
...
| Septiembre de 2022 | [Creación de una campaña](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-campaigns/create-a-campaign.html) | Vídeo | Obtenga información sobre cómo enviar contenido de una sola vez a un público específico ejecutando acciones inmediatamente o según una programación especificada. |
...
Utilice Experience Platform para orquestar el recorrido de un cliente a escala a través de canales de experiencia, anticipando de forma inteligente las necesidades de cada persona en tiempo real.
...
|  | ([!DNL Google Ads] cuentas) La vista Campañas > Anuncios ahora incluye una columna [!UICONTROL Intensidad de anuncios] opcional, que indica cómo sigue cada anuncio de búsqueda adaptable (RSA) las prácticas recomendadas de [!DNL Google Ads] para el rendimiento.<br><br>[!DNL Microsoft® Advertising] aún no habilita una compatibilidad similar a través de su API. |
...
| [!UICONTROL Información sobre los anuncios] | La vista de [!UICONTROL Información sobre los anuncios] tiene un nuevo aspecto y flujo de trabajo, basados en una nueva infraestructura que mejora el rendimiento y la fiabilidad. Ahora solo tienes que hacer clic en un nombre de insight, seleccionar o ingresar la configuración y luego hacer clic en [!UICONTROL Generar Insight].<br><br>Para volver temporalmente a la vista heredada, habilita [!UICONTROL Cambiar a la IU antigua] en la esquina superior derecha. La vista heredada se eliminará a finales de septiembre. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Septiembre de 2022 | [Adaptación de la ansiedad de las fuentes con Adobe Fonts](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/assets/TamingTypeAnxiety.pdf) | PDF | Aprenda cómo funciona Adobe Fonts en este tutorial práctico. |
