...
| Marzo de 2022 | [Configuración e instalación de un bot de chat](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/dynamic-chat/setup.html?lang=es) | Vídeo | Una guía para ayudarle a instalar un bot de chat de JavaScript en su sitio web o página de destino, así como personalizar su aspecto para que coincida con su marca. |
