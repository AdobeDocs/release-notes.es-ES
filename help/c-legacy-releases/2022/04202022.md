...
* **Experience Manager as a Cloud Service**
  ...
  Vea el [vídeo de información general sobre la versión de marzo de 2022](https://video.tv.adobe.com/v/3454199?captions=spa) para obtener un resumen de las funciones agregadas en la versión 2022.3.0 (marzo de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
| Abril de 2022 | [Pista de auditoría](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/monitoring/audit-trail.html?lang=es) | Vídeo | Obtenga información sobre cómo acceder a los registros de pista de auditoría y qué configuración se puede ajustar. | Versión 8 de Campaign |
