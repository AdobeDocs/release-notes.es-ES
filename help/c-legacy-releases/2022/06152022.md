...
* **Experience Manager as a Cloud Service**
  ...
  Vea el [vídeo de información general sobre la versión de mayo de 2022](https://video.tv.adobe.com/v/3453436/?captions=spa&quality=12) para obtener un resumen de las funciones añadidas en la versión 2022.5.0 (mayo de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* Nueva [Versión del Panel de control de mayo](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=es#may-2022)
