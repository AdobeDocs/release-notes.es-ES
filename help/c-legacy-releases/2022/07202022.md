...
* Vea el [vídeo de información general sobre la versión de mayo de 2022](https://video.tv.adobe.com/v/3453436/?captions=spa&quality=12) para obtener un resumen de las funciones añadidas en la versión 2022.5.0 (mayo de 2022).
* [Vídeo de información general sobre la versión de abril de 2022](https://video.tv.adobe.com/v/3452779?captions=spa&quality=12)
* [Vídeo de información general sobre la versión de marzo de 2022](https://video.tv.adobe.com/v/3454199?captions=spa)
...
| Julio de 2022 | [Ignorar propiedades del modelo de datos de formulario](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/adaptive-forms/override-fdm-values.html?lang=es) | Vídeo | Obtenga información sobre cómo ignorar propiedades de los modelos de datos de formulario, de modo que sea más sencillo probarlos con diferentes extremos. | AEM [!DNL Forms] |
