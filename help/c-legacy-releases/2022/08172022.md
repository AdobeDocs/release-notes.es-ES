...
Vea el [vídeo de información general sobre la versión de julio de 2022](https://video.tv.adobe.com/v/3454199/?captions=spa&quality=12) para obtener un resumen de las funciones añadidas en la versión 2022.7.0 (julio de 2022). <!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* `mod_macro` ya está disponible en Experience Manager as a Cloud Service. [Consulte esta tabla &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=es) para obtener una lista de los módulos Apache compatibles.
