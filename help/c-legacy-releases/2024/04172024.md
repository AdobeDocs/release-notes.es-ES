...
|Published|Name|Type|Description|
|---------|----|----|-----------|
|February 2024|[Project link (URL) generated changes when you share an Adobe Analytics workspace](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21698.html?lang=es)|New article| This article offers a solution to the Adobe Analytics issue where a project link changes each time a workspace project link is retrieved in a shared Adobe Analytics workspace. You can use either the newly generated link or the previously generated link for access to the target project.|
...
Watch the [November 2023 Release Overview video](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/2023/2023-11-0.html?lang=es) for a summary of the features added in the 2023.11.0 (November 2023) release. 
-->
...
* [Información de la versión de Experience Manager as a Cloud Service](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/release-notes/home)
* [Actualizaciones de la versión de Experience Manager as a Cloud Service](https://experienceleague.adobe.com/es/docs/events/aemcs-release-update-recordings/overview)
...
* [Notas de la versión de la aplicación de escritorio Experience Manager](https://experienceleague.adobe.com/es/docs/experience-manager-desktop-app/using/release-notes)
...
* [Inicio de Ayuda de Dynamic Media Classic](https://experienceleague.adobe.com/es/docs/dynamic-media-classic/using/home)
...
* [Página de inicio de Learn &amp; Support de Experience Manager 6.5](https://experienceleague.adobe.com/es/docs/experience-manager-65/content/implementing/deploying/introduction/platform)
* [Página de inicio de Learn &amp; Support de Experience Manager 6.4](https://experienceleague.adobe.com/es/docs/experience-manager-64)
...
|Abril de 2024|[[!DNL Workfront] eventos recientes](https://experienceleague.adobe.com/es/docs/events/workfront-recordings/overview)|Varios vídeos |Ver todos los eventos recientes de [!DNL Workfront] en Experience League.|
|Abril de 2024|[Todos los eventos próximos](https://experienceleague.adobe.com/events?lang=es)|Varios vídeos |Ver todos los eventos próximos en Experience League (todas las aplicaciones).|
