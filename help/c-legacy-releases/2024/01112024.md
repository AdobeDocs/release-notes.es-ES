...
| ----------| ---------- | ---------- | ---------- |---------- |
| Diciembre de 2023 | SDK móvil | [Tutorial de implementación de Adobe Experience Cloud en aplicaciones móviles](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/overview) | Tutorial actualizado (varios artículos) | Obtenga información sobre cómo implementar las aplicaciones de Adobe [!DNL Experience Cloud] en su aplicación móvil mediante Adobe [!DNL Experience Platform Mobile SDK]. |
| Diciembre de 2023 | Platform, Journey Optimizer | [Crear y enviar notificaciones push](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push) | Artículo | Obtenga información sobre cómo crear notificaciones push para aplicaciones móviles con [!DNL Experience Platform Mobile SDK] y [!DNL Journey Optimizer]. |
| Diciembre de 2023 | SDK móvil, Journey Optimizer | [Crear y enviar mensajes in-app](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp) | Artículo | Obtenga información sobre cómo crear mensajes in-app para aplicaciones móviles con [!DNL Experience Platform Mobile SDK] y [!DNL Journey Optimizer]. |
| Diciembre de 2023 | Platform, Journey Optimizer | [Crear y visualizar ofertas con Gestión de decisiones](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers) | Artículo | Obtenga información sobre cómo mostrar ofertas de [!DNL Journey Optimizer] [!UICONTROL Gestión de decisiones] en sus aplicaciones móviles con [!DNL Experience Platform Mobile SDK]. |
| Diciembre de 2023 | Administración | [Añadir administradores de productos](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-product-administrators) | Vídeo | Obtenga información sobre cómo añadir nuevos administradores para Adobe [!DNL Experience Platform] en [!DNL Admin Console]. Los administradores pueden añadir y administrar administradores, usuarios, desarrolladores y credenciales de API adicionales. |
...
| Diciembre de 2023 | Administración | [Añadir usuarios y administrar permisos](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-users) | Vídeo actualizado | Obtenga información sobre cómo añadir usuarios y administrar permisos en aplicaciones basadas en Adobe Experience Platform como [!DNL Real-Time Customer Data Platform] y [!DNL Journey Optimizer]. |
| Diciembre de 2023 | Recopilación de datos | [Crear una secuencia de datos](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream) | Vídeo | Aprenda a crear una secuencia de datos en Experience Platform. |
| Diciembre de 2023 | Recopilación de datos | [Configurar una propiedad de etiqueta](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags) | Vídeo | Obtenga información sobre cómo configurar una propiedad de etiqueta en la interfaz de [!UICONTROL Recopilación de datos]. |
...
| Diciembre de 2023 | Perfiles | [Cree un atributo calculado para la suma de las compras](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases) | Vídeo | Aprenda a utilizar atributos calculados para sumar las cantidades de compra realizadas por un usuario en varios canales de ventas. |
| Diciembre de 2023 | Recopilación de datos | [Creación de una propiedad de etiquetas](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/tags/create-a-property) | Vídeo actualizado | Aprenda a crear propiedades de etiquetas para administrar las etiquetas de marketing de su sitio web. |
...
|---------|----|----|-----------|
| Diciembre de 2023 | [[!DNL AEP] - [!DNL TARGET] públicos: cambios de fecha modificados para todas los públicos  [!DNL Target]  después de una sola activación en [!DNL AEP]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23223) | Nuevo artículo | Aprenda por qué puede estar viendo que la fecha de modificación después de activar un solo segmento hacia su destino de [!DNL Target] en [!DNL Adobe Experience Platform] ha cambiado para todos los segmentos activados en ese destino (en [!DNL Target UI]). |
| Diciembre de 2023 | [[!DNL AEP] - Las actualizaciones de perfil de streaming fallan cuando el esquema de origen no cumple con [!DNL XDM]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23026) | Nuevo artículo | Obtenga información sobre cuándo transmitir un perfil &quot;[!DNL upsert],&quot; el flujo de datos falla si el esquema de origen no cumple con [!DNL XDM]. |
| Diciembre de 2023 | [[!DNL AEP] - El público a la que se puede dirigir en la sección de uso de licencias no coincide con el recuento de perfiles de la página principal](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23025) | Nuevo artículo | Obtenga información sobre cuándo el público accesible en la sección de uso de licencias no coincide con el recuento de perfiles de la página principal. |
...
| Publicadas | Nombre | Tipo | Descripción |
| ----------| ---------- | ---------- |---------- |
| Diciembre de 2023 | [Importación de datos de muestra en Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/import-sample-data) | Artículo actualizado | Aprenda a configurar un entorno de zona protegida de Experience Platform con datos de muestra. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Enero de 2024 | [Compartir un proyecto de solo lectura en [!UICONTROL Analysis Workspace]](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace) | Vídeo | Obtenga información sobre cómo compartir proyectos de [!UICONTROL Workspace] de solo lectura con los usuarios, y comprenda las funciones disponibles para este nivel de permisos. |
| Diciembre de 2023 | [Una lista de comprobación útil para auditar el diccionario de datos](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary) | Artículo | Mejore la eficacia y fiabilidad de los datos con nuestra lista de comprobación de auditoría del diccionario de datos de Adobe [!DNL Analytics] y [!DNL Customer Journey Analytics] . |
...
| Diciembre de 2023 | [Configuración básica de la extensión de Analytics en Etiquetas de Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/basic-configuration-of-the-analytics-launch-extension.html) | Vídeo | Observe cómo configurar la extensión de [!DNL Analytics] en Etiquetas de [!DNL Experience Platform] para un sitio básico. |
...
| Diciembre de 2023 | [Configuración de variables globales para la extensión de Analytics en Etiquetas de Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-global-variables-in-the-tags-analytics-extension.html) | Vídeo | Obtenga información sobre cómo configurar las variables globales en la extensión de etiquetas de Analytics para un sitio web básico. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Diciembre de 2023 | [ID de compra duplicados que hacen que no se genere un informe en [!DNL Adobe Analytics]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23145) | Nuevo artículo | Descubra cómo afectan a [!DNL Adobe Analytics] los ID de compra duplicados, impidiendo la creación de informes de pedidos. Descubra cómo la implementación adecuada puede resolver este problema de seguimiento. |
| Diciembre de 2023 | [¿Cómo ordenar manualmente el orden de [!UICONTROL Dimensión de intervalo de fechas] en el informe de  [!DNL Workspace] ?](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-21923) | Nuevo artículo | Obtenga información sobre cómo resolver el problema si el icono de ordenación [!UICONTROL Intervalo de fecha] no ayuda a ordenar el orden de [!UICONTROL Dimensiones] en [!DNL Adobe Analytics]. |
...
Los clientes existentes pueden seguir utilizando su implementación de [!DNL DIL]. Sin embargo, Adobe no desarrollará [!DNL DIL] más allá de este punto. Se recomienda a los clientes que evalúen el [SDK web de Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=en) para su estrategia de recopilación de datos a largo plazo. Los clientes que deseen implementar nuevas integraciones de recopilación de datos a partir de julio de 2023 deberán utilizar la [Experience Platform de la web de SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=en) en su lugar.

Para obtener recursos de ayuda, consulte [Documentación y tutoriales de Audience Manager](https://experienceleague.adobe.com/en/docs/audience-manager) en Experience League.
...
Además de los lanzamientos recientes [Reglas de filtro de tráfico](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/security/traffic-filter-rules-including-waf), que incluye las reglas de cortafuegos de aplicaciones web (WAF) con licencia opcional, existe la oportunidad de utilizar la [!UICONTROL Canalización de configuración] para declarar e implementar otros tipos de configuración de CDN. Adobe desea conocer sus casos de uso, incluidos los siguientes:
...
* [Permisos personalizados de Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions) le permite crear nuevos perfiles de permisos personalizados con permisos configurables para restringir el acceso a programas, canalizaciones y entornos para los usuarios de [!DNL Cloud Manager].
...
* Los contenedores de compilación ahora admiten la versión 18 de Node.js para [canalizaciones de front-end](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/developing-with-front-end-pipelines).
* Para los programas de Cloud Manager recién creados, [la subcuenta de New Relic asociada](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/user-access-new-relic) no está activada de forma predeterminada.
...
* Los despliegues de actualizaciones en el [entorno de compilación](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) que se [anunciaron e iniciaron con la versión de octubre de 2023 de Cloud Manager](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0) se han completado.
   * Se ha añadido compatibilidad con el nodo 18 para [canalizaciones front-end y full-stack](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines).
   ...
   * Maven se ha actualizado a la versión 3.8.8.
      ...
      * [Adobe recomienda](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details) a los usuarios actualizar sus repositorios Maven para usar HTTPS en lugar de HTTP.
