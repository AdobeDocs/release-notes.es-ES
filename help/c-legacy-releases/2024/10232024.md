...
**Dejar comentarios:** Buscar **_¿Fue útil este contenido?_** en la parte inferior de cada página. Los comentarios se seleccionan se envían a los autores de contenido.
...
* **[!UICONTROL Expandir todas las secciones]**: muestra toda la tabla de contenido de cualquier guía de Experience League. (Esta opción se desactiva después de cargar una página. Este problema se solucionará en una actualización futura). Se han eliminado las opciones **[!UICONTROL Ver más]** y **[!UICONTROL Ver menos]**.
...
| -----------| -----------| ---------- |
| Octubre de 2 | Inicio personalizable | En la página de aterrizaje de Experience Cloud, haga clic en **[!UICONTROL Editar]**. [!UICONTROL El modo Editar] le permite personalizar su página principal de Experience Cloud con acceso a una biblioteca de widgets y fondos personalizados. [!UICONTROL El modo Edit] proporciona controles intuitivos y sin problemas para mover, cambiar el tamaño y administrar widgets. Esta función incluye acciones de forma masiva y ajustes de diseño, lo que ofrece una experiencia más estética y personalizada. Personalice la página de inicio de Experience Cloud con acceso a una biblioteca de widgets y fondos personalizados. |
...
* Consulte [[!DNL Journey Optimizer B2B Edition]](https://business.adobe.com/es/products/journey-optimizer-b2b-edition.html?lang=es) para obtener información del producto.
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/es/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|Video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/es/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|Video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/es/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|Video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| 
-->
