...
* **Otros cambios de base**: durante la semana del 7 de agosto de 2023, AEM devolverá el código de error 429 en lugar del código de error 503 cuando las solicitudes a instancias de AEM superen un nivel correcto. [Más información](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html?lang=es).
...
* GEM de AEM, 28 de junio de 2023. La grabación está disponible para &quot;Domine el arte de la certificación de Experience Manager: ¡Prepárese, prepare, obtenga la certificación!&quot;: [https://adobe.ly/3p2CmbA](https://adobe.ly/3p2CmbA)
...
| Agosto de 2023 | [!DNL AEM Sites] | [[!DNL AEM Sites] Horario de oficina del Campeón](https://experienceleague.adobe.com/docs/events/aem-champion-office-hours/2023/march.html?lang=es) | Vídeo | Obtenga información sobre las prácticas recomendadas de [!DNL AEM Sites] de los campeones de AEM. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Julio de 2023 | [Problema de revisión al cargar revisiones, barra azul se desplaza indefinidamente](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22364.html?lang=es) | Nuevo artículo | Obtenga información sobre cómo resolver el error que se produce al cargar una nueva prueba. |
