---
title: 'Notas de la versión central: febrero de 2023'
...
* Las notificaciones de estado ya están disponibles en [!DNL Slack]. Con una configuración única, puede agregar la [!DNL Adobe Status Slack] aplicación a su [!DNL Slack] espacio de trabajo y recibir notificaciones de estado en su [!DNL Slack] canal. Utilice este vínculo para administrar sus preferencias de suscripción: [https://status.adobe.com/es-es/proactive-notifications/manage](https://status.adobe.com/es/proactive-notifications/manage).
...
<!-- For the latest release information, see Adobe System Status [release notes](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=es#status). -->
...
| -----------| ---------- | ---------- | ---------- |
|January 2023|[Schedule Customer Journey Analytics workbooks using Report Builder](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/exporting/report-builder/schedule-cja-workbooks-using-report-builder.html?lang=es)|Video |Learn how to schedule workbooks in Report Builder for Customer Journey Analytics. Scheduling workbooks lets users automate the process of refreshing Report Builder workbooks with the latest data and sending it to stakeholders on a regular, pre-defined schedule.|
|January 2023|[Leverage date field support](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/leverage-date-field-support.html?lang=es)|Video |You can use date and date-time fields within Customer Journey Analytics. Select how the date or date-time field is displayed, and use date-specific logical operators in the include/exclude functionality to filter what is displayed.|
|January 2023|[First-time and returning sessions](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/first-time-and-returning-sessions.html?lang=es)|Video |Learn how to distinguish between first-time and returning sessions for your users. This is accomplished through a 13-month look-back applied to your report.|
|January 2023|[Use the experimentation panel](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/use-the-experimentation-panel.html?lang=es)|Video |Learn how to configure and use the experimentation panel, which automatically builds some visualizations based on your experiment data.|
...
Última versión: **viernes, 22 de septiembre de 2022**
...
* **Próximo seminario web de Experience Manager GEM:** _Aceleración del desarrollo de Experience Manager as a Cloud Service con entornos de desarrollo rápido_. [Regístrese aquí](https://bit.ly/3x1Cl8x).
...
* **Objetivos de la comunidad Adobe Experience Manager:** resalta las últimas actualizaciones de la comunidad Experience Manager, todo en un solo lugar. [Lea la cuarta edición ahora](https://bit.ly/3CAxuy2).
