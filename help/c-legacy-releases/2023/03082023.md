...
¡Atención a quienes quieran obtener la certificación de Adobe! Adobe se complace en anunciar el lanzamiento del nuevo sitio de [Certificación](https://experienceleague.adobe.com/docs/certification/certification/overview.html?lang=es) Experience Cloud en Experience League.
...
Fecha de la versión: **jueves, 08 de marzo de 2023**
...
_Nueva funcionalidad disponible en el canal de versión preliminar_
...
* [Actualizaciones de la versión de Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html?lang=es)
...
Obtenga acceso a las notas de versión preliminar, las notas de la versión actual y los nuevos tutoriales de Adobe Target.
