...
* Con su Adobe ID, puede suscribirse a las notificaciones de eventos en función de sus preferencias de productos, regiones y eventos. A los usuarios que configuran sus preferencias de suscripción solo se les notifican los eventos de mantenimiento e incidencias del producto relevantes en cuanto sus preferencias se abran, actualicen o cierren. Empiece por [status.adobe.com/subscriptions](https://status.adobe.com/es-es/proactive-notifications/subscriptions/edit).
