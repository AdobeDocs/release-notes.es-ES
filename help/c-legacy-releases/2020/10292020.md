...
| 21 de noviembre de 2025 | [Sistema de informes con canales de marketing de Advertising Cloud](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-reporting-a4adc.html#analytics) | Vídeo | Cómo funcionan los datos de entrada de clics y vistas de Advertising Cloud con los canales de marketing de Adobe Analytics. |
