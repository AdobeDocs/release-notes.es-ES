---
title: 'Notas de la versión central: julio de 2021'
...
| Julio de 2021 | [Introducción al Servicio de consultas para ingenieros de datos](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.qsvc.gsde&lang=es) | Curso | Aprenda a validar los datos ingeridos, obtener perspectivas de los datos almacenados en el lago de datos y cómo preparar los datos para tomar decisiones críticas para el negocio mediante el Servicio de consultas. |
| Julio de 2021 | [Creación de tableros mediante el Servicio de consultas](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.qsvc.dash&lang=es) | Curso | Aprenda a validar los datos ingeridos, obtener perspectivas de los datos almacenados en el lago de datos y crear paneles de control mediante el Servicio de consultas en Adobe Experience Platform. |
...
| Julio de 2021 | [Introducción a Gobernanza de datos de la plataforma Adobe Experience](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.dgov.gs&lang=es) | Curso | Aprenda a tomar el control de los datos desde el punto en el que se recopilan en las fuentes de datos hasta el momento en el que se asocian a destinos fuera de Adobe Experience Platform. |
...
Consulte las [notas de la versión de Offer Decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=es) para mantenerse al día.

**Más recursos para Offer Decisioning**

[Documentación](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html?lang=es) - [Notas de la versión](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=es) - [Vídeos de presentación](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/introduction-to-decision-management.html?lang=es)
...
* [Nuevas funciones de Customer Journey Analytics](#cust-journey) (actualizado el miércoles, 10 de agosto de 2021)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
     ...
     Visite [Experience Manager Guides](https://business.adobe.com/es/products/experience-manager/guides/aem-guides.html) para obtener más información.
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * La herramienta [Ingestor masivo de datos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html?lang=es) permite añadir metadatos durante una ingesta masiva.
...
* [Notas de la versión de Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=es)
...
* [Notas de la versión 8 de Campaign](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html?lang=es)
