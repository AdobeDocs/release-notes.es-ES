...
# Acceso anticipado - Notas de la versión de Adobe Experience Cloud - Noviembre de 2019

> [!IMPORTANT] Esta página incluye contenido previo al lanzamiento de la nueva versión y está sujeta a cambios antes de su publicación planificada.
...
**Fecha de la versión: 30 de octubre de 2019**
...
* La página Fuente se desaprobó en diciembre de 2019. Busque un aviso de desaprobación del producto. (MCUI-10039)
* Se ha actualizado el vínculo [Más](https://www.adobe.com/marketing/campaign.html) información para Adobe Campaign desde el selector de aplicaciones. (MCUI-10034)
* Se ha mejorado la estabilidad y la capacidad de respuesta de la plataforma principal para la interfaz de Experience Cloud. (MCUI-6822)
* Se han corregido las vulnerabilidades de seguridad en la interfaz de usuario de Experience Cloud. (MCUI-9942)
* Se corrigió un problema crítico en Atributos del cliente que bloqueaba la validación de esquema para algunos clientes. (MCUI-10024, MCUI-6479)
...
| Función | Descripción |
| -----------| ---------- | 
| Análisis de viajes del cliente | El 21 de noviembre de 2019, Adobe hará que [Customer Journey Analytics](https://www.adobe.com/analytics/customer-journey-analytics.html) esté disponible como complemento para Adobe Analytics.<br><br/>Customer Journey Analytics le permite traer todos los datos de clientes desde cualquier canal: tanto en línea como fuera de línea — en la plataforma de Adobe Experience y, a continuación, analice estos datos del mismo modo que lo haría con los datos digitales actuales mediante Analysis Workspace. El análisis de viaje del cliente incluye la capacidad de controlar cómo conecta los datos en línea y sin conexión en Analysis Workspace en cualquier ID de cliente común, permitiéndole finalmente realizar atribuciones, segmentación, flujo, visitas en el orden previsto, etc. en todo el conjunto de datos de clientes en Adobe Analytics.<br><br/>Los clientes de Analytics Select, Prime y Ultimate pueden adquirir este producto adicional. Póngase en contacto con el equipo de su cuenta de Adobe para obtener más información. |
...
| -----------| ---------- | ---------- |
| Opción Archivo **[!UICONTROL EOL de]** vista | 30 de octubre de 2019 | Anuncio de la fecha de finalización de enero de 2020 para la opción **[!UICONTROL Ver archivo]** en el Administrador de tableros (**[!UICONTROL Componentes &gt; Tableros]**). |
| Opción EOL de **[!UICONTROL Aplicar restricciones]** de inicio de sesión IP | 30 de octubre de 2019 | Anunciando la fecha de finalización de enero de 2020 para la lista blanca de inicio de sesión IP (**[!UICONTROL Aplicar restricciones]** de inicio de sesión IP) en el menú **[!UICONTROL Administración &gt; Configuración de la empresa &gt; Seguridad]** . |
...
| Función | Descripción |
|--- |----|
| [Mejoras en las reglas de combinación de perfiles](https://docs.adobe.com/help/en/audience-manager/user-guide/features/profile-merge-rules/merge-rules-overview.html) | Hemos lanzado una serie de mejoras para las reglas [!UICONTROL de combinación de]perfiles: <ul><li>La evaluación de segmentos ahora se admite en lote, para hasta 100 dispositivos.</li><li>Hemos mejorado la precisión de los informes para las poblaciones de rasgos y segmentos.</li><li>Hemos mejorado la precisión de los archivos por lotes generados mediante ID entre dispositivos.</li><li>Hemos actualizado la documentación con casos de uso más detallados para cada regla. Consulte Casos de uso [general de reglas](https://docs.adobe.com/help/en/audience-manager/user-guide/features/profile-merge-rules/merge-rule-targeting-options.html)de combinación de perfiles, casos [de uso de gráficos de dispositivos](https://docs.adobe.com/help/en/audience-manager/user-guide/features/profile-merge-rules/external-graph-use-cases.html)externos y casos [de uso de gráficos de dispositivos de vínculos de](https://docs.adobe.com/help/en/audience-manager/user-guide/features/profile-merge-rules/profile-link-use-case.html)perfiles.</li></ul> |
| [Herramientas de administración masiva](https://docs.adobe.com/content/help/en/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html) | Hemos lanzado una nueva versión de la hoja de cálculo de Administración masiva que funciona en los sistemas operativos MacOS y Microsoft Windows y que admite el inicio de sesión en Experience Cloud. |
| [HTTP Strict-Transport-Security](https://docs.adobe.com/help/en/audience-manager/user-guide/overview/data-security-and-privacy/data-security.html#hsts) | Agregamos soporte para [!DNL HTTP Strict-Transport-Security], una política de seguridad web que protege contra el secuestro de cookies y ataques de protocolo de baja calidad. |
...
* Hemos corregido un error en Señales derivadas, en el que durante un corto tiempo los clientes no podían crear nuevas señales derivadas. (AAM-50968)
...
* Se corrigió un error en el cual algunos usuarios tenían cuentas duplicadas para iniciar sesión en la interfaz de usuario de Audience Manager. Debido a los permisos asociados a las cuentas duplicadas, estos usuarios no pudieron acceder a algunas partes de la interfaz de usuario y realizar operaciones. (AAM-50818)
* Seguimos mejorando la accesibilidad de la interfaz de usuario de Audience Manager. (AAM-48932, AAM-49043, AAM-49054, AAM-49371, AAM-49375)
...
* **Servicio de conversión automatizada de AEM Forms**
   ...
   El servicio Conversión automatizada de formularios ayuda a acelerar la digitalización y modernización de las experiencias de captura de datos mediante la conversión automatizada de formularios PDF a formularios adaptables. El servicio, con la tecnología Adobe Sensei, convierte automáticamente los formularios PDF en formularios adaptables basados en HTML5, adaptables y fáciles de usar en el dispositivo. A la vez que aprovecha las inversiones existentes en formularios PDF y XFA, el servicio también aplica validaciones, estilo y presentación adecuados a los campos de formulario adaptables durante la conversión.

   Consulte [Servicio](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/introduction.html)de conversión automatizada de formularios de Adobe Experience Manager.
...
* **Activity Map**
   ...
   Ahora debe utilizar el complemento [del explorador de Mapa de](https://docs.adobe.com/content/help/en/analytics/analyze/activity-map/getting-started/get-started-users/activitymap-install.html) actividades para Chrome, Firefox o Internet Explorer, como proporciona Adobe Analytics.

* **Guía de prácticas recomendadas para proyectos de AEM Screens**

   La nueva Guía de _optimizaciones para pantallas_ AEM ofrece una completa perspectiva y consejos prácticos para imaginar, diseñar y aportar experiencias de cliente intencionales a su implementación de publicidad dinámica. También le guía en cómo crear un impacto positivo en su empresa mediante las prácticas recomendadas, todo mientras implementa un proyecto de publicidad dinámica en AEM Screens.

   Consulte la Guía de [prácticas recomendadas para proyectos](https://docs.adobe.com/content/help/en/experience-manager-screens/using/about-guide.html)de AEM Screens.

* **Administración de experiencias sin objetivos**

   Las funciones del procesador [de contenido](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/spa-ssr.html#main-pars_header_450130848) remoto que se utilizan en el servidor para la representación de aplicaciones de una sola página ya están documentadas.

* **SPA y procesamiento en el servidor**

   Puede ampliar y personalizar el servicio de representación de contenido remoto que los SPAs dirigidos por AEM utilizan para el procesamiento en el servidor para satisfacer sus necesidades.

   Consulte [SPA y Representación](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/spa-ssr.html#RemoteContentRenderer)del lado del servidor.
...
* **Tipo de archivo del proyecto AEM**
   ...
   Consulte [AEM Project Archetype](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/overview.html).
...
* **Actualizaciones de la documentación de AEM**
   ...
   Consulte la documentación de [AEM: Actualizaciones](https://helpx.adobe.com/experience-manager/documentation-updates.html)de documentación recientes.
