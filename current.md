...
* **Adobe Workfront** | _Planificación de Workfront: Smart Start_ | Conozca las prácticas recomendadas de configuración base del equipo de administración de productos de Workfront. | 31 de julio de 2025 - 10:00 AM MT | [Registrarse](https://events.teams.microsoft.com/event/adbabe72-e591-464e-87f8-1f1947d49f38@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Adobe Marketo Engage (multisolución)** | _Marketo y Mochas: Salesforce Sync_ | Sugerencias y estrategia para sincronizar y optimizar Salesforce + Marketo. | 31 de julio de 2025 - 10:00 AM MT | [Registrarse](https://adobeevents.adobeconnect.com/eeb0ucvtg1l0/event/registration.html?campaign-id=ExL)

* **Adobe Workfront** | _Diseño sencillo: cómo Kohler reinventó los informes de Creative_ | Caso práctico sobre innovación en procesos breves creativos en Workfront. | 6 de agosto de 2025, 12:00 p. m. MT | [Registrarse](https://events.teams.microsoft.com/event/fbfa9ecf-7042-4ed8-b7a5-58351dae561f@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
| Julio de 2025 | [!DNL Journey Optimizer] | [Agregar campos de formulario a plantillas de canales de experiencia basadas en código](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences) | Nuevo vídeo | Descubra cómo los desarrolladores pueden optimizar la colaboración con los equipos de marketing habilitando campos editables en canales de experiencia basada en código. |
