...
* Ayuda de [People - Customer Attributes and Audience Library](https://experienceleague.adobe.com/docs/core-services/interface/services/core-services-landing.html?lang=es).
...
| Junio de 2021 | [Crear clases de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-classes.html?lang=es) | Vídeo | Aprenda a crear clases en Adobe Experience Platform para utilizarlas en esquemas XDM (Experience Data Model). |
...
| Junio de 2021 | [Crear tipos de datos de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-data-types.html?lang=es) | Vídeo | Aprenda a crear sus propios tipos de datos en Adobe Experience Platform para utilizarlos en esquemas XDM (Experience Data Model). |
...
### Actualizaciones de productos de Experience Manager

* **Experience Manager 6.5.9.0**

   Experience Manager 6.5, Service Pack 9.0 (6.5.9.0, publicado el 27 de mayo de 2021) es una actualización importante que incluye nuevas funciones, mejoras clave solicitadas por el cliente, rendimiento mejorado, estabilidad y seguridad, publicada desde el lanzamiento general de AEM 6.5 en abril de 2019.
...
* **Experience Manager as a Cloud Service**
   ...
   >[!NOTE]
   >
   >Ya está disponible la versión de la función Experience Manager as a Cloud Service de junio. Para experimentar las nuevas funciones, asegúrese de que está en al menos Experience Manager 2021.6.5561.
...
### **Comunidad del Experience Manager**
...
* [Notas de la versión de Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en)
...
* **El nuevo Adobe Campaign v8**  ofrece mejoras significativas en infraestructura, seguridad, capacidad de envío y supervisión. Adobe Campaign v8 mejora considerablemente su escala y velocidad, con la capacidad de administrar un número más significativo de perfiles de clientes, así como tasas de entrega y transacciones mucho más altas por hora. Obtenga más información en la [Documentación de Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=es).

* **Versión de Adobe Campaign Classic v7 21.1.3:** Más información en las notas de la versión de  [Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=es?lang=es).

* **Versión de Adobe Campaign Standard 21.2:** obtenga más información sobre las notas de la versión de  [Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=es).
...
## ![](/assets/creative-cloud-24.png) IconCreative Cloud para empresas {#creative-cloud}

Nuevos vídeos, tutoriales o cursos publicados para Creative Cloud de la empresa.
