...
Próxima versión: **15 de junio de 2022**
...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Insights] | El análisis de pérdida de uso compartido de impresiones ya está disponible como función beta. |
