...
* [!DNL Advertising Cloud](#adcloud) (actualizado el 1/11)
...
Actualizado el 8 de noviembre de 2019, versión
...
| Integración con Adobe Analytics | Ahora, Analytics incluye la dimensión "Tipo de aterrizaje (AMO ID)" para las campañas de DSP de Advertising Cloud.  Utilice esta dimensión para segmentar las métricas de Analytics en función de cómo los visitantes aterrizaron en el sitio. Los valores incluyen "Pulsaciones" y "Pulsaciones".<br><br/>**** Nota: Los datos de las visualizaciones que se produjeron antes del 31 de octubre de 2019 se muestran como datos de las pulsaciones. Por lo tanto, no recomendamos utilizar esta dimensión con datos anteriores a mediados de noviembre de 2019. |
