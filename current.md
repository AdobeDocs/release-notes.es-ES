...
* [[!DNL Adobe Analytics]](#analytics) (publicación el **15 de mayo**)
* [[!DNL Adobe Customer Journey Analytics]](#cja) (publicación el **15 de mayo**)
...
* **WORKFRONT** | Evento de la comunidad | _Adobe Workfront Industry Circle: minorista_ | Si es cliente de Workfront en el sector minorista y está interesado en resolver problemas colectivos y compartir lo aprendido con otros administradores, únase a nosotros para el debate abierto de una hora, dirigido por los administradores de DSW y Nordstrom. | **23 de marzo a las 11:00 a. m. PT** | [Registrarse](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,vFfS8Q7qMUCtqS73wkJMig,sz-whm3Hyka_fhpfall8TA,DCY8aPpdN069tKqlYeJMyQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Receso | _Receso de preguntas y respuestas de la comunidad de Adobe Workfront: migración de Adobe Business Platform_ | Únase a los expertos de Workfront en la comunidad y haga cualquier pregunta que tenga sobre Adobe Business Platform, la migración de su organización a Adobe Admin Console y mucho más. | **29 de marzo a las 8:00 a. m. PT** | [Registrarse](https://experienceleaguecommunities.adobe.com/t5/workfront-events/workfront-coffee-break-wednesday-may-29th-at-8am-pt-best/ev-p/668763?profile.language=es)
...
Encuentre más información sobre los [próximos eventos](https://experienceleague.adobe.com/events/) o examine las [grabaciones de los eventos anteriores](https://experienceleague.adobe.com/es/docs/events/experience-league-recorded-events/overview) en Experience League.
...
| Correcciones de errores | <ul><li>Se han mejorado los filtros del entorno en las páginas de productos de Adobe Connect, Adobe Marketo y Adobe Sign.</li><li>Los clics en la cuadrícula del historial de 40 días aterrizan en el día correspondiente y con los eventos relevantes para ese día.</li><li>Mejoras de la interfaz</li></ul> |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Mayo de 2024 | [!DNL Experience Platform], [!DNL Audience Manager] | [Configuración [!DNL Audience Manager]  con el SDK web de Platform](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/applications-setup/setup-audience-manager) | Artículo | Obtenga información sobre cómo configurar Adobe Audience Manager con el SDK web de Adobe Experience Platform y validar la implementación mediante un destino de cookie. |
| Mayo de 2024 | [!DNL Experience Platform], [!DNL Analytics] | [Configuración de Adobe  [!DNL Analytics] con [!DNL Experience Platform]  el SDK web](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/applications-setup/setup-analytics) de Adobe | Artículo | Obtenga información sobre cómo configurar Adobe Analytics mediante el SDK web de Adobe Experience Platform, crear reglas de etiquetas para enviar datos a Adobe Analytics y validar que Analytics captura los datos según lo esperado. |
| Mayo de 2024 | [!DNL Experience Platform] | [Aplicaciones creadas en [!DNL Experience Platform]](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/intro-to-platform/native-applications) | Vídeo | Obtenga información sobre las aplicaciones creadas de forma nativa sobre Adobe Experience Platform: Customer Journey Analytics, Real-time Customer Data Platform, [!DNL Journey Optimizer] y Mix Modeler. |
| Mayo de 2024 | [!DNL Experience Platform], [!DNL Journey Optimizer] | [Configuración del  [!DNL Journey Optimizer] canal web con el SDK web](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/applications-setup/setup-web-channel) | Artículo | Obtenga información sobre cómo implementar el Adobe [!DNL Journey Optimizer] canal web mediante el SDK web de Adobe Experience Platform. |
| Mayo de 2024 | [!DNL Experience Platform], [!DNL Journey Optimizer] | [Configuración de la gestión de decisiones con el SDK web de Platform](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/applications-setup/setup-decision-management) | Artículo | Obtenga información sobre cómo implementar la capacidad de gestión de decisiones de Adobe [!DNL Journey Optimizer] mediante el SDK web de Platform. |
| Mayo de 2024 | [!DNL Experience Platform] | [Caducidad de perfil seudónimo y evento de experiencia](https://experienceleague.adobe.com/es/docs/platform-learn/tutorials/data-hygiene/pseudonymous-profile-and-event-expiration) | Vídeo | Obtenga información sobre cómo configurar la caducidad de los perfiles seudónimos y eventos en Experience Platform y sus ventajas. |
| Mayo de 2024 | Recopilación de datos, [!DNL Experience Platform] | [Apilado de reglas de etiquetas](https://experienceleague.adobe.com/es/docs/platform-learn/data-collection/tags/stack-rules) | Vídeo | Obtenga información sobre cómo apilar reglas en una propiedad de etiqueta. El apilado de reglas utiliza la función de ordenación en los eventos de reglas de etiquetas para secuenciar las reglas y poder administrar las implementaciones de etiquetas escalables. |
| Mayo de 2024 | [!DNL Experience Platform] | [Configurar una secuencia de datos](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/initial-configuration/configure-datastream) | Artículo | Obtenga información sobre cómo configurar una secuencia de datos para el SDK web de Adobe Experience Platform. |
| Mayo de 2024 | [!DNL Experience Platform] | [Creación de un esquema XDM para datos web](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/initial-configuration/configure-schemas) | Artículo | Obtenga información sobre cómo crear un esquema XDM para datos web en la interfaz de recopilación de datos de Adobe Experience Platform. |
| Mayo de 2024 | [!DNL Experience Platform] | [Configuración de un espacio de nombres de identidad](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/initial-configuration/configure-identities) | Artículo | Obtenga información sobre cómo configurar espacios de nombres de identidad para utilizarlos con el SDK web de Adobe Experience Platform. |
| Mayo de 2024 | [!DNL Experience Platform] | [Validación de implementaciones de SDK web con Experience Platform Debugger](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/tags-configuration/validate-with-debugger) | Vídeo | Obtenga información sobre cómo validar la implementación del SDK web de Adobe Experience Platform con el Adobe Experience Platform Debugger. |
| Mayo de 2024 | [!DNL Experience Platform] | [Validación de implementaciones de SDK web con Experience Platform Assurance](https://experienceleague.adobe.com/es/docs/platform-learn/implement-web-sdk/tags-configuration/validate-with-assurance) | Artículo | Obtenga información sobre cómo validar la implementación de SDK web de Platform con Adobe Experience Platform Assurance. Esta lección forma parte del tutorial Implementación de Adobe Experience Cloud con SDK web. |
...
Explore el nuevo [Extension Manager en  [!DNL AEM Sites]](https://developer.adobe.com/uix/docs/extension-manager/) para que pueda personalizar la configuración de AEM mediante la configuración de extensiones de IU.

Extension Manager en [!DNL AEM Sites] permite a los desarrolladores y profesionales acceder, administrar y personalizar las [extensiones de IU](https://developer.adobe.com/uix/docs/) creadas con el [Creador de aplicaciones de Adobe](https://developer.adobe.com/app-builder/) para mejorar la funcionalidad de [!DNL AEM Sites].
...
| Publicadas | Aplicaciones | Nombre | Tipo | Descripción |
| ----------| ---------- | ---------- | ---------- |---------- |
| Mayo de 2024 | [!DNL AEM Sites] | [Cloud 5 - Temporada 3](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/cloud5-season-3) | Vídeos | La tercera temporada le ayuda a conocer mejor el servicio Edge Delivery Service de AEM mediante entrevistas en profundidad con expertos que han trabajado en proyectos complicados. |
| Mayo de 2024 | [!DNL AEM Sites] | [Cloud 5: Integración de la creación de documentos de  [!DNL AEM Assets] ](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-integrate-assets) | Vídeo | Explore cómo integrar [!DNL AEM Assets] con la creación de documentos para ofrecer experiencias excepcionales con Edge Delivery Services. |
| Mayo de 2024 | [!DNL AEM Sites] | [Generar variaciones: Plantillas de indicación en Edge Delivery Services](https://experienceleague.adobe.com/es/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/prompt-templates) | Vídeo | Explore cómo utilizar las plantillas de indicación de IA generativa en la creación de documentos de Edge Delivery Services para generar variaciones de contenido. |
| Mayo de 2024 | [!DNL AEM Sites] | [Generar variaciones: Plantillas de indicación personalizada en Edge Delivery Services](https://experienceleague.adobe.com/es/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/custom-prompt-templates) | Vídeo | Explore cómo generar las plantillas de indicación personalizada para Generar variaciones en la creación de documentos de Edge Delivery Services. |
| Mayo de 2024 | [!DNL AEM Sites] | [Generar variaciones: Guardar plantillas de indicación personalizada en Edge Delivery Services](https://experienceleague.adobe.com/es/docs/experience-manager-learn/sites/document-authoring/how-to/generate-variations/save-custom-prompt-template) | Vídeo | Explore cómo guardar las plantillas de indicación personalizada de IA generativa en la creación de documentos de Edge Delivery Services para generar variaciones de contenido. |
...
| Mayo de 2024 | [!DNL AEM Assets] | [Exportación de recursos](https://experienceleague.adobe.com/es/docs/experience-manager-learn/assets/sharing/export) | Artículo | Obtenga información sobre cómo exportar recursos al equipo local mediante un script personalizable de `Node.js`. Este script de exportación proporciona un ejemplo de cómo descargar recursos mediante programación desde AEM con las API de HTTP de [!DNL AEM Assets], centrándose específicamente en las representaciones originales para garantizar la máxima calidad. |
| Mayo de 2024 | [!DNL AEM Forms] | [Usar la API de GuideBridge en los datos de formulario de POST](https://experienceleague.adobe.com/es/docs/experience-manager-learn/forms/core-component-based-forms/submit-data-using-guidebridge-api) | Artículo | Use [!UICONTROL Guardar y reanudar] para que se guarde el progreso de rellenado de un formulario y poder reanudarlo más tarde. |
| Mayo de 2024 | [!DNL AEM Sites] | [IA generativa en [!DNL AEM Sites]](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-generative-ai-for-aem-sites) | Vídeo | Explore las nuevas funciones de IA generativa disponibles en la creación de documentos de [!DNL AEM Sites]. |
| Mayo de 2024 | [!DNL AEM Forms] | [Rellenar un formulario en PDF mediante el bot de chat](https://experienceleague.adobe.com/es/docs/experience-manager-learn/forms/chatbot-and-aem-forms/introduction) | Vídeo | Obtenga información sobre cómo rellenar un formulario en PDF mediante un bot de chat. |
| Mayo de 2024 | AEM sin encabezado | [Protección del contenido en AEM sin encabezado](https://experienceleague.adobe.com/es/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/protected-content) | Artículo | Aprenda a proteger contenido en AEM sin encabezado. |
| Mayo de 2024 | AEM CS | [Redes avanzadas](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/networking/advanced-networking) | Artículo | Obtenga información sobre las opciones de redes avanzadas de AEM as a Cloud Service. |
| Mayo de 2024 | AEM CS | [Salida de puerto flexible](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/networking/flexible-port-egress) | Vídeo | Obtenga información sobre cómo configurar y utilizar la salida de puerto flexible para admitir conexiones externas desde AEM as a Cloud Service a servicios externos. |
| Mayo de 2024 | [!DNL AEM Assets] | [[!DNL AEM Assets] y Adobe Express](https://experienceleague.adobe.com/es/docs/experience-manager-learn/assets/creative-workflows/adobe-express) | Vídeo | Descubra cómo crear y editar contenido dentro de Adobe Experience Manager Assets sin esfuerzo mediante Adobe Express. |
| Mayo de 2024 | [!DNL AEM Assets] | [Permisos basados en metadatos](https://experienceleague.adobe.com/es/docs/experience-manager-learn/assets/advanced/metadata-driven-permissions) | Artículo | Aprenda a restringir el acceso en función de las propiedades de los metadatos del recurso, en lugar de la estructura de carpetas. |
| Mayo de 2024 | AEM CS | [Bloqueo de ataques DoS y DDoS mediante reglas de filtro de tráfico](https://experienceleague.adobe.com/es/docs/experience-manager-learn/cloud-service/security/blocking-dos-attack-using-traffic-filter-rules) | Artículo | Obtenga información sobre cómo bloquear los ataques de denegación de servicio (DoS) y denegación de servicio distribuido (DDoS) mediante las reglas de filtro de tráfico de límite de velocidad y otras estrategias en la CDN administrada por AEM as a Cloud Service (AEMCS). |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|--------|---------|---------|
| Abril de 2024 | [Convertir [!DNL URLs] a minúsculas y [!DNL docx] hasta [!DNL HTML] usando [!DNL Apache] reglas de reescritura](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23705) | Nuevo artículo | Obtenga información sobre los pasos para aprender a convertir [!DNL URLs] a minúsculas y extensiones de [!DNL docx] a [!DNL HTML] con las reglas de reescritura de [!DNL Apache] en [!DNL AEM Dispatcher]. |
| Abril de 2024 | [Explicación y resolución de la caducidad inmediata de la imagen en las cachés del explorador con  [!DNL Dynamics Media]](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23899) | Nuevo artículo | Obtenga información sobre cómo las imágenes de los sitios web a veces desaparecen o no se cargan a pesar de estar disponibles. Este artículo explora por qué ocurre esto y cómo la configuración de [!DNL Content Delivery Networks (CDNs)] y [!DNL TTL (Time-To-Live)] desempeña una función. |
| Abril de 2024 | [[!DNL AEM]: Carga parcial de la página con `TooManyCallsException`](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23902) | Nuevo artículo | Obtenga información sobre cómo resolver el error con `TooManyCallsException`, aumente ligeramente (500) el valor de Número de llamadas por solicitud en el paquete [!UICONTROL Servlet principal de Sling] de [!DNL Apache]. |
| Abril de 2024 | [Concesión de acceso a la [!UICONTROL consola Felix] para usuarios no administradores](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23931) | Nuevo artículo | Obtenga información sobre cómo el componente [!DNL OSGI] del proveedor de seguridad de la [!UICONTROL consola web de Sling] de [!DNL Apache] facilita la autenticación para los usuarios de [!DNL AEM]. |
| Abril de 2024 | [Análisis del archivo `request.log` para patrones de tráfico](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23936) | Nuevo artículo | Obtenga información sobre cómo analizar `request.log` generando un gráfico de tráfico y luego generando referencias cruzadas a la salida de las herramientas de `request.log` y `rlog.jar`. |
| Abril de 2024 | [Cómo encontrar conflictos al obtener el error `OakState0001` en [!DNL AEM]](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23983) | Nuevo artículo | Obtenga información sobre el error `OakState0001` en [!DNL Adobe Experience Manager]. Consulte los pasos descritos en este artículo para identificar cualquier conflicto. |
| Abril de 2024 | [El nodo inicial no se replica al publicar las plantillas](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-23996) | Nuevo artículo | Obtenga información sobre el comportamiento único del [!UICONTROL nodo inicial] en las plantillas de [!DNL Adobe Experience Manager (AEM)] y por qué no se replica en el entorno de publicación durante el proceso de publicación. |
| Abril de 2024 | [Límite máximo de caracteres para variables de entorno en  [!DNL AEMaaCS's Cloud Manager]](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24014) | Nuevo artículo | Obtenga información sobre los límites máximos de caracteres para variables de entorno en [!UICONTROL Cloud Manager] de [!DNL Adobe Experience Manager as a Cloud Service's (AEMaaCS)] en varios entornos, incluidos ensayo, producción y desarrollo. |
| Abril de 2024 | [[!DNL Marcom] - La limpieza de revisión no se muestra en mantenimiento diario - [!DNL AEM]](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24037) | Nuevo artículo | Obtenga información sobre la visibilidad de la tarea [!UICONTROL Limpieza de revisión] en la IU de [!DNL Adobe Experience Manager (AEM)] en [!UICONTROL Mantenimiento diario], especialmente después de una actualización a [!DNL SP17] y proporciona conocimiento sobre la administración de [!UICONTROL Recopilación de datos desechables de revisión] al usar [!DNL MongoDB] como almacén de datos. |
| Abril de 2024 | [Deshabilitar la búsqueda de texto completo por tipo  [!DNL mime]  con configuración [!DNL Tika] personalizada en [!DNL AEM]](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24046) | Nuevo artículo | Obtenga información sobre cómo personalizar la configuración de [!DNL Tika] para deshabilitar la búsqueda de texto completo basada en el archivo de tipos [!DNL mime]. |
| Abril de 2024 | [[!DNL Scene7]: seleccione el marco del póster o la miniatura de vídeo](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24053) | Nuevo artículo | Obtenga información sobre cómo especificar una miniatura de vídeo o una imagen de póster específica en [!DNL Adobe Experience Manager (AEM)] en el contexto de [!DNL Scene7], ahora conocido como **[!DNL Dynamic Media]**. |
| Abril de 2024 | [Cómo agregar `stricthostcheck` in [!DNL AEMaaCS] Configuración de Dispatcher](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24069) | Nuevo artículo | Obtenga información sobre cómo agregar `stricthostcheck` in [!DNL AEMaaCS] Configuración de Dispatcher. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Abril de 2024 | [¿Qué sucede cuando el objeto [!UICONTROL Tablero predeterminado] se cambia a  [!DNL Marketo Measure]?](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-24085) | Nuevo artículo | Obtenga información sobre los efectos de cambiar el objeto [!UICONTROL Tablero predeterminado] en la configuración de [!DNL Marketo Measure]. |
