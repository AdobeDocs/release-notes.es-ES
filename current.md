...
* (Anunciantes con el servicio de seguimiento de conversión de Marketing Cloud) Con la prevención inteligente de seguimiento de Apple (ITP) 2.2, que se publicó en mayo, las cookies de seguimiento de conversión de Marketing Cloud se eliminan automáticamente de los exploradores Apple Safari después de 24 horas. Sin embargo, Advertising Cloud tiene una nueva solución ITP que le permite rastrear conversiones que se producen en Safari durante más de 24 horas después del clic original. La solución utiliza el almacenamiento local y la tecnología de iframe. Póngase en contacto con el administrador de la cuenta de búsqueda de Marketing Cloud para ver las instrucciones de implementación.
* En Búsqueda &gt; Avanzado (ACM), ahora puede configurar los sufijos URL finales de nivel de campaña para las plantillas de texto de Google y las plantillas de anuncios de compra.
* Ahora, los anunciantes con cuentas de Google Ads que cumplen los requisitos para la Coincidencia del cliente pueden realizar lo siguiente:
   * Cree una audiencia de coincidencia de clientes de Google Ads usando ID de usuario de un segmento de audiencia de Adobe. Para ver esta función, la cuenta del anunciante debe configurarse para permitirla.
   * Crear una audiencia de coincidencia del cliente de Google Ads cargando un archivo de datos de cliente. El archivo puede constar de información de contacto (direcciones de correo electrónico, direcciones de correo electrónico o números de teléfono), ID de usuario o ID de dispositivos móviles. Algunos tipos de información de contacto deben ser hash con el algoritmo SHA -256.
   * Actualice cualquier audiencia de coincidencia de clientes de Google excepto audiencias creadas a partir de una audiencia de Adobe. Puede cargar datos para agregar, eliminar o reemplazar todos los datos existentes de la audiencia. Toda la información de contacto debe ser hash con el algoritmo SHA -256.
* Las Audiencias Audiencias &gt; Objetivos y audiencias &gt; Exclusiones incluyen una columna "Tipo".
