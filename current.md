...
source-git-commit: 25b4ac7932c588f36451ea46c21bbb13a3539359
workflow-type: tm+mt
...
|-------|------------|----------------|
| Experience Cloud admin & central interface   | [June 1, 2025](https://experienceleague.adobe.com/es/docs/release-notes/experience-cloud/current) | Generative AI support in Admin Console, improved user/product license management |
| Adobe Experience Platform | [June 18, 2025](https://experienceleague.adobe.com/es/docs/experience-platform/release-notes/latest)  | New dashboard email exports, updated tutorials & support articles |
| Adobe Real-Time CDP  | [June 12, 2025](https://experienceleague.adobe.com/es/docs/real-time-cdp-collaboration/using/latest) | Self-serve destination support, audience refresh frequency |
| Adobe Analytics  | [June 18-24, 2025](https://experienceleague.adobe.com/es/docs/analytics/release-notes/latest)  | Secure cloud exports, new preview bar chart, enhanced attribution |
| Adobe Customer Journey Analytics | [June 2-18, 2025](https://experienceleague.adobe.com/es/docs/analytics-platform/using/releases/latest)  | Fixed panel hover, new B2B Edition GA with account-level modeling |
| Adobe Streaming Media Analytics  | _(Not updated)_  | No new release notes - last updated December 2024 | 
| Adobe Experience Manager | [June 10, 2025](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/release-notes/maintenance/2025/2025-6-0)  | Maintenance release 21193, feature release 2025.6.0 scheduled June 26 |
| Adobe Commerce (Magento)  | [June 10, 2025](https://experienceleague.adobe.com/es/docs/commerce-operations/release/versions)  | Commerce 2.4.9‑alpha & patch 2.4.8‑p1, security fixes via APSB25‑50 |
| Adobe Commerce B2B Edition | [June 10, 2025](https://experienceleague.adobe.com/es/docs/commerce-admin/b2b/release-notes)  | B2B module v1.5.2‑p1 and v1.4.2‑p6 released with security compatibility |
...
| Adobe Journey Optimizer  | [June 18, 2025](https://experienceleague.adobe.com/es/docs/journey-optimizer/using/whats-new/release-notes) | Beta: AEP dataset decisioning |
...
| Adobe Mix Modeler   | [June 18, 2025](https://experienceleague.adobe.com/es/docs/mix-modeler/using/releases/latest)  | Introduced goal-based plans and spend pattern configurations |
...
* **Adobe Workfront** | _Seminario Web Sobre La Versión Del Tercer Trimestre_ | Destaca las últimas funciones de Workfront programadas para la versión de julio de 2025. | [10 de julio de 2025 - 9:00 AM MT] | [Registrarse](https://events.teams.microsoft.com/event/0481924a-fc34-4781-b7fc-ed4a54e6fa1f@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Adobe Marketo Engage** | _Grupo de usuarios_ | Aprenda a impulsar campañas con Marketo Personalization en esta sesión fundacional. | 10 de julio de 2025 | [Registrar](https://mugs.marketo.com/events/details/marketo-foundational-marketo-user-group-presents-foundations-of-marketo-engage-powering-campaigns-with-marketo-personalization/)

* **Adobe Workfront** | _Connect: Chat del administrador para Marketing y Creative_ | Analice con compañeros las prácticas recomendadas y sugerencias para los administradores de Workfront. | 11 de julio de 2025 - 10:00 AM MT | [Registrar](https://events.teams.microsoft.com/event/14f0c251-136d-4a61-befc-54673bf58cd6@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* **Adobe Workfront** | _Colectivo Workfront_ | Encuentro mensual para compartir características, generar ideas y resolver desafíos. | 17 jul. 2025 - 7:00 AM MT | [Registrar](https://events.teams.microsoft.com/event/cce5eabe-e2e7-435f-aefb-14956ec192d0@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Lanzamiento previsto: **18 de junio de 2025**
...
|---------|----|----|-----------|
| Mayo de 2025 | [[!DNL Snowflake] tiempo de espera de conexión al editar el flujo de datos de [!UICONTROL Origen] en AEP](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26451) | Nuevo artículo | Obtenga información sobre las soluciones al problema de tiempo de espera de conexión de [!DNL Snowflake] en Adobe Experience Platform al editar un flujo de datos de [!UICONTROL Origen] de [!DNL Snowflake]en el paso **[!UICONTROL Seleccionar datos]**. |
| Mayo de 2025 | [Adobe Experience Platform - la búsqueda del perfil de **[!UICONTROL ID de partner]** no muestra resultados](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26462) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando la búsqueda del perfil de **[!UICONTROL ID de partner]** no muestra resultados en Adobe Experience Platform debido al modo en que funcionan los gráficos de identidad. |
| Mayo de 2025 | [AEP no admite la restricción del acceso a la API en función de direcciones IP específicas](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26471) | Nuevo artículo | Obtenga información sobre las soluciones al problema en el que no se puede restringir el acceso de la API a direcciones IP específicas dentro de Adobe Experience Platform (AEP). |
| Mayo de 2025 | [*UIS-0002-400: error en la resolución de identidad del lote* en Adobe Experience Platform](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26520) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando se produce el error *UIS-0002-400: error de fallo en la resolución de identidad del lote* en Adobe Experience Platform (AEP). |
| Mayo de 2025 | [Corrección del error 400 de la [!UICONTROL API de Privacy Service] en AEP: se explica el límite de carga diaria](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26552) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando se activa un error 400 al intentar realizar eliminaciones de perfiles de usuario a gran escala para el cumplimiento de la normativa, como el RGPD, ya que la [!UICONTROL API de Privacy Service] de Adobe Experience Platform (AEP) impone un límite diario de carga útil estricto para evitar el uso indebido del servicio. |
| Mayo de 2025 | [Resolución de errores de tiempo de espera durante la creación de segmentos en Adobe Experience Platform](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26606) | Nuevo artículo | Obtenga información sobre cómo resolver errores de tiempo de espera durante la creación de segmentos del público en Adobe Experience Platform. |
| Mayo de 2025 | El conector [[!DNL Facebook] [!UICONTROL Público personalizado] se ha bloqueado en el estado de procesamiento](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26615) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando el destino de [!DNL Facebook] [!UICONTROL Público personalizado] se queda atascado en el estado de procesamiento, bloqueando la activación del público. |
| Mayo de 2025 | [Resolución de discrepancias en el recuento de perfiles en Adobe Experience Platform](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26648) | Nuevo artículo | Obtenga información sobre las soluciones al problema en [!UICONTROL Real-Time Customer Data Platform] (CDP), cuando el recuento de instantáneas del perfil difiere de la vista del sistema de origen en Adobe Experience Platform (AEP). |
| Mayo de 2025 | [Incoherencias en la lógica de límite entre ubicaciones en la toma de decisiones sobre ofertas de AEP](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26682) | Nuevo artículo | Obtenga información sobre las soluciones al problema por el que la lógica de límite se comporta de forma inconsistente entre las ubicaciones de mensajes 1:1 y las de los correos electrónicos en la función **[!UICONTROL Toma de decisiones sobre ofertas]** de Adobe Experience Platform. |
| Mayo de 2025 | [AEP: error de ingesta de datos debido a que la carga útil de la solicitud supera el tamaño máximo permitido](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26712) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando Adobe Experience Platform (AEP) devuelve un error de tamaño de carga útil cuando la solicitud supera el límite de 1 MB durante la ingesta de streaming. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|--------|---------|---------|
| Mayo de 2025 | [El público compartido de Analytics sigue mostrando datos recopilados en la **[!UICONTROL biblioteca de públicos]**](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26635) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando no se recopilan datos para una variable personalizada, por ejemplo: `eVar1`. El valor se muestra como “`未指定`” en la tabla de forma libre de **[!UICONTROL Analysis Workspace]**. |
| Mayo de 2025 | [Seguimiento del modelo de dispositivo móvil para  [!DNL iPhone]  en Adobe Analytics y CJA](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26568) | Nuevo artículo | Obtenga información sobre el seguimiento del modelo de dispositivo móvil para [!DNL iPhone] en Adobe Analytics y CJA. |
| Mayo de 2025 | [Demasiados operadores `Contains` hacen que los segmentos no funcionen correctamente](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-25262) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando demasiados operadores `Contains` hacen que los segmentos no funcionen correctamente. |
...
* [Notas de la versión de mantenimiento actuales](https://experienceleague.adobe.com/es/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest)
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Mayo de 2025 | El asistente para [**[!UICONTROL Actualizar la estructura de la base de datos &#x200B;]**&#x200B;en Adobe Campaign Classic no muestra el esquema](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26407) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando al utilizar el asistente para **[!UICONTROL Actualizar la estructura de la base de datos]** en Adobe Campaign Classic, no se muestran los esquemas vinculados a bases de datos externas. |
| Mayo de 2025 | [El flujo de trabajo se ejecuta de forma inesperada a pesar de la configuración del planificador en Adobe Campaign Managed Cloud](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26415) | Nuevo artículo | Obtenga información sobre las soluciones al problema de cuando no se aplican las actualizaciones del planificador y se producen ejecuciones de flujo de trabajo inesperadas en Adobe Campaign Managed Cloud. |
| Mayo de 2025 | [No se puede ver las pestañas segmentación y flujo de trabajo en Campaign Classic](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26632) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando las pestañas **[!UICONTROL segmentación y flujo de trabajo]** no son visibles en Adobe Campaign Classic. |
| Mayo de 2025 | [El filtro de estadísticas de envío no funciona debido al límite de registros de 10 000 en los **[!UICONTROL informes dinámicos]**](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26697) estándar de Adobe Campaign Standard | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando el filtro de estadísticas de envío **[!UICONTROL Contiene]** no devuelve los resultados completos cuando se aplican palabras clave específicas. |
| Mayo de 2025 | [El recuento de destinatarios disminuye tras la actividad de envío en Adobe Campaign Classic](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26446) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando el recuento de registros disminuye después de una actividad de envío. |
...
| Junio de 2025 | [Crear actividades de filtro básicas](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-filter-activity) | Nuevo artículo | En esta actividad, creará un filtro de proyecto denominado “Todos los proyectos del portafolio de marketing” en la experiencia de filtro heredada. Esto le mostrará todos los proyectos del portafolio denominado “Portafolio de marketing” independientemente de su estado. |
| Junio de 2025 | [Crear un informe de matriz](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-matrix-report) | Nuevo vídeo | Descubra cuándo un informe de matriz puede ser útil y cómo crearlo en Workfront. |
| Junio de 2025 | [Envío y uso compartido de informes](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/how-to-send-and-share-reports) | Nuevo vídeo | Obtenga información sobre cómo enviar informes a usuarios, equipos o a cualquier dirección de correo electrónico, y cómo compartirlos con cualquier persona en Workfront. |
| Junio de 2025 | [Creación de paneles](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-dashboards) | Nuevo vídeo | Organice y muestre los datos del proyecto con los paneles de Workfront. Puede acceder a ellos fácilmente, personalizarlos, y compartir e imprimirlos para una administración y colaboración de proyectos sin problemas. |
| Junio de 2025 | [Comprender la configuración del informe](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/report-settings) | Nuevo vídeo | Obtenga información sobre cómo acceder a la configuración de informes de Workfront y para qué se utilizan los ajustes comunes de los informes. |
| Junio de 2025 | [Creación de una vista básica](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-basic-view) | Nuevo vídeo | Obtenga información sobre qué es una vista, cómo crearla y compartirla con otros usuarios en Workfront. |
| Junio de 2025 | [Seguimiento del progreso de la revisión](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/workfront-proof/review-and-approve-work-for-proof/track-proof-progress) | Nuevo artículo | Aprenda a utilizar los indicadores SOCD, el progreso de la revisión y los informes para realizar el seguimiento del progreso de una revisión en Workfront. |
| Junio de 2025 | [Creación de un informe de tareas](https://experienceleague.adobe.com/es/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/create-a-task-report) | Nuevo vídeo | Aprenda a crear un informe de tareas con un filtro complejo y a encontrar los informes que crea en Workfront. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Mayo de 2025 | [El estado de planificación predeterminado personalizado no se ha aplicado a los nuevos proyectos en Workfront](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26366) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando al configurar un estado de planificación predeterminado personalizado en Adobe Workfront, los proyectos recién creados siguen utilizando el estado de planificación predeterminado del sistema en lugar del personalizado. |
| Mayo de 2025 | [Compatibilidad de las cuentas principales de servicio de  [!DNL Azure]  con Adobe Workfront y  [!DNL Fusion]  SSO](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26646) | Nuevo artículo | Obtenga información sobre cuando, al inicio de sesión único (SSO) de [!DNL Azure], para la autenticación durante la transición de [!DNL SiteMinder] plantea preguntas acerca de si se pueden usar las cuentas principales de servicio de [!DNL Azure] para autenticarse en Adobe Workfront y [!DNL Fusion], en sustitución de las cuentas de servicio tradicionales vinculadas a las direcciones de correo electrónico. |
