...
* Adobe Campaign Standard: [Documentación](https://helpx.adobe.com/support/campaign/standard.html) - Notas [de la](https://docs.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html) versión - [Vídeos](https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/overview.html) de procedimientos - Planificación de [la versión](https://helpx.adobe.com/campaign/kb/acs-release-planning.html)
