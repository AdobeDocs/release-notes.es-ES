...
# Notas de la versión de Adobe Experience Cloud: Octubre de 2022
...
Los eventos de Experience League son un buen lugar para aprender, interactuar y obtener respuestas de los expertos en productos de Adobe. Consulte [Eventos](https://experienceleague.adobe.com/events/?lang=es) Experience League para mantenerse actualizado para octubre de 2022.

| Nombre de producto / evento | Tipo | Descripción |
| -----------|---------- | ----|
| **[!DNL Adobe Workfront]** | Taller | _Serie de Realización de Valores: asignación de ruta a su recorrido de Workfront_ - ¿Qué sigue en su recorrido de Workfront? Únase a nosotros para hablar sobre cómo crear su propia hoja de ruta para Adobe Workfront en su organización. Obtenga ideas sobre nuestros hitos favoritos para añadirlos a su hoja de ruta y conozca nuestras experiencias como antiguos administradores del sistema.<p>**4 de octubre a las 12:30 p. m. MT**: [detalles y registro](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,Bx3LyyABjkC6f0LfiHlHgw,F_Tenijn5UulPjqprok8eg,7lni6LpvlEWagR1OIDfosA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
...
## Actualización de búsqueda unificada

* **Búsqueda personalizada:** Los resultados de búsqueda en la barra de búsqueda global ahora están personalizados con la frecuencia y la actualización de uso por parte del usuario.
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Octubre de 2022 | [Usar campos enumerados y valores sugeridos](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/use-enumerated-fields.html) | Vídeo | Aprenda a utilizar campos enumerados y valores sugeridos para crear menús desplegables prácticos en la interfaz del generador de segmentos. | Modelo de datos (XDM) |
| Octubre de 2022 | [Administrar datos confidenciales en almacenes de datos](https://experienceleague.adobe.com/docs/platform-learn/data-collection/edge-network/manage-sensitive-data-in-datastreams.html) | Vídeo | Aprenda a administrar datos confidenciales en conjuntos de datos. | SDK web |
| Octubre de 2022 | [Crear un tablero](https://experienceleague.adobe.com/docs/platform-learn/tutorials/dashboards/create-a-dashboard.html) | Vídeo | Obtenga información sobre cómo crear un tablero en Adobe Experience Platform. | Tableros |

### [!DNL Adobe Mobile] SDK

Actualizado: **9 de septiembre de 2022** - Consulte [Notas de la versión y registros de cambios](https://aep-sdks.gitbook.io/docs/release-notes) para conocer los SDK móviles de Adobe Experience Platform.

## ![Icono](/assets/analytics.png) [!DNL Adobe Analytics] {#analytics}

Versión siguiente: **5 de octubre de 2022**

>[!NOTE]
>
>Las notas de la versión de octubre estarán disponibles en **5 de octubre de 2022**.
...
| -----------| ---------- | ---------- | ---------- |
| Octubre de 2022 | [Gráficos combinados en Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/combo-charts.html) | Vídeo | Obtenga información sobre la visualización de gráficos combinados en Analysis Workspace. |
...
### AEM hojas de ruta y vídeos de lanzamiento

Adobe recomienda visitar los siguientes recursos para mantenerse al día con la información de la versión:

* [actualizaciones de la versión del Experience Manager y hojas de ruta](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html?lang=es) : Obtenga información sobre la hoja de ruta de las versiones de Experience Manager, las actualizaciones de versiones anteriores y las actualizaciones de documentación.
* [Actualizaciones de la versión as a Cloud Service del Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html?lang=en) : obtenga información general rápida sobre las últimas funciones de Adobe Experience Manager as a Cloud Service.

### Experience Manager [!DNL Sites] as a [!DNL Cloud Service]

_Nuevas funciones de AEM Sites_

La variable [!UICONTROL Correo electrónico] permite la creación de contenido en AEM que luego se envía como correos electrónicos a través de [!DNL Campaign Classic]. La variable [!UICONTROL Componente de correo electrónico principal]:
...
* Proporciona una personalización y segmentación avanzadas, gracias al [inserción de variables de Campaign](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization) en la mayoría de los campos de diálogo y en la variable [Componente de segmentación](https://github.com/adobe/aem-core-email-components/wiki/(Technical-Documentation)).

* Proporciona una salida óptima para el HTML que puede enviar por correo electrónico, gracias al [Estilo CSS inliner](https://github.com/adobe/aem-core-email-components/wiki/HTML-Inliner:-Technical-documentation), el [HTML atributo inliner](https://github.com/adobe/aem-core-email-components/wiki/HTML-Inliner:-Technical-documentation)y [HTML sanitizer](https://github.com/adobe/aem-core-email-components/wiki/HTML-sanitizing:-Technical-documentation).

* Permite la creación de los correos electrónicos en cualquier lugar.

_[!DNL Sites]Nuevas funciones disponibles en el canal de prelanzamiento de_
...
* [Eliminar campos ocultos de un documento de registro (DoR) durante el procesamiento en el servidor](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=es): Puede generar el PDF de documento de registro para los usuarios finales que contenga únicamente aquellos campos que les fueran visibles durante la experiencia de captura de datos. Al enviar el formulario, el servidor valida qué campos se ocultaron al usuario final en función de los datos enviados y excluye del documento de registro para mantener la coherencia.

### Cloud Manager

* [!DNL AEM Guides] ahora se puede configurar de forma autoservicio en programas de espacio aislado.

* Clientes sin ninguno [!DNL Cloud Manager] no puede acceder a los detalles del programa. Sin embargo, pueden desplazarse a los puntos finales de Autor desde [!DNL Cloud Manager] páginas de aterrizaje.

* Los clientes pueden configurar **Incidente y notificación dinámica** grupos a los que desee escuchar desde el Adobe sobre incidentes o recomendaciones relacionados con su aplicación AEMaaCS. Consulte [Grupo de usuarios para notificaciones](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/onboarding/journey/user-groups.html?lang=en) para obtener más información.

* **[!UICONTROL Agregar asistencia del programa]** en la interfaz de usuario proporciona información del objeto de forma coherente cuando está desactivado por motivos relacionados con permisos o autorizaciones.

### [!DNL Workfront] para conector mejorado del Experience Manager

La última versión (1.9.3) de [!DNL Workfront] para que el conector mejorado del Experience Manager estuviera disponible en **16 de septiembre de 2022**. Consulte [Notas de la versión](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/workfront/release-notes-enhanced-connector-workfront.html?lang=en) para obtener más información.

Adobe recomienda que [actualizar a la última versión 1.9.3](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html?lang=en) del conector mejorado de Workfront for Experience Manager.
...
| -----------| ---------- | ---------- | ---------- | ------|
| Octubre de 2022 | [Propiedad de carga de elementos en AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/adaptive-forms/using-item-load-path.html) | Vídeo | Aprenda a configurar y rellenar la lista desplegable con la propiedad ruta de carga del elemento. | AEM Forms CS |
| Octubre de 2022 | [Habilitar canalización front-end para el tipo de archivo del proyecto AEM estándar](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/enable-frontend-pipeline-devops/overview.html) | Vídeo | Obtenga información sobre cómo habilitar el proyecto AEM WKND Sites mediante AEM tipo de archivo del proyecto para implementar recursos front-end como CSS, JavaScript, fuentes e iconos, mediante una canalización front-end para un ciclo más rápido de desarrollo e implementación. | AEM Sites |
| Octubre de 2022 | [Aplicación Next.js](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/example-apps/next-js.html) | Vídeo | Obtenga información sobre cómo consultar contenido mediante las API de AEM GraphQL mediante consultas persistentes. El cliente AEM sin encabezado para JavaScript se utiliza para ejecutar las consultas persistentes de GraphQL que alimentan la aplicación. | AEM Sites |
| Octubre de 2022 | [Extraer datos adjuntos de formularios enviados](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-and-power-automate/send-af-attachments-in-email.html) | Vídeo | Obtenga información sobre cómo extraer archivos adjuntos de formularios y enviarlos en un mensaje de correo electrónico en Power Automatice el flujo de trabajo. | AEM Forms CS |
| Octubre de 2022 | [Enviar DoR como archivo adjunto de correo electrónico](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-and-power-automate/send-DoR-email-attachment.html) | Vídeo | Extraiga DoR y envíe como un adjunto de correo electrónico en Power Automatice el flujo de trabajo. | AEM Forms CS |
| Octubre de 2022 | [Consola Fragmentos de contenido](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-console.html?lang=en) | Vídeo | Obtenga información sobre las funciones y características básicas de la consola de creación de fragmentos de contenido de AEM as a Cloud Service. | AEM CS |
| Octubre de 2022 | [Preguntas frecuentes sobre la migración de contenido as a Cloud Service AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/content-migration/faq.html) | Vídeo | Obtenga respuestas a las preguntas más frecuentes sobre la migración de contenido a AEM as a Cloud Service. | AEM CS |
...
* [Notas de la versión actual de Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=en)
...
* [Notas de la versión de Livefyre](https://experienceleague.adobe.com/docs/discontinued/using/livefyre.html)
...
Nuevas funciones y contenido disponible para [!DNL Adobe Commerce].

### Servicios de pago{#payment-services}

| Función | Descripción |
| ------- | ------- |
| [Usar varias cuentas de PayPal](https://experienceleague.adobe.com/docs/commerce-merchant-services/payment-services/configure/settings.html?lang=en#use-multiple-paypal-accounts) | Aprenda a utilizar diferentes cuentas de negocio de PayPal para su cuenta de comerciante para que pueda realizar transacciones en varios países (con distintas monedas) o utilizar Adobe Commerce para algunas, pero no todas, partes de su negocio. |
| [Agregar un descriptor de software al sitio web o a las vistas de tienda](https://experienceleague.adobe.com/docs/commerce-merchant-services/payment-services/configure/settings.html?lang=en#add-soft-descriptor) | Aprenda a añadir un descriptor de software al sitio web o a almacenar vistas para definir entre tiendas, marcas o catálogos en los estados bancarios de transacciones de clientes. |
...
* [Notas de la versión de Recomendaciones Product](https://experienceleague.adobe.com/docs/commerce-merchant-services/product-recommendations/release-notes.html?lang=es)
...
>[!NOTE]
>
>[!DNL Adobe Search&Promote] finalización del servicio **1 de septiembre de 2022**. Para la búsqueda de productos y comercio, [Live Search](https://experienceleague.adobe.com/docs/commerce-merchant-services/live-search/overview.html?lang=es) es la aplicación de búsqueda de Adobe. Consulte la [anuncio de fin de vida útil](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html?lang=en) para obtener más información.

### Nuevos tutoriales y documentación para [!DNL Adobe Commerce] {#tutorials-commerce}

| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Octubre de 2022 | [Información general sobre la instalación local](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/overview.html) | Documentación del producto | Obtenga información sobre el proceso de instalación para implementaciones locales de Adobe Commerce y Magento Open Source. |
| Octubre de 2022 | [Infraestructura de Commerce magento-cloud)](https://experienceleague.adobe.com/docs/commerce-operations/reference/commerce.html) | Documentación del producto | Obtenga información sobre todos los comandos, argumentos y opciones disponibles para la herramienta de línea de comandos de Adobe Commerce magento-cloud. |
| Octubre de 2022 | [Servicio de catálogo para Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/catalog-service.html) | Documentación del producto | Obtenga información sobre cómo instalar y probar el servicio de catálogo. |
| Octubre de 2022 | [Guía de promociones y comercialización de Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-admin/marketing/guide-overview.html) | Documentación del producto | Obtenga información sobre las funciones promocionales y de comercialización, incluidos los descuentos y eventos dirigidos. |
...
Próxima versión planificada: **Del 4 al 6 de octubre de 2022**
...
| Publicadas | Nombre | Tipo | Descripción | Aplicaciones |
| -----------| ---------- | ---------- | ---------- |---------- |
| Octubre de 2022 | [Introducción a la gestión de decisiones para especialistas en marketing](https://experienceleague.adobe.com/docs/courses/using/experienceplatform-u-1-2020-1-offerdecisioning.html?lang=en) | Vídeo | Aprenda a utilizar campos enumerados y valores sugeridos para crear menús desplegables prácticos en la interfaz del generador de segmentos. | Campaign v8 |
| Octubre de 2022 | [Configuración de SMS para Adobe Campaign](https://experienceleague.adobe.com/?recommended=Campaign-A-1-2022.classic.setupsms) | Curso | Obtenga información sobre cómo conectar la instancia de Campaign a su proveedor SMTP y cómo analizar y solucionar problemas de la configuración. | Campaign v8 |
| Octubre de 2022 | [Delegación completa de subdominios](https://experienceleague.adobe.com/docs/control-panel-learn/tutorials/subdomains-and-certificates/subdomain-delegation.html?lang=en) | Vídeo actualizado | Aprenda a delegar completamente un subdominio a Adobe Campaign. | Panel de control |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Octubre de 2022 | [Copiar un recorrido en otro simulador de pruebas](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/copy-a-journey.html?lang=en) | Vídeo | Aprenda a copiar un recorrido y sus objetos dependientes de un simulador para pruebas a otro. |
| Octubre de 2022 | [Usar alertas](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/report-and-monitor/alerts.html?lang=en) | Vídeo | Obtenga información sobre cómo suscribirse a alertas predefinidas para detectar comportamientos de recorrido inesperados y recibir notificaciones por correo electrónico, Journey Optimizer o mediante una API. |
| Septiembre de 2022 | [Introducción a la gestión de decisiones para especialistas en marketing](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2020.1.offerdecisioning) | Curso | Obtenga información sobre las funcionalidades de gestión de decisiones de Adobe Journey Optimizer. Este curso está diseñado para especialistas en marketing que deseen aumentar los ingresos, la experiencia del cliente y la lealtad mediante el envío de las mejores ofertas a sus clientes |
...
* Consulte [Octubre de 2022: notas de la versión actuales](https://experienceleague.adobe.com/docs/marketo/using/release-notes/current.html?lang=en) para obtener la información más reciente
* Consulte [!DNL Marketo Engage] [programación de versiones](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html?lang=en) para obtener la información más reciente sobre el calendario de versiones y las notas de la versión.
...
Para obtener la documentación del producto más reciente, consulte el inicio de la [Documentación del producto de Marketo](https://experienceleague.adobe.com/docs/marketo/using/home.html?lang=en)
...
### Nuevo Adobe [!DNL Workfront] cursos y tutoriales {#tutorials-workfront}

Nuevo [!DNL Workfront] curso y colecciones de tutoriales sobre Experience League.

**Nota:**[[!DNL Workfront] La traducción para Experience League de todos los tutoriales y la documentación del producto de estará disponible pronto.](https://experienceleague.adobe.com/docs/workfront.html?lang=en)

| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Octubre de 2022 | [Agregar y editar la configuración de columna en un tablero](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/agile/boards/add-and-edit-column-settings-on-a-board.html?lang=es) | Vídeo | Aprenda a añadir y editar la configuración de columnas en un tablero. |
| Octubre de 2022 | [Informes avanzados](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/advanced-reporting/welcome-to-advanced-reporting.html?lang=en) | Vídeo | Aprenda a utilizar el Explorador de API y el modo de texto para crear filtros, vistas y agrupaciones avanzadas que vayan más allá de las capacidades de la interfaz de usuario de informes. |
...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Campañas] | (Versión del 6 de octubre) Hay nuevas columnas de métricas relacionadas con el ritmo disponibles para la variable [!UICONTROL Campañas] vistas: &quot;[!UICONTROL OTS de ayer]&quot; (en gasto objetivo), &quot;[!UICONTROL Entrega de ayer],&quot;[!UICONTROL Objetivo de ayer],&quot;[!UICONTROL OTS de hoy]&quot; (en gasto objetivo), &quot;[!UICONTROL Entrega de hoy],&quot; y &quot;[!UICONTROL El objetivo de hoy].&quot; |
...
| Publicadas | Nombre | Tipo | Descripción | Aplicación |
| -----------| ---------- | ---------- | ---------- |---------- |
| Octubre de 2022 | [Analizar cualquier cosa al PDF](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/mobile/scan-mobile-app.html) | Vídeo | Aprenda a convertir cualquier documento en papel en un PDF mediante la aplicación móvil gratuita de Adobe Scan. | Acrobat |
...
| Octubre de 2022 | [Trabajar con archivos del Dropbox](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/integrations/acrobat-dropbox.html?lang=en) | Vídeo | Obtenga información sobre cómo abrir, crear, editar, firmar y guardar cambios en los archivos Dropbox desde Acrobat. | Acrobat |
| Octubre de 2022 | [Archivar automáticamente archivos en SharePoint con Power Automate](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/auto-archive-sharepoint-power-automate.html?lang=en) | Vídeo | Aprenda a archivar automáticamente los documentos firmados en una biblioteca de SharePoint mediante Power Automate. | Acrobat Sign |
| Octubre de 2022 | [Configuración de la asignación de datos en Salesforce](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/salesforce/set-up-data-mapping.html?) | Vídeo | Obtenga información sobre cómo configurar la asignación de datos para Acrobat Sign en Salesforce. La asignación de datos permite recuperar datos en Salesforce después de firmar un acuerdo. | Acrobat Sign |
| Octubre de 2022 | [Configuración de un archivo externo](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/set-up-your-external-archive.html?lang=en) | Vídeo | Aprenda a crear un archivo externo para copias de seguridad de los acuerdos que se han firmado. | Acrobat Sign |
| Octubre de 2022 | [Administrar y rastrear los acuerdos](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-managing/manage-and-track.html?lang=en) | Vídeo actualizado | Obtenga información sobre cómo administrar y rastrear documentos enviados para su firma en Acrobat Sign. | Acrobat Sign |
| Octubre de 2022 | [Configuración de la asignación de combinación en Salesforce](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/salesforce/set-up-merging-map.html?lang=en) | Vídeo actualizado | Aprenda a combinar datos de Salesforce directamente en un documento de Acrobat Sign. | Acrobat Sign |
| Octubre de 2022 | [Creador de documentos para Salesforce](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/salesforce/create-an-agreement-template.html) | Vídeo | Aprenda a crear una plantilla de documento reutilizable mediante el Creador de documentos para Salesforce. | Acrobat Sign |
| Octubre de 2022 | [Administración de datos de formulario web](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/manage-webform-data.html?lang=en) | Vídeo | Obtenga información sobre cómo rastrear, administrar y exportar datos desde un formulario web. | Acrobat Sign |
| Octubre de 2022 | [Modo líquido en Acrobat Sign](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-tutorials/liquidmode.html?lang=es) | Vídeo | Descubra cómo el modo Liquid Mode la experiencia de firma móvil. No más pellizcar y acercar mientras se intenta leer y firmar documentos. | Acrobat Sign |
| Septiembre de 2022 | [Suscripción a una cuenta de desarrollador](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/sign-up-developer-account.html?lang=en) | Vídeo | En la parte 1 del _Guía de inicio rápido de Acrobat Sign Embed_, aprenda a registrarse en una cuenta de desarrollador de API de Acrobat Sign. Su nueva cuenta de desarrollador está totalmente habilitada con la funcionalidad de firmar y API. | Servicios de documento |
| Septiembre de 2022 | [Creación de la aplicación](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-your-application.html?lang=en) | Vídeo | En la parte 2 de la _Guía de inicio rápido de Acrobat Sign Embed_, aprenda a crear una aplicación mediante la API de Acrobat Sign. | Servicios de documento |
| Septiembre de 2022 | [Creación de un vínculo incrustado](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-an-embed-link.html?lang=en) | Vídeo | En la parte 3 de la _Guía de inicio rápido de Acrobat Sign Embed_, aprenda a crear un vínculo incrustado para OAuth. La aplicación obtiene permisos para usuarios que utilizan este método OAuth. | Servicios de documento |
| Septiembre de 2022 | [Generación de un token de acceso](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/generating-an-access-token.html?lang=en) | Vídeo | En la parte 4 de la _Guía de inicio rápido de Acrobat Sign Embed_, aprenda a generar un token de acceso que se puede utilizar con la API de Acrobat Sign. | Servicios de documento |
| Septiembre de 2022 | [Creación de un documento transitorio](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-a-transient-document.html?lang=en) | Vídeo | En la parte 5 de la _Guía de inicio rápido de Acrobat Sign Embed_, aprenda a crear un documento transitorio. | Servicios de documento |
