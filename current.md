...
| Función | Descripción |
| ------- | ----------- |
| [!UICONTROL Campañas], [!UICONTROL Hojas de edición masiva] | (Versión del 22 de enero) ([!DNL Microsoft Advertising accounts]) Ahora puede crear y administrar anuncios de búsqueda interactivos (RSA) desde la vista [!UICONTROL Campañas] > [!UICONTROL Anuncios] y desde [!UICONTROL Campañas] > [!UICONTROL Hojas de edición en bloque]. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| 17 de febrero de 2022 | Tutoriales de Advertising Cloud | Vídeos | Un nuevo tutorial de vídeo sobre &quot;[Cómo crear una colocación de visualización estándar](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/placement-create.html)&quot; está disponible. |
