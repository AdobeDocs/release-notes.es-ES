...
* [Primetime](https://helpx.adobe.com/es/support/primetime.html) (vínculos a la ayuda de la solución)
...
Para obtener documentación del producto, consulte [Experience Cloud y Core Services](https://marketing.adobe.com/resources/help/es_ES/mcloud/)
...
Para obtener documentación del producto, consulte [Experience Cloud ID]( servicehttps://marketing.adobe.com/resources/help/es_ES/mcvid/).
...
Para obtener documentación del producto, consulte [Mobile Services](https://marketing.adobe.com/resources/help/es_ES/mobile/).

Para obtener más información sobre los SDK para móviles, consulte: [Android SDK 4.x para Experience Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/android/) and [iOS SDK 4. x para Experience Cloud
Solutions](https://marketing.adobe.com/resources/help/es_ES/mobile/ios/).
...
| Migración del servidor Dallas FTP (ftp2.omniture.com) | 19 de octubre de 2018 | Si el 23 de octubre de 2018 se conecta a ftp2.omniture.com mediante el protocolo SFTP, es posible que deba volver a aceptar el identificador de host del sitio SJ1. Este problema solo se dará el 23 de octubre. Consulte [Actualización de Adobe FTP Servers](https://marketing.adobe.com/resources/help/es_ES/whitepapers/ftp/ftp_upgrade.html). |
...
| Función | Descripción |
| -----------| ---------- |  
| [Recomendaciones de características](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/trait-recommendations.html) | Recomendaciones de características, con tecnología [Adobe Sensei](https://www.adobe.com/sensei.html), incorpora la ciencia de datos en los flujos de trabajo diarios de Audience Manager. <br> Con Recomendaciones de características, cuando crea o edita un segmento en [el creador de segmento](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/segment-builder.html), obtiene recomendaciones sobre características adicionales que puede incluir, que son similares a las características de la regla de segmento. Añada las características recomendadas al segmento para aumentar la audiencia objetivo. |
...
Consulte las [notas de la versión de Adobe Target ](https://docs.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html) para obtener la información más reciente sobre los siguientes productos:
...
* [Versiones AEM Forms CFP](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html)
...
* [Documentación de versiones anteriores de AEM](https://helpx.adobe.com/experience-manager/aem-previous-versions.html)
