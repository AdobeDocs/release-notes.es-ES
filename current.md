...
* [!DNL Analytics](#analytics) (**Actualización: 26 de noviembre de 2019**)
* [Audience Manager](#aam)
* [Experience Manager](#aem)
* [!DNL Campaign](#ac)
* [!DNL Target](https://docs.adobe.com/content/help/es-ES/target/using/release-notes/target-release-notes.translate.html) (vínculos a la ayuda de la solución)
...
¿Busca ayuda en casa? Consulte [Formación y asistencia para Experience Cloud](https://helpx.adobe.com/es/support/experience-cloud.html).
...
* Se ha actualizado el vínculo [Más información](https://www.adobe.com/es/marketing/campaign.html) para Adobe Campaign en el selector de aplicaciones. (MCUI-10034)
...
| -----------| ---------- | ---------- |
| Actualización de las etiquetas de dimensión “Mes” y “Trimestre” | 26 de noviembre de 2019 | El 16 de enero de 2020, las etiquetas de dimensión Mes y Trimestre se actualizarán para reflejar el año natural estándar. La configuración del calendario personalizado (que se establece en **[!UICONTROL Admin &gt; Grupo de informes &gt; Editar configuración &gt; General)** seguirá determinando qué meses aparecen en los informes.<br>Por ejemplo, si el calendario personalizado para 2020 se define como “desde octubre de 2019 a septiembre de 2020”, los meses y trimestres aparecerán de la siguiente manera en los informes:<ul><li>Trimestres: Oct 2019-Dic 2019, Ene 2020-Mar 2020, Abr 2020-Jun 2020, Jul 2020-Sept 2020</li><li>Meses: Oct 2019, Nov 2019, Dic 2019, Ene 2020, Feb 2020, etc.</li><li>Anteriormente, todos estos elementos habrían reflejado el año 2019, lo que confundía a los usuarios finales.</li></ul>Si tiene filtros de informes o segmentos que buscan estos valores, no es necesario realizar ninguna acción. Se actualizarán para reflejar la nueva convención de nombres. |
| Fecha de fin de uso de la opción **[!UICONTROL Aplicar restricciones de inicio de sesión con IP]** | 21 de noviembre de 2019 | Anuncio de la fecha de finalización en *octubre de 2020* de la creación de listas de IP de inicio de sesión admitidas (**[!UICONTROL Aplicar restricciones de inicio de sesión con IP]**) en el menú **[!UICONTROL Administración &gt; Configuración de la compañía &gt; Seguridad]**. (Originalmente, esto se anunció con vistas a que se produjese en enero de 2020.) |
...
| [Recomendaciones inteligentes para datos de Audience Marketplace, con tecnología de Adobe Sensei](https://docs.adobe.com/content/help/es-ES/audience-manager/user-guide/features/segments/trait-recommendations.translate.html) | Con Recomendaciones de características, cuando crea o edita un segmento en el [Generador de segmentos](https://docs.adobe.com/content/help/es-ES/audience-manager/user-guide/features/segments/segment-builder.translate.html), ahora obtiene recomendaciones sobre características adicionales que puede incluir, desde fuentes de datos de [!UICONTROL Audience Marketplace] a las que no está suscrito. Añada las características recomendadas al segmento para aumentar la audiencia objetivo. <br>  Además, hemos rediseñado la página [!UICONTROL Marketplace] para facilitar la búsqueda de características similares y el filtrado de fuentes de datos. |
...
* [ID de dispositivo globales](https://docs.adobe.com/content/help/es-ES/audience-manager/user-guide/reference/ids-in-aam.html#global-device-ids)
* [Fuentes de datos globales](https://docs.adobe.com/content/help/es-ES/audience-manager/user-guide/features/data-sources/global-data-sources.html)
...
* **Brand Portal 6.4.5**
   ...
   Consulte [Novedades de AEM Assets Brand Portal](https://docs.adobe.com/content/help/es-ES/experience-manager-brand-portal/using/introduction/whats-new.html).
...
* **Cloud Manager 2019.10.0**
   ...
   Consulte las [notas de la versión de Cloud Manager 2019.10.0](https://docs.adobe.com/content/help/es-ES/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).

### Autoayuda

* **Activity map**

   Debido a los cambios de seguridad dentro de la API de Adobe Analytics, ya no es posible utilizar la versión de Activity Map incluida en AEM. Consulte [Configuración de la conexión a Adobe Analytics](https://helpx.adobe.com/es/experience-manager/6-5/sites/administering/using/adobeanalytics-connect.html#ConfiguringtheConnectiontoAdobeAnalytics).

   Ahora debe utilizar el [complemento del explorador de Activity Map](https://docs.adobe.com/content/help/es-ES/analytics/analyze/activity-map/getting-started/get-started-users/activitymap-install.html) para Chrome, Firefox o Internet Explorer proporcionado por Adobe Analytics.
...
* **Guía de recomendaciones para proyectos de AEM Screens**
   ...
   Consulte la [Guía de recomendaciones para proyectos de AEM Screens](https://docs.adobe.com/content/help/es-ES/experience-manager-screens/using/about-guide.html).

* **Administración de experiencias indirectas**

   Las funcionalidades del [Procesador de contenido remoto](https://helpx.adobe.com/es/experience-manager/6-5/sites/developing/using/spa-ssr.html#main-pars_header_450130848) que se utilizan en el servidor para la representación de aplicaciones de una sola página ya están documentadas.
...
* **SPA y procesamiento en el servidor**
   ...
   Consulte [SPA y procesamiento en el servidor](https://helpx.adobe.com/es/experience-manager/6-5/sites/developing/using/spa-ssr.html#RemoteContentRenderer).
...
* **Arquetipo de AEM Project**
   ...
   Consulte [Arquetipo de AEM Project](https://docs.adobe.com/content/help/es-ES/experience-manager-core-components/using/developing/archetype/overview.html).
...
* **Actualizaciones de la documentación de AEM**
   ...
   Consulte la [Documentación de AEM: Actualizaciones de documentación recientes](https://helpx.adobe.com/es/experience-manager/documentation-updates.html).
...
* [Notas de la versión de Livefyre](https://docs.adobe.com/content/help/es-ES/livefyre/using/release-notes/c-rn.translate.html)
...
* Adobe Campaign Classic: [Documentación](https://helpx.adobe.com/es/support/campaign/classic.html) - [Notas de la versión](https://docs.campaign.adobe.com/doc/AC/es/RN.html) - [Vídeos de presentación](https://docs.adobe.com/content/help/en/campaign-learn/campaign-classic-tutorials/overview.html)
