...
* **ANALYTICS** | Creadores de experiencia: el intercambio de habilidades | _Intercambio de habilidades en el Adobe Summit para Adobe Analytics_ | El 28 de marzo de 2024, organizaremos el intercambio de habilidades de Adobe Analytics en Summit en Las Vegas. Regístrese ahora para obtener sugerencias, trucos y prácticas recomendadas de los clientes y defensores de Analytics. | **28 de marzo a las 9:00 h PT** | [Registrarse](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=952%20953)

* **EXPERIENCE MANAGER** | Creadores de experiencia: el intercambio de habilidades | _Intercambio de aptitudes en el Adobe Summit AEM para la_ | AEM El 28 de marzo de 2024, organizaremos el intercambio de habilidades de la comunidad de Skill en el evento Summit en Las Vegas. AEM Regístrese ahora para obtener sugerencias, trucos y prácticas recomendadas de clientes y campeones de la red de la comunidad de la que se ha. | **28 de marzo a las 9:00 h PT** | [Registrarse](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=950%20951)

* **EXPERIENCE MANAGER** | Creadores de experiencia: el intercambio de habilidades | _Intercambio de aptitudes en el Adobe Summit para el Marketo Engage_ | El 28 de marzo de 2024, organizaremos el intercambio de habilidades de Marketo Engage en Summit en Las Vegas. Regístrese ahora para aprender consejos, trucos y prácticas recomendadas de los clientes y campeones Marketo Engage. | **28 de marzo a las 9:00 h PT** | [Registrarse](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=954%20955)

* **WORKFRONT** | Creadores de experiencia: el intercambio de habilidades | _Intercambio de habilidades en el Adobe Summit para Workfront_ | El 28 de marzo de 2024, organizaremos el intercambio de habilidades de Adobe Workfront en Summit en Las Vegas. Regístrese ahora para obtener sugerencias, trucos y prácticas recomendadas de los clientes de Workfront. | **28 de marzo a las 9:00 h PT** | [Registrarse](https://reg.adobe.com/flow/adobe/as24/sessions/page/catalog?tab.allsessions=1643149273691001NFtR&amp;search=956%20957)

* **WORKFRONT**| Evento de la comunidad | _Connect: chat del administrador para marketing y creativos_ | ¿Es administrador de sistemas de un equipo creativo o de marketing? Esta sesión basada en el cliente le conectará con otros administradores para analizar las prácticas recomendadas, sugerencias y trucos. | **5 de abril a las 9:00 h PT** | [Registrar](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,1qnTSsu1BE6bJ4ijFsYafg,COdPeWL3z0qsME9nhjnRwg,S3qiBpspOUyiG7Vl_PtPXg,rFPUK2gma0OCogFhuCyzjw,nTcEntnvgkePuH01JzrsQw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
Más información [Cadena de suministro de contenido](https://business.adobe.com/solutions/adobe-genstudio.html?lang=es), Adobe es una solución integral para acelerar y simplificar el contenido con IA generativa y automatización inteligente.

+++Detalles

| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Febrero de 2024 | [Tutorials de la cadena de suministro de contenido](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html) | Vídeos | Ver tutoriales de la cadena de suministro de contenido en Experience League. La cadena de suministro de contenido es una solución integral de Adobe para acelerar y simplificar su cadena de suministro de contenido con IA generativa y automatización inteligente. |
...
* [miércoles, 30 de enero de 2024](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2024/02142024.html#status)
...
* Ahora puede buscar una credencial de API por nombre al ver o modificar sus credenciales.
* La información de pertenencia a grupos de usuarios ya está disponible para cada función cuando se visualiza la lista de funciones de un usuario en la pestaña funciones. El **[!UICONTROL Quitar rol]** Esta opción está deshabilitada para los usuarios a los que se les ha asignado un rol a través de un grupo de usuarios solamente.
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Febrero de 2024 | Etiquetas | [Adición y configuración de extensiones de etiquetas](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/add-and-configure-extensions.html) | Vídeo | Obtenga información sobre cómo añadir y configurar extensiones en la propiedad de etiquetas. Las extensiones son &quot;aplicaciones&quot; empaquetadas previamente que se instalan en el sitio para proporcionarle el seguimiento, la personalización u otras capacidades que necesite. |
| Febrero de 2024 | Etiquetas | [Creación de elementos de datos](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/create-data-elements.html) | Vídeo | Obtenga información sobre cómo crear elementos de datos para almacenar valores extraídos de la capa de datos y ponerlos a disposición de reglas y extensiones en la propiedad de etiquetas. |
| Febrero de 2024 | Etiquetas | [Generar reglas de etiquetas](https://experienceleague.adobe.com/docs/platform-learn/data-collection/tags/build-rules.html) | Vídeo | Aprenda a crear reglas para poder ejecutar comandos en etiquetas. Los eventos y las condiciones determinan cuándo hacer cosas, mientras que las acciones determinan qué hacer. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Febrero de 2024 | [[!UICONTROL Ingesta de valor predeterminado] in [!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23641.html) | Nuevo artículo | Obtenga información sobre cómo configurar un valor predeterminado durante la ingesta en [!DNL Adobe Experience Platform (AEP)], especialmente para [!DNL upsert] , debe utilizar asignaciones explícitas en el proceso de ingesta de datos. |
...
[!DNL Analytics] fecha de lanzamiento: **13 de marzo de 2024**
...
Vídeos, tutoriales o cursos nuevos o actualizados publicados para Adobe Analytics.

| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Febrero de 2024 | [Creación de elementos de datos en etiquetas de Experience Platform para la implementación de Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html) | Vídeo | Creación de elementos de datos para su [!DNL Analytics] implementación en etiquetas basada en las variables y eventos documentados en un documento Diseño de referencia de la solución (DRS). |
| Febrero de 2024 | [Creación de una regla de página global en etiquetas de Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-a-global-page-rule-in-tags.html) | Vídeo | Obtenga información sobre cómo configurar una regla de página global para los puntos de datos que desea enviar a Adobe Analytics en todas las páginas mediante etiquetas de Experience Platform. |
| Febrero de 2024 | [Validación de la regla de carga de página global en etiquetas de Experience Platform](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/validating-your-global-page-load-rule-in-tags.html) | Vídeo | Obtenga información sobre cómo validar la regla de carga de página global con el depurador de Experience Platform. |
| Febrero de 2024 | [Creación de reglas de etiquetas de Experience Platform para eventos de éxito](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-tags-rules-for-success-events.html?lang=en) | Vídeo | Aprenda a utilizar las reglas en las etiquetas para rastrear eventos de conversión (eventos de éxito) en el sitio. |
...
| Febrero de 2024 | [Definición de filtros de URL internos](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/set-internal-url-filters.html?lang=en) | Vídeo | obtenga información acerca de la configuración de los referentes, que se establecen como referentes internos (para activar los informes de rutas) o externos (para activar los informes de dominio de referencia/referente). |
| Febrero de 2024 | [Etiquetas: su asistente personal](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/analytics/analysis-workspace/tips-and-tricks/tags-your-personal-assistant.html) | Artículo | Descubra cómo las etiquetas de Experience Platform pueden optimizar su análisis digital, y servir como asistente personal para encontrar lo que necesita de forma eficaz. Jeff Bloomer, Campeón de Adobe Analytics, comparte perspectivas de expertos sobre cómo maximizar el potencial de la herramienta para su beneficio. |
...
[!DNL Customer Journey Analytics] fecha de lanzamiento: **13 de marzo de 2024**
...
| Febrero de 2024 | Experience Manager Sites | [Configuración de la creación de documentos](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/set-up.html) | Vídeo | Una guía sobre cómo configurar la creación de documentos para autores. |
| Febrero de 2024 | Experience Manager Sites | [Flujos de trabajo de documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Vídeo | AEM Explore cómo utilizar flujos de trabajo de documentos con la creación de documentos de. |
| Febrero de 2024 | Experience Manager Sites | [Versiones de documento](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Vídeo | AEM Obtenga información sobre cómo crear versiones de documentos creados mediante la creación de documentos de. |
| Febrero de 2024 | AEM CS | [Cloud 5: búsqueda de terceros](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-3rd-party-search.html) | Vídeo | Explore cómo la búsqueda de terceros se puede integrar mejor en los Edge Delivery Services. |
| Febrero de 2024 | Experience Manager Assets | [Eventos de AEM Assets para la integración con PIM](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/examples/assets-pim-integration.html) | Vídeo | Obtenga información sobre cómo integrar AEM Assets AEM con un sistema de terceros, como un sistema de administración de la información del producto (PIM) o de administración de la línea de productos (PLM), para actualizar los metadatos de recursos mediante eventos nativos de E/S de. |
| Febrero de 2024 | AEM sin encabezado | [Campos personalizados](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Vídeo | AEM Obtenga información sobre cómo crear campos personalizados en el Editor de fragmentos de contenido de. |
| Febrero de 2024 | Experience Manager AEM, Administrador de nube de, Marketo Engage | [AEM Consejos y trucos para el campeón de la: uso de registros en Cloud Manager](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/cloud-manager-using-logs.html) | Vídeo | AEM Eche un vistazo a estos consejos de su compañero campeón de la, Rami EL Gamal. En este vídeo, Rami le explica cómo descargar registros en Cloud Manager, mientras comparte consejos sobre las prácticas recomendadas a lo largo del camino. |
| Febrero de 2024 | AEM CS | [Cloud 5: Monitorización de usuarios reales (RUM)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-rum.html?lang=en) | Vídeo | Explore los análisis de supervisión de usuarios reales (RUM) que Adobe AEM ofrece a sus sitios de acceso a los que se entrega con Edge Delivery Services, y cómo RUM se puede utilizar para mejorar un sitio web. |
| Febrero de 2024 | Experience Manager Forms | [Generar PDF con datos del envío de formularios basados en componentes principales](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/generate-pdf-from-core-component-form-submission.html) | Vídeo | Combine datos del envío de formularios basados en componentes principales con la plantilla XDP en el flujo de trabajo. |
| Febrero de 2024 | AEM Cloud Manager | [AEM AEM Recomendaciones y prácticas recomendadas del Campeón de la: preparación y planificación de una migración a la as a Cloud Service de la organización](https://experienceleague.adobe.com/docs/experiences-by-you/experiences-by-you/experience-manager/cloud-service/cloud-manager-best-practices/migration.html) | Vídeo | AEM Explore los consejos de los expertos y las prácticas recomendadas de su compañero campeón del mundo de la, Wilson Faure. AEM En este vídeo, explora las complejidades de la planificación y la preparación para la migración a la as a Cloud Service. |
| Febrero de 2024 | Experience Manager Sites | [Cloud 5: Trabajadores de Edge](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/expert-resources/cloud-5/season-3/cloud5-edge-workers.html?lang=en) | Vídeo | Explore la importancia de los Edge Delivery Services de Edge en AEM Sites y cómo integrarlos con sus sistemas back-end. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|--------|---------|---------|
| Febrero de 2024 | [[!DNL CDN] plantilla en [!UICONTROL Ajustes de aplicación] no se guarda](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23756.html) | Nuevo artículo | Obtenga información sobre la solución cuando la variable [!DNL CDN] plantilla en [!UICONTROL Ajustes de aplicación] no se puede guardar. |
| Febrero de 2024 | [JDK 11 causas `NoClassDefFoundError` [!DNL AEM] 6,5](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23581.html) | Nuevo artículo | Obtenga información acerca de cómo instalar el [!DNL CXF] paquetes externamente para resolver el problema de `NoClassDefFoundError` después de una actualización a [!DNL Java™] 11 con [!DNL AEM] 6,5x. |
| Febrero de 2024 | [Cómo calificar a un [!DNL AEM as Cloud Service] Ticket de asistencia](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23750.html) | Nuevo artículo | Obtenga información sobre cómo calificar completamente un ticket para que el servicio de asistencia pueda procesar y comprender rápidamente el problema, y qué información se requiere. |
| Febrero de 2024 | [Obtenga información sobre cómo cambiar el servidor y [!DNL JVM] Zona horaria a Europa/París en [!DNL AEM as a Cloud Service]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Nuevo artículo | Obtenga información sobre cómo cambiar el servidor y [!DNL JVM] Zona horaria a Europa/París en [!DNL AEM as a Cloud Service]. |
| Febrero de 2024 | [Los flujos de trabajo se establecen como &quot;no editables&quot; después de la implementación del código](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23531.html) | Nuevo artículo | Obtenga información acerca de cómo resolver el problema [!DNL AEM] problema después de crear un flujo de trabajo en [!DNL AEM] seguido de una implementación de código, la variable [!UICONTROL Flujo de trabajo] aparece como &quot;No editable&quot;. Como práctica recomendada, debe mantener su [!UICONTROL Flujo de trabajo] Los modelos de la base de código son coherentes en varios entornos, por lo que no tiene que volver a crear [!UICONTROL Flujos de trabajo] por cada entorno. |
| Febrero de 2024 | [[!DNL DDoS] ataque o sobrecarga de bots [!DNL AEM] con tráfico](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23718.html) | Nuevo artículo | Obtenga información sobre cómo depurar este problema habilitando el registro habilitado en el nivel de Dispatcher y tome medidas para mejorar el almacenamiento en caché de Dispatcher, que ayuda a evitar interrupciones causadas por picos de tráfico. |
| Febrero de 2024 | [Problemas y soluciones comunes de ingesta de recursos](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23717.html) | Nuevo artículo | Obtenga información sobre los más comunes [!DNL AEM] Escenarios de problemas de ingesta de recursos y cómo analizarlos, incluidos alto procesamiento, gran volumen y gran tamaño [!DNL DAM] repositorios y muchos autores simultáneos. |
| Febrero de 2024 | [Límite máximo de variaciones, Rendimiento y política de retención de [!UICONTROL Fragmentos de contenido]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23715.html) | Nuevo artículo | Obtenga información acerca del límite máximo del número de variaciones permitidas dentro de un único [!UICONTROL fragmento de contenido], si las variaciones múltiples contribuyen a la lentitud del sitio y si hay alguna política de retención para los elementos eliminados [!UICONTROL fragmentos de contenido]. |
| Febrero de 2024 | [[!UICONTROL Solicitud de eliminación] flujo de trabajo activado al eliminar contenido](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23690.html) | Nuevo artículo | Obtenga información sobre cuándo un usuario inicia sesión y elimina una página o un recurso en [!DNL AEM], el &quot;[!UICONTROL Solicitud de eliminación]&quot; flujo de trabajo activado. |
| Febrero de 2024 | [[!DNL HTML] archivo almacenado en [!DNL CRX] no se abre en el explorador, se descarga en su lugar](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23689.html) | Nuevo artículo | A [!DNL HTML] archivo almacenado directamente en [!DNL Oak] el repositorio no se abre en el explorador. En su lugar, se descarga en [!DNL AEM 6.1 SP2] y versiones posteriores. |
| Febrero de 2024 | [[!DNL Adobe Experience Manager]: `WARN` mensaje de `Scheduler job requested thread pool with name org-apache-sling-sitemap`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23665.html) | Nuevo artículo | Obtenga información sobre el problema durante [!DNL AEM 6.5] inicio, `WARN` Los mensajes de aparecen varias veces en `error.log`. |
| Febrero de 2024 | [[!DNL Adobe Experience Manager]: El nodo con `sling:resourceType=wcm/msm/components/ghost`](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23664.html) | Nuevo artículo | Obtenga información sobre el problema cuando, en algunos casos, los nodos con una `sling:resourceType` valor de `wcm/msm/components/ghost` existen. Este artículo explica cómo se crea el nodo. |
...
| Publicadas | Nombre | Tipo | Descripción |
| -----------| ---------- | ---------- | ---------- |
| Febrero de 2024 | [Conexión y ejecución de consultas en la base de datos de Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/remote-db-connection-execute-queries.html?lang=en) | Vídeo | Obtenga información sobre cómo conectarse a un proyecto en la nube de Adobe Commerce, volcar una base de datos para su uso fuera del sitio, enmascarar PII y eliminarla. |
| Febrero de 2024 | [Incorporación técnica y transferencia de hardware de Commerce Cloud: línea de tiempo del proceso de lanzamiento](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-commerce-cloud/technical-onboarding-hardware-handoff/launch-process-timeline.html) | Vídeo | Obtenga información acerca de la incorporación técnica de Adobe Commerce Cloud para la cronología del proceso de lanzamiento. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|--------|---------|---------|
| Febrero de 2024 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html?lang=es) | Nuevos artículos | Nuevos artículos sobre cómo aplicar parches disponibles en [!DNL QPT] 1.1.44, [!DNL QPT] 1.1.45 y [!DNL QPT] 1.1.46 se publicaron y se puede encontrar en sus secciones respectivas. |
| Febrero de 2024 | [Varias filas en la base de datos para la misma entidad](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/database/multiple-rows-in-database-for-same-entity.html) | Nuevos artículos | Este artículo proporciona una solución al problema de que haya varias filas para el mismo ID de entidad en la base de datos. |
| Febrero de 2024 | [Recommendations [!DNL JS] errores tras la actualización a la versión 2.4.5 de Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Nuevos artículos | Este artículo proporciona una corrección para los casos en los que después de la actualización a Adobe Commerce (todos los métodos de implementación), haya [!DNL JS] errores en la consola relacionados con los módulos o unidades de Recommendations del producto. |
...
* [!DNL Campaign Web Interface]: [¿Qué hay de nuevo?](https://experienceleague.adobe.com/docs/campaign-web/v8/whats-new.html?lang=es) | [Documentación del producto](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html?lang=es)

* [!DNL Campaign] Versión 8.6: [Notas de versión](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html?lang=es) | [Documentación del producto](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaign-home.html?lang=es)
...
| Febrero de 2024 | Interfaz de usuario web de Campaign | [Exploración de la interfaz de usuario web de Campaign](https://experienceleague.adobe.com/docs/campaign-web-learn/tutorials/getting-started/explore-the-web-ui.html) | Vídeo | Obtenga información sobre cómo acceder a la interfaz de usuario de Campaign Web y navegar por ella, y cómo personalizar las listas de inventario. Descubra el asistente de conocimientos con tecnología de IA. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Febrero de 2024 | [No se puede ver correctamente la ventana de plantillas de envíos al conectarse a [!DNL Campaign Console] mediante [!DNL VPN]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Nuevo artículo | Obtenga información acerca de la solución del problema al conectarse a [!DNL Adobe Campaign Console] mediante [!DNL VPN]Sin embargo, no puede ver los datos de las plantillas de envío dentro de la ventana. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Febrero de 2024 | [Encapsule las funciones al crear expresiones utilizando el operador &quot;+&quot;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23749.html) | Nuevo artículo | Descubra cómo cualquier llamada a una función debe encapsularse con paréntesis al utilizar el operador &quot;+&quot;. |
...
| -----------| ---------- | ---------- | ---------- |---------- |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Adobe Firefly de Discover](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/discover.html?lang=en) | Vídeo | Descubra el Adobe Firefly del futuro de la creatividad con IA generativa, diseñada para el uso y la innovación en seguridad comercial. |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Página de destino](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Vídeo | Obtenga información sobre cómo empezar a utilizar el Adobe Firefly. |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Relleno generativo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-fill.html?lang=en) | Vídeo | Aprenda a utilizar el relleno generativo para agregar, expandir o quitar contenido de las imágenes de forma no destructiva mediante sencillos mensajes de texto. El relleno generativo le permite potenciar su creatividad y crear proyectos extraordinarios. |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Color generativo](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/gen-recolor.html?lang=en) | Vídeo | Obtenga información sobre cómo previsualizar al instante diversas variaciones de color para el embalaje del producto, carteles o ilustraciones en archivos vectoriales. El cambio de color generativo permite cambiar el color lo más rápido posible. Experimente con ideas originales, idee diferentes temas o paletas y produzca varias variaciones de una sola vez. |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Ejemplos de cómo usar Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/examples.html?lang=en) | Vídeo | Aprenda a utilizar Firefly para crear presentaciones de PowerPoint, paneles de estados de ánimo, ideación, protectores de pantalla y mucho más. |
| Febrero de 2024 | [!DNL Adobe Firefly] | [Efectos de texto](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/text-effects.html?lang=en) | Vídeos | Aprenda a crear texto único e inspirador para sus proyectos con simples mensajes de texto. Los efectos de texto le permiten mejorar su creatividad y crear textos extraordinarios para sus proyectos. |
