...
| [!DNL Experience Cloud] | [Inteligencia artificial aplicada a la agencia](https://experienceleague.adobe.com/es/docs/core-services/interface/features/agentic-ai) | Obtenga información acerca del agente de soporte de productos y Data Insights Agent (IA auténtica). |
...
|---------|----|----|-----------|
| Junio de 2025 | [Resolviendo el botón **[!UICONTROL Edge]** atenuado en el **[!UICONTROL visor de perfiles]**](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26624) de AEP | Nuevo artículo | Obtenga información acerca de las soluciones al problema cuando el botón **[!UICONTROL Edge]** en **[!UICONTROL Pertenencia a audiencias]** en el **[!UICONTROL Visor de perfiles]** de Adobe Experience Platform (AEP) aparezca atenuado. |
...
| Publicadas | Nombre | Tipo | Descripción |
|---------|----|----|-----------|
| Junio de 2025 | [Comprenda los límites de tamaño de datos en las conexiones de CJA](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26969) | Nuevo artículo | Obtenga información acerca de los límites de tamaño de datos en las conexiones de CJA y las prácticas recomendadas para administrar la ingesta de datos a fin de mantener la eficacia y el cumplimiento del sistema. |
...
| Junio de 2025 | [[!DNL OAuth] Error 401 al usar la autenticación de servidor a servidor en AEM](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26755) | Nuevo artículo | Obtenga información sobre las soluciones al problema cuando se produce un *error no autorizado 401* en AEM as a Cloud Service al cambiar de JWT a [!DNL OAuth] autenticación de servidor a servidor. |
...
| Junio de 2025 | [Las etiquetas inteligentes no funcionan en AEM Sites sin una licencia de Assets](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26842) | Nuevo artículo | Obtenga información acerca de las soluciones al problema de las etiquetas inteligentes que no funcionan en AEM Sites sin una licencia de Assets. |
...
| Julio de 2025 | [Crear un producto de paquete](https://experienceleague.adobe.com/es/docs/commerce-learn/tutorials/getting-started/create-products/create-bundle-product) | Nuevo vídeo | Obtenga información sobre cómo crear un paquete de productos mediante la API de REST y el administrador de Commerce. |
| Julio de 2025 | [Crear un producto de tarjeta regalo](https://experienceleague.adobe.com/es/docs/commerce-learn/tutorials/getting-started/create-products/create-gift-card-product) | Nuevo vídeo | Obtenga información sobre cómo crear un producto de tarjeta regalo mediante la API de REST y el administrador de Adobe Commerce. |
...
| Junio de 2025 | [Actualización de seguridad disponible para Adobe Commerce - APSB25-50](https://experienceleague.adobe.com/es/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb25-50) | Nuevos artículos | El 10 de junio de 2025, Adobe lanzó una actualización de seguridad programada regularmente para Adobe Commerce y Magento Open Source. |
| Junio de 2025 | [Cuenta de zona protegida de PayPal no verificada](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26836) | Nuevos artículos | Obtenga información sobre las soluciones al problema cuando tu cuenta de zona protegida de PayPal no esté verificada, de modo que no puedas finalizar la incorporación con [!UICONTROL Servicios de pago] en Adobe Commerce. |
...
| Junio de 2025 | [Pagos erróneos con tarjeta de crédito en un entorno de espacio aislado](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26825) | Nuevos artículos | Obtenga información sobre las soluciones al problema cuando una tarjeta de crédito de prueba falla en un entorno de espacio aislado con API de PayPal. |
...
| Junio de 2025 | [Reducir `oauth_tokens` caducados antes de la actualización a 2.4.6](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26848) | Nuevos artículos | Obtenga información acerca de las soluciones al problema cuando aparezca un gran número de `oauth_tokens` en la tabla `oauth_token`, lo que puede causar un largo retraso en la actualización a la versión 2.4.6. |
| Junio de 2025 | [Solucionar problemas [!DNL Upgrade Compatibility Tool] errores](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26849) | Nuevos artículos | Obtenga información acerca de las soluciones al problema cuando se producen errores al usar [!DNL Upgrade Compatibility Tool]. |
...
| Junio de 2025 | [Las imágenes del producto no se muestran a pesar de [!UICONTROL Modificar producto] roles de imagen](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26859) | Nuevos artículos | Obtenga información sobre las soluciones al problema que se produce cuando las imágenes de productos no se muestran en la tienda a pesar de las funciones de imagen establecidas en la página [!UICONTROL Edición de productos]. |
...
| Junio de 2025 | [*No se puede eliminar el archivo. Advertencia: no existe el error de archivo o directorio* del administrador ](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26887) | Nuevos artículos | Obtenga información acerca de las soluciones al problema cuando se produce el error *El archivo no se puede eliminar. Advertencia: No existe el error de archivo o directorio* en el administrador de Commerce cuando se realiza el vaciado de JavaScript/CSS. |
| Junio de 2025 | [La búsqueda de coincidencia exacta no funciona en Adobe Commerce 2.4.x](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26888) | Nuevos artículos | Obtenga información acerca de las soluciones al problema en el que los resultados de búsqueda de tienda que usan la misma cadena de búsqueda difieren en Adobe Commerce 2.4.x en comparación con Adobe Commerce 2.3.x. |
...
| Junio de 2025 | [Errores de implementación al habilitar el módulo alfa inicial [!DNL Baler] module](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26914) | Nuevos artículos | Obtenga información acerca de las soluciones al problema cuando se producen errores de implementación al utilizar el módulo [!DNL Baler] en un entorno de producción. |
| Junio de 2025 | [La implementación falla con las claves de acceso correctas en `env:COMPOSER_AUTH` o `auth.json`](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26921) | Nuevos artículos | Obtenga información acerca de las soluciones al problema que se produce cuando la implementación falla con un *archivo no descargado (HTTP/1.1 404 no encontrado)* error en el registro de implementación. |
...
| Junio de 2025 | [Explicación de las recomendaciones de configuración de cola en el informe de revisión de entorno](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26956) | Nuevos artículos | Obtenga información acerca de la revisión de entornos Informa de recomendaciones relacionadas con la configuración de colas en Adobe Commerce en la infraestructura en la nube. |
...
| Junio de 2025 | [Comprenda cómo el Centro de mensajes afecta a los perfiles activos en Adobe Campaign v8](https://experienceleague.adobe.com/es/docs/experience-cloud-kcs/kbarticles/ka-26812) | Nuevo artículo | Obtenga información acerca de cómo el Centro de mensajes afecta a los perfiles activos en Adobe Campaign v8. |
...
| Julio de 2025 | [!DNL Journey Optimizer] | [Agregar campos de formulario a plantillas de canales de experiencia basadas en código](https://experienceleague.adobe.com/es/docs/journey-optimizer-learn/tutorials/channels/code-based-experience-channel/form-fields-in-code-based-experiences) | Nuevo vídeo | Descubra cómo los desarrolladores pueden optimizar la colaboración con los equipos de marketing habilitando campos editables en canales de experiencia basados en código. |
...
| Julio de 2025 | [Crear un informe de calendario personalizado](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/calendar-reports/creating-custom-calendars.html?lang=es) | Nuevo vídeo | Aprenda a crear su propio calendario personalizado. |
