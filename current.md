...
| Búsqueda de Experience League | 1 de junio de 2021 | Se ha mejorado la búsqueda de documentación del Experience League. Vaya a [Experience League](https://experienceleague.adobe.com/docs/?lang=es) y utilice el campo **[!UICONTROL Buscar]** para localizar tutoriales, documentación, cursos y más. |
...
| Junio de 2021 | [Crear clases de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-classes.html) | Vídeo | Aprenda a crear clases en Adobe Experience Platform para utilizarlas en esquemas del Modelo de datos de experiencia (XDM). |
...
| Junio de 2021 | [Crear tipos de datos de esquema](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-data-types.html) | Vídeo | Aprenda a crear sus propios tipos de datos en Adobe Experience Platform para utilizarlos en esquemas del Modelo de datos de experiencia (XDM). |
...
* **Versión de Adobe Campaign Classic v7 21.1.3:** Más información en las notas de la versión de  [Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=es).
