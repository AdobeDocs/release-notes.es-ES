...
| ----------| ---------- | ---------- |---------- |
| Septiembre de 2025 | [Tutorial de composición de audiencia federada](https://experienceleague.adobe.com/es/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Vídeo | Interactúe con las audiencias directamente desde el almacén de datos mediante la Composición de audiencias federada (FAC). |
