...
* **Actualización de inicio de sesión:** la actualización a Experience Cloud elimina la pantalla inicial de inicio de sesión de Experience Cloud. A partir del 4 de febrero, se le redirigirá directamente desde `https://experience.adobe.com/login` a la pantalla de inicio de sesión de Adobe.
...
| 3 de febrero de 2021 | [Activación de datos en aplicaciones que no son de Adobe](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=es) | Vídeo | Descubra cómo el CDP en tiempo real de Adobe le ayuda a crear estrategias de personalización verdaderas con sus audiencias. Aprenda también cómo se integra en su ecosistema actual y en las aplicaciones que no son de Adobe de Microsoft, Google y Facebook. |
| 21 de enero de 2021 | [Introducción al curso para iniciarse en los servicios inteligentes para especialistas en marketing](https://video.tv.adobe.com/v/330805?quality=12&learn=on) | Vídeo | Introducción al curso Introducción a los servicios inteligentes para especialistas en marketing. |
| 13 de enero de 2021 | [Introducción a Offer Decisioning para especialistas en marketing](https://video.tv.adobe.com/v/330520?quality=12&learn=on) | Vídeo | Introducción a Offer Decisioning para especialistas en marketing. |
| 31 de enero de 2021 | [Practicar, calificar el progreso y producir modelos con la plantilla del generador de fórmulas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/train-score-and-productize-models.html?lang=es) | Vídeo | Aprenda a utilizar la plantilla actualizada del creador de fórmulas para crear una fórmula con el esquema de ventas minoristas y los conjuntos de datos. |
| 31 de enero de 2021 | [Carga de datos en cuadernos de JupyterLab](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/load-data-in-jupyterlab-notebooks.html?lang=es) | Vídeo | Obtenga información sobre JupyterLab en Data Science Workspace. |
...
| EOL de Ad Hoc Analysis | Enero de 2021 | [!UICONTROL Ad Hoc ] Analytics llegó a su fecha de finalización el 1 de marzo de 2021. Para obtener más información, consulte [Discover Workspace](https://spark.adobe.com/page/S9Bhp66VJ2fEn/). |
...
* Se ha resuelto un problema con la clonación de **[!UICONTROL Modelo]** en la función **[!UICONTROL Predictive Audiences]**. (AAM-56775)
...
| 2 de febrero de 2021 | [Función de Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html?lang=es) | Vídeo | Explore el propósito de [!UICONTROL Cloud Manager] y cómo funciona con Experience Manager como Cloud Service. |
