...
* [Notas de la versión de Experience Platform Launch](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=es) (Publicación: 18 de febrero de 2021)
...
| Workspace: Versiones anteriores del proyecto | 13 de mayo de 2021 | Permite cargar versiones anteriores de un proyecto de Workspace para deshacer cambios no deseados o simplemente volver a una versión anterior preferida. |
...
| Abril de 2021 | [Creación de la configuración de Cloud Services de Adobe Sign](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-and-sign/create-adobe-sign-cloud-configuration.html?lang=es) | Artículo | Cree la configuración de los Cloud Services de Adobe Sign para integrarla con Adobe Sign mediante la API de Adobe Sign. |
...
| Abril de 2021 | [Modelado avanzado para GraphQL](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/advanced-modeling.html?lang=es) | Vídeo | Aprenda a crear relaciones entre los modelos de fragmento de contenido en Adobe Experience Manager (AEM) y a aprovechar estas relaciones en las consultas de GraphQL. |
...
| Abril de 2021 | [Prueba de la creación de un posible cliente en Salesforce al hacer clic en el evento de un botón](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/integrate-with-salesforce/create-lead-click-event.html?lang=es#forms) | Vídeo | Cree el objeto de posible cliente invocando la operación de POST del Modelo de datos de formulario en el evento de clic de un botón. |
| Abril de 2021 | [Integrar [!UICONTROL AEM Forms] con  [!DNL Salesforce]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/integrate-with-salesforce/introduction.html?lang=es#forms) | Vídeo | Vídeo introductorio del curso de integración de Forms + Salesforce. |
...
| Abril de 2021 | [Prueba de la creación de un posible cliente en  [!DNL Salesforce]  en el envío de formularios](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/integrate-with-salesforce/create-lead-submitting-form.html?lang=es#forms) | Vídeo | Cree un formulario adaptable basado en el modelo de datos del formulario. Compruebe que el objeto de posible cliente se crea en la base de datos de Salesforce al enviar el formulario. |
