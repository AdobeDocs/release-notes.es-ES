...
* [!DNL Advertising Cloud](#adcloud) **(Actualización: 10 de febrero de 2020)**
...
Actualización: 10 de febrero de 2020 para la versión del 8 de febrero

| Ver | Función |
|------|---------|
| Portafolios | Ahora puede agregar Yahoo! Campañas de la Red de visualización de Japón (YDN) en portafolios para optimizar los presupuestos de campaña y las ofertas de nivel de grupo de publicidad. La misma oferta se aplica a todas las publicidades de un grupo de publicidad. Los datos de las campañas YDN se incluyen en las simulaciones del portafolio. |
| Buscar > Hojas de edición masiva | Ahora puede crear, editar y eliminar publicidades de búsqueda adaptables (RSA, por sus siglas en inglés) de Google mediante hojas de edición masiva. Anteriormente, la compatibilidad solo estaba disponible a través de la interfaz de administración de campañas estándar en Buscar > Campañas |
| Búsqueda > Campañas, Informes | Métricas de prominencia de Google Ads &quot;Impr. (Abs. Superior) %&quot; e &quot;Impr. (Superior) %&quot; ahora está disponible en todos los informes básicos y en las vistas de administración de campañas a nivel de entidad, excepto en los informes de grupos de productos de compras, en los informes de uso compartido de impresiones diarias de campaña y de uso compartido de impresiones diarias de palabras clave, y en las vistas de etiquetas y restricciones. |
